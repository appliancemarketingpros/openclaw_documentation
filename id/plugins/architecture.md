...
source_url: https://docs.openclaw.ai/id/plugins/architecture
...
[**Instal dan gunakan Plugin** Panduan pengguna akhir untuk menambahkan, mengaktifkan, dan memecahkan masalah Plugin. ](</id/tools/plugin>) [**Membangun Plugin** Tutorial Plugin pertama dengan manifes berfungsi paling kecil. ](</id/plugins/building-plugins>) [**Plugin channel** Bangun Plugin channel perpesanan. ](</id/plugins/sdk-channel-plugins>) [**Plugin provider** Bangun Plugin provider model. ](</id/plugins/sdk-provider-plugins>) [**Ikhtisar SDK** Referensi peta impor dan API pendaftaran. ](</id/plugins/sdk-overview>)
...
* ### Konsumen memakai perilaku bersama

---
title: MiniMax
source_url: https://docs.openclaw.ai/de/providers/minimax
...
Sowohl `minimax` als auch `minimax-portal` registrieren `image_generate` mit demselben Modell `image-01`. Setups mit API-Schlüssel verwenden `MINIMAX_API_KEY`; OAuth-Setups können stattdessen den gebündelten Auth-Pfad `minimax-portal` verwenden.
...
Konfigurationsoptionen Option | Beschreibung  
---|---  
...
Details zur Coding-Plan-Nutzung
...
"Unbekanntes Modell: minimax/MiniMax-M2.7"
...
[**Modellauswahl** Provider, Modellreferenzen und Failover-Verhalten auswählen. ](</de/concepts/model-providers>) [**Bildgenerierung** Gemeinsame Parameter des Bildwerkzeugs und Provider-Auswahl. ](</de/tools/image-generation>) [**Musikgenerierung** Gemeinsame Parameter des Musikwerkzeugs und Provider-Auswahl. ](</de/tools/music-generation>) [**Videogenerierung** Gemeinsame Parameter des Videowerkzeugs und Provider-Auswahl. ](</de/tools/video-generation>) [**MiniMax-Suche** Websuche-Konfiguration über den MiniMax Token Plan. ](</de/tools/minimax-search>) [**Fehlerbehebung** Allgemeine Fehlerbehebung und FAQ. ](</de/help/troubleshooting>)

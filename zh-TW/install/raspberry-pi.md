---
title: Raspberry Pi
source_url: https://docs.openclaw.ai/zh-TW/install/raspberry-pi
...
**最低需求：** 1 GB RAM、1 核心、500 MB 可用磁碟空間、64 位元作業系統。 **建議：** 2 GB+ RAM、16 GB+ SD 卡（或 USB SSD）、乙太網路。
...
OpenClaw 狀態位於：
  ...
  * `~/.openclaw/workspace/` — agent 工作區（[SOUL.md](<http://SOUL.md>)、記憶體、成品）。

---
title: Mattermost
source_url: https://docs.openclaw.ai/es/channels/mattermost
...
* ### Asegúrate de que el Plugin esté disponible
...
json5Copy code
[code]
    {  channels: {    mattermost: {      commands: {        native: true,        nativeSkills: true,        callbackPath: "/api/channels/mattermost/command",        // Úsalo cuando Mattermost no pueda llegar directamente al Gateway (proxy inverso/URL pública).        callbackUrl: "https://gateway.example.com/api/channels/mattermost/command",      },    },  },}
[/code]

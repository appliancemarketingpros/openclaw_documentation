...
source_url: https://docs.openclaw.ai/pt-BR/help/testing-updates-plugins
...
Comece pela identidade do artefato:
  ...
  * Resumo de Aceitação de Pacote `resolve_package`: origem, versão, SHA-256 e nome do artefato.
  * Artefatos do Docker: `.artifacts/docker-tests/**/summary.json`, `failures.json`, logs da lane e comandos de nova execução.
  * Resumo do sobrevivente de upgrade: `.artifacts/upgrade-survivor/summary.json`, incluindo versão de baseline, versão candidata, cenário, tempos das fases e etapas da receita.

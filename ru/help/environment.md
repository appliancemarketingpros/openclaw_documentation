...
source_url: https://docs.openclaw.ai/ru/help/environment
...
См. [Управление секретами](</ru/gateway/secrets>) и [поверхность учетных данных SecretRef](</ru/reference/secretref-credential-surface>), где перечислены поддерживаемые поля.
...
Оба разрешаются из окружения процесса во время активации. Подробности SecretRef документированы в [Управление секретами](</ru/gateway/secrets>). Сам блок `env` конфигурации не разрешает SecretRefs или сокращенные значения `file:...`.

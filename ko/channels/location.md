---
title: 채널 위치 파싱
source_url: https://docs.openclaw.ai/ko/channels/location
...
textCopy code
[code]
    위치(신뢰할 수 없는 메타데이터):```json{  "latitude": 48.858844,  "longitude": 2.294351,  "name": "Eiffel Tower",  "address": "Champ de Mars, Paris",  "caption": "Meet here"}```
[/code]

---
title: Hetzner
source_url: https://docs.openclaw.ai/pl/install/hetzner
...
Jeśli używasz innego Linux VPS, odpowiednio dopasuj pakiety. Ogólny przepływ Docker znajdziesz w [Docker](</pl/install/docker>).

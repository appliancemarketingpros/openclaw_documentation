...
Queueing + concurrency
  ...
  * Messaging channels can choose queue modes (collect/steer/followup) that feed this lane system. See [Command Queue](</concepts/queue>).
...
[Agent Runtime](</concepts/agent>)[System Prompt](</concepts/system-prompt>)

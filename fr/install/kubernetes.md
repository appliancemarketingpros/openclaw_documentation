---
title: Kubernetes
source_url: https://docs.openclaw.ai/fr/install/kubernetes
...
Récupérez le secret partagé configuré pour l’UI de contrôle. Ce script de déploiement crée une authentification par jeton par défaut :

...
source_url: https://docs.openclaw.ai/pt-BR/cli/status
...
Observações:
  ...
  * Falhas de atualização de preços de modelos são exibidas como avisos opcionais de preços. Elas não significam que o Gateway ou os canais não estejam íntegros.

...
source_url: https://docs.openclaw.ai/tr/concepts/qa-matrix
...
---|---|---  
`--profile <profile>` | `all` | Senaryo profili. Bkz. Profiller.  
`--fail-fast` | kapalı | İlk başarısız kontrolden veya senaryodan sonra dur.  
`--scenario <id>` | - | Yalnızca bu senaryoyu çalıştır. Tekrarlanabilir. Bkz. Senaryolar.  

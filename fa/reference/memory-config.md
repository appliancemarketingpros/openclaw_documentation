...
source_url: https://docs.openclaw.ai/fa/reference/memory-config
scraped_at: 2026-05-25
---

این صفحه همهٔ تنظیمات قابل پیکربندی برای جستجوی حافظهٔ OpenClaw را فهرست می‌کند. برای مرورهای مفهومی، ببینید:

[**نمای کلی حافظه** حافظه چگونه کار می‌کند. ](</fa/concepts/memory>) [**موتور داخلی** backend پیش‌فرض SQLite. ](</fa/concepts/memory-builtin>) [**موتور QMD** sidecar محلی‌اول. ](</fa/concepts/memory-qmd>) [**جستجوی حافظه** pipeline جستجو و تنظیم آن. ](</fa/concepts/memory-search>) [**Active Memory** زیرعامل حافظه برای نشست‌های تعاملی. ](</fa/concepts/active-memory>)
...
نوع‌های ورودی سازگار با OpenAI
...
محلی (GGUF + node-llama-cpp) کلید | نوع | پیش‌فرض | توضیح  
---|---|---|---  
...
زمان‌بندی به‌روزرسانی کلید | نوع | پیش‌فرض | توضیح  
---|---|---|---  
...
محدودیت‌ها کلید | نوع | پیش‌فرض | توضیح  
---|---|---|---  

---
title: Azure Speech
source_url: https://docs.openclaw.ai/fa/providers/azure-speech
...
[**تبدیل متن به گفتار** نمای کلی TTS، ارائه‌دهندگان، و پیکربندی `messages.tts`. ](</fa/tools/tts>) [**پیکربندی** مرجع کامل پیکربندی شامل تنظیمات `messages.tts`. ](</fa/gateway/configuration>) [**ارائه‌دهندگان** همهٔ ارائه‌دهندگان همراه OpenClaw. ](</fa/providers>) [**عیب‌یابی** مشکلات رایج و مراحل اشکال‌زدایی. ](</fa/help/troubleshooting>)

---
title: Черга команд
source_url: https://docs.openclaw.ai/uk/concepts/queue
...
Про timing і поведінку залежностей, специфічні для runtime, див. [Черга керування](</uk/concepts/queue-steering>). Для явної команди `/steer <message>` див. [Керування](</uk/tools/steer>).

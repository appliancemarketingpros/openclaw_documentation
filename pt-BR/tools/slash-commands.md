...
source_url: https://docs.openclaw.ai/pt-BR/tools/slash-commands
...
Comandos de dock trocam a rota de resposta da sessão atual para outro canal vinculado. Veja [Docking de canal](</pt-BR/concepts/channel-docking>) para configuração, exemplos e solução de problemas.

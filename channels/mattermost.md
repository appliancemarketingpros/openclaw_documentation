...
If you choose Mattermost during setup and a git checkout is detected, OpenClaw will offer the local install path automatically. Details: [Plugins](</tools/plugin>)
...
[Matrix](</channels/matrix>)[Microsoft Teams](</channels/msteams>)

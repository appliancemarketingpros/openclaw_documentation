...
source_url: https://docs.openclaw.ai/it/plugins/architecture
...
[**Installare e usare i plugin** Guida per gli utenti finali su aggiunta, abilitazione e risoluzione dei problemi dei plugin. ](</it/tools/plugin>) [**Creare plugin** Tutorial per il primo plugin con il manifesto funzionante più piccolo. ](</it/plugins/building-plugins>) [**Plugin di canale** Crea un plugin per canale di messaggistica. ](</it/plugins/sdk-channel-plugins>) [**Plugin provider** Crea un plugin provider di modelli. ](</it/plugins/sdk-provider-plugins>) [**Panoramica dell'SDK** Riferimento alla mappa di importazione e all'API di registrazione. ](</it/plugins/sdk-overview>)
...
* ### Definisci la capability

Definisci nel core la capability mancante.

* ### Esponi tramite l'SDK
...
### Livello plugin di canale/funzionalità
...
Applicazione della registrazione a runtime

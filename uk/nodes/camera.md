...
source_url: https://docs.openclaw.ai/uk/nodes/camera
...
Якщо дозволів немає, застосунок за можливості покаже запит; якщо відмовлено, запити `camera.*` завершуються помилкою `*_PERMISSION_REQUIRED`.

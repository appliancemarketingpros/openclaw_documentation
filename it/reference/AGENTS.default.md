...
source_url: https://docs.openclaw.ai/it/reference/AGENTS.default
...
[/code]
  ...
  3. Facoltativo: se vuoi l'elenco delle skill dell'assistente personale, sostituisci [AGENTS.md](<http://AGENTS.md>) con questo file:

...
source_url: https://docs.openclaw.ai/uk/channels/bot-loop-protection
...
Див. [середовище виконання SDK](</uk/plugins/sdk-runtime#reusable-runtime-utilities>), щоб дізнатися подробиці реалізації Plugin.

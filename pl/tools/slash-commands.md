...
source_url: https://docs.openclaw.ai/pl/tools/slash-commands
...
Polecenia dokowania przełączają trasę odpowiedzi bieżącej sesji na inny połączony kanał. Zobacz [Dokowanie kanałów](</pl/concepts/channel-docking>), aby poznać konfigurację, przykłady i rozwiązywanie problemów.
...
Uwagi o argumentach i parserze
...
Szybka ścieżka i skróty w treści
...
Polecenia umiejętności i argumenty natywne
...
W przeciwieństwie do zwykłego czatu:
  ...
  * w sesjach harness Codex działa jako efemeryczny wątek poboczny Codex z bieżącymi uprawnieniami Codex i natywną powierzchnią narzędzi,

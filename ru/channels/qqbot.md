---
title: QQ-бот
source_url: https://docs.openclaw.ai/ru/channels/qqbot
...
## Настройка
  ...
  1. Перейдите на [QQ Open Platform](<https://q.qq.com/>) и отсканируйте QR-код с помощью QQ на телефоне, чтобы зарегистрироваться или войти.

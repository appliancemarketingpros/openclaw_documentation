...
source_url: https://docs.openclaw.ai/hi/providers/models
scraped_at: 2026-06-29
---

ModelsOverview

OpenClaw कई LLM प्रदाताओं का उपयोग कर सकता है। कोई एक चुनें, प्रमाणीकरण करें, फिर डिफ़ॉल्ट मॉडल को `provider/model` के रूप में सेट करें।
...
पूर्ण प्रदाता कैटलॉग (xAI, Groq, Mistral आदि) और उन्नत कॉन्फ़िगरेशन के लिए, [मॉडल प्रदाता](</hi/concepts/model-providers>) देखें।

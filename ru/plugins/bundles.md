---
title: Наборы Plugin
source_url: https://docs.openclaw.ai/ru/plugins/bundles
...
bashCopy code
[code]
    # Локальный каталогopenclaw plugins install ./my-bundle # Архивopenclaw plugins install ./my-bundle.tgz # Маркетплейс Claudeopenclaw plugins marketplace list <marketplace-name>openclaw plugins install <plugin-name>@<marketplace-name>
[/code]
...
Бандлы Codex лучше всего подходят OpenClaw, когда используют корневые каталоги Skills и каталоги пакетов хуков в стиле OpenClaw (`HOOK.md` \+ `handler.ts`).

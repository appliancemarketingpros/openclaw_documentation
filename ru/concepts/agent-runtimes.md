...
source_url: https://docs.openclaw.ai/ru/concepts/agent-runtimes
...
Harness `copilot` — это отдельный внешний plugin harness, включаемый явно, для GitHub Copilot CLI; см. [среду выполнения агента GitHub Copilot](</ru/plugins/copilot>) для пользовательского выбора между PI, Codex и средой выполнения агента GitHub Copilot.
...
О разделении префиксов семейства OpenAI см. [OpenAI](</ru/providers/openai>) и [поставщики моделей](</ru/concepts/model-providers>). Контракт поддержки среды выполнения Codex см. в разделе [Среда выполнения обвязки Codex](</ru/plugins/codex-harness-runtime#v1-support-contract>).
...
Контракт поддержки среды выполнения Codex задокументирован в [среда выполнения среды Codex](</ru/plugins/codex-harness-runtime#v1-support-contract>).

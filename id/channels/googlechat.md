---
title: Google Chat
source_url: https://docs.openclaw.ai/id/channels/googlechat
...
[/code]
  ...
  4. **Otorisasi node untuk akses Funnel:** Jika diminta, kunjungi URL otorisasi yang ditampilkan di output untuk mengaktifkan Funnel bagi node ini dalam kebijakan tailnet Anda.
...
URL Webhook publik Anda akan menjadi: `https://<node-name>.<tailnet>.ts.net/googlechat`

Dasbor privat Anda tetap hanya untuk tailnet: `https://<node-name>.<tailnet>.ts.net:8443/`
...
Jika mengembalikan "Config path not found", tambahkan konfigurasi (lihat Sorotan config).

...
source_url: https://docs.openclaw.ai/tr/gateway/openresponses-http-api
...
Güvenlik notu:
  ...
  * İnternete açık gateway'ler için uygulama düzeyi korumalara ek olarak ağ çıkış denetimleri uygulayın. Bkz. [Güvenlik](</tr/gateway/security>).

...
source_url: https://docs.openclaw.ai/pl/concepts/model-providers
...
[**Modele GLM** [Z.AI](<http://Z.AI>) Coding Plan albo ogólne punkty końcowe API. ](</pl/providers/glm>) [**MiniMax** OAuth MiniMax Coding Plan albo dostęp przez klucz API. ](</pl/providers/minimax>) [**Qwen Cloud** Powierzchnia dostawcy Qwen Cloud oraz mapowanie punktów końcowych Alibaba DashScope i Coding Plan. ](</pl/providers/qwen>)
...
### [Z.AI](<http://Z.AI>) (GLM)
  ...
  * CLI: `openclaw onboard --auth-choice zai-api-key`
    ...
    * `zai-api-key` automatycznie wykrywa pasujący punkt końcowy [Z.AI](<http://Z.AI>); `zai-coding-global`, `zai-coding-cn`, `zai-global` i `zai-cn` wymuszają konkretną powierzchnię

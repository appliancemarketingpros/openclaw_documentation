...
source_url: https://docs.openclaw.ai/it/reference/wizard
scraped_at: 2026-05-25
---

Questa è la reference completa per `openclaw onboard`. Per una panoramica di alto livello, consulta [Onboarding (CLI)](</it/start/wizard>).
...
Gli esempi di comandi specifici per provider si trovano in [Automazione CLI](</it/start/wizard-cli-automation#provider-specific-examples>). Usa questa pagina di reference per la semantica dei flag e l'ordine dei passaggi.

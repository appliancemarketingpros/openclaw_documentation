---
title: प्रकाशन
source_url: https://docs.openclaw.ai/hi/clawhub/publishing
...
catalog repos के लिए, ClawHub के reusable [`skill-publish.yml` workflow](<https://github.com/openclaw/clawhub/blob/main/.github/workflows/skill-publish.yml>) का उपयोग करें। यह `root` के अंतर्गत प्रत्येक immediate skill फ़ोल्डर के लिए `skill publish` कॉल करता है (default: `skills`), या केवल `skill_path` के रूप में दिए गए फ़ोल्डर के लिए।
...
यदि आप किसी org, brand, package scope, owner handle, या namespace के rightful owner हैं जो ClawHub पर पहले से claim या reserve किया गया है, तो public, non-sensitive proof के साथ एक [Org / Namespace Claim issue](<https://github.com/openclaw/clawhub/issues/new?template=org-namespace-claim.yml>) खोलें। क्या शामिल करना है और public issues से क्या बाहर रखना है, इसके लिए [Org और Namespace Claims](</hi/clawhub/namespace-claims>) देखें।
...
### Plugin प्रकाशित करने से पहले
  ...
  * प्रकाशित करने से पहले `clawhub package validate <source>` चलाएं। package, manifest, SDK import, या artifact findings के लिए, [Plugin validation fixes](</hi/clawhub/plugin-validation-fixes>) देखें।
...
यदि आपके पास current owner तक access नहीं है लेकिन आपको लगता है कि आपका org, project, या brand rightful namespace owner है, तो staff review के लिए public, non-sensitive proof के साथ एक [Org / Namespace Claim issue](<https://github.com/openclaw/clawhub/issues/new?template=org-namespace-claim.yml>) खोलें। file करने से पहले [Org और Namespace Claims](</hi/clawhub/namespace-claims>) देखें।

...
source_url: https://docs.openclaw.ai/ru/gateway/local-models
...
Для локальных серверов, которые должны запускаться только тогда, когда они нужны выбранной модели, см. [Сервисы локальных моделей](</ru/gateway/local-model-services>).

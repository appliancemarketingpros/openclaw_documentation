---
title: 訊息
source_url: https://docs.openclaw.ai/zh-TW/cli/message
scraped_at: 2026-05-25
---

# `openclaw message`

用於傳送訊息和頻道動作的單一傳出指令 (Discord/Google Chat/iMessage/Matrix/Mattermost (Plugin)/Microsoft Teams/Signal/Slack/Telegram/WhatsApp)。

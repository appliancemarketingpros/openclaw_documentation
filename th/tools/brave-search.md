...
source_url: https://docs.openclaw.ai/th/tools/brave-search
...
## รับคีย์ API
  ...
  1. สร้างบัญชี Brave Search API ที่ <https://brave.com/search/api/>
...
การตั้งค่าการค้นหา Brave เฉพาะผู้ให้บริการตอนนี้อยู่ใต้ `plugins.entries.brave.config.webSearch.*` ค่าเดิม `tools.web.search.apiKey` ยังโหลดผ่าน compatibility shim ได้ แต่ไม่ใช่เส้นทางคอนฟิกมาตรฐานอีกต่อไป

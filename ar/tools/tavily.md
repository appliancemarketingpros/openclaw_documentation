---
title: Tavily
source_url: https://docs.openclaw.ai/ar/tools/tavily
...
[**نظرة عامة على Web Search** جميع المزودين وقواعد الاكتشاف التلقائي. ](</ar/tools/web>) [**Firecrawl** بحث مع كشط واستخراج محتوى. ](</ar/tools/firecrawl>) [**Exa Search** بحث عصبي مع استخراج محتوى. ](</ar/tools/exa-search>) [**الإعداد** مخطط الإعداد الكامل لإدخالات Plugin وتوجيه الأدوات. ](</ar/gateway/configuration>)

---
title: ข้อความ
source_url: https://docs.openclaw.ai/th/concepts/messages
...
โทเค็นเงียบที่ตรงตัว `NO_REPLY` / `no_reply` หมายถึง "อย่าส่งการตอบกลับที่ผู้ใช้มองเห็นได้" เมื่อเทิร์นหนึ่งยังมีสื่อเครื่องมือที่รออยู่ เช่น เสียง TTS ที่สร้างขึ้น OpenClaw จะตัดข้อความเงียบออกแต่ยังส่งไฟล์แนบสื่อนั้น OpenClaw แก้พฤติกรรมนั้นตามประเภทบทสนทนา:

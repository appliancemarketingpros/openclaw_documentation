...
source_url: https://docs.openclaw.ai/th/concepts/memory-builtin
...
พิจารณาเปลี่ยนไปใช้ [QMD](</th/concepts/memory-qmd>) หากคุณต้องการ reranking, query expansion หรือต้องการจัดทำดัชนีไดเรกทอรีนอกพื้นที่ทำงาน

พิจารณา [Honcho](</th/concepts/memory-honcho>) หากคุณต้องการหน่วยความจำข้ามเซสชันพร้อม การสร้างโมเดลผู้ใช้โดยอัตโนมัติ
...
สำหรับการตั้งค่าผู้ให้บริการ embedding, การปรับแต่งการค้นหาแบบไฮบริด (น้ำหนัก, MMR, temporal decay), การจัดทำดัชนีแบบแบตช์, หน่วยความจำมัลติโหมด, sqlite-vec, เส้นทางเพิ่มเติม และปุ่มตั้งค่า อื่นๆ ทั้งหมด ดู [ข้อมูลอ้างอิงการตั้งค่าหน่วยความจำ](</th/reference/memory-config>)

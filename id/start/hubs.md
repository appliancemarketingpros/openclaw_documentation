...
source_url: https://docs.openclaw.ai/id/start/hubs
scraped_at: 2026-05-25
---

Gunakan hub ini untuk menemukan setiap halaman, termasuk pendalaman dan dokumentasi referensi yang tidak muncul di navigasi kiri.
...
## Mulai di sini
  ...
  * [Dashboard (Gateway lokal)](<http://127.0.0.1:18789/>)
  * [Bantuan](</id/help>)
  * [Direktori dokumentasi](</id/start/docs-directory>)
...
## Instalasi + pembaruan
  ...
  * [Nix](</id/install/nix>)
  * [Memperbarui / rollback](</id/install/updating>)
  * [Alur kerja Bun (eksperimental)](</id/install/bun>)


## Konsep inti

  * [Arsitektur](</id/concepts/architecture>)
  ...
  * [Streaming + pemotongan chunk](</id/concepts/streaming>)
  ...
  * [Penemuan + transport](</id/gateway/discovery>)
  ...
  * [OAuth](</id/concepts/oauth>)


## Penyedia + ingress

  * [Hub channel chat](</id/channels>)
  * [Hub penyedia model](</id/providers/models>)
...
## Gateway + operasi
  ...
  * [Model jaringan](</id/network#core-model>)
...
## Platform
  ...
  * [Ringkasan platform](</id/platforms>)
  * [macOS](</id/platforms/macos>)
  * [iOS](</id/platforms/ios>)
  * [Android](</id/platforms/android>)
  * [Windows (WSL2)](</id/platforms/windows>)
  * [Linux](</id/platforms/linux>)
  * [Permukaan web](</id/web>)


## Aplikasi pendamping macOS (lanjutan)
  ...
  * [Proses anak macOS](</id/platforms/mac/child-process>)
  * [Kesehatan macOS](</id/platforms/mac/health>)
  ...
  * [Skills macOS](</id/platforms/mac/skills>)
  * [Peekaboo macOS](</id/platforms/mac/peekaboo>)


## Plugin

  * [Ringkasan Plugin](</id/tools/plugin>)
...
## Workspace + templat
  ...
  * [AGENTS default](</id/reference/AGENTS.default>)
  * [Templat: AGENTS](</id/reference/templates/AGENTS>)
  * [Templat: BOOTSTRAP](</id/reference/templates/BOOTSTRAP>)
  * [Templat: HEARTBEAT](</id/reference/templates/HEARTBEAT>)
  * [Templat: IDENTITY](</id/reference/templates/IDENTITY>)
  * [Templat: SOUL](</id/reference/templates/SOUL>)
  * [Templat: TOOLS](</id/reference/templates/TOOLS>)
  * [Templat: USER](</id/reference/templates/USER>)


## Proyek

  * [Kredit](</id/reference/credits>)


## Pengujian + rilis

  * [Pengujian](</id/reference/test>)
  * [Kebijakan rilis](</id/reference/RELEASING>)
  * [Model perangkat](</id/reference/device-models>)

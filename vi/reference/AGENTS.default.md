...
source_url: https://docs.openclaw.ai/vi/reference/AGENTS.default
...
[/code]
  ...
  3. Tùy chọn: nếu bạn muốn danh sách Skills cho trợ lý cá nhân, hãy thay [AGENTS.md](<http://AGENTS.md>) bằng tệp này:

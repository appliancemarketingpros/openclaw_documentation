---
title: QR
source_url: https://docs.openclaw.ai/hi/cli/qr
...
## नोट्स
  ...
  * `--remote` के साथ, OpenClaw को या तो `gateway.remote.url` या `gateway.tailscale.mode=serve|funnel` की आवश्यकता होती है।

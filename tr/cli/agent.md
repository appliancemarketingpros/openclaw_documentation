---
title: Ajan
source_url: https://docs.openclaw.ai/tr/cli/agent
scraped_at: 2026-05-25
---

# `openclaw agent`

Gateway üzerinden bir agent turn çalıştırın (gömülü için `--local` kullanın). Yapılandırılmış bir ajanı doğrudan hedeflemek için `--agent <id>` kullanın.

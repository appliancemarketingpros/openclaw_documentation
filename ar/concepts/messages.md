---
title: الرسائل
source_url: https://docs.openclaw.ai/ar/concepts/messages
...
يرسل بث الكتل ردودًا جزئية بينما ينتج النموذج كتلًا نصية. يحترم التقسيم إلى أجزاء حدود نص القناة ويتجنب تقسيم الشيفرات المسيّجة.

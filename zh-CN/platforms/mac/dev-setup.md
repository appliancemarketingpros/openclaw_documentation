...
关于开发运行模式、签名标志和 Team ID 故障排除，请参阅 macOS 应用 README： <https://github.com/openclaw/openclaw/blob/main/apps/macos/README.md>
...
`pnpm add -g openclaw@<version>` 和 `bun add -g openclaw@<version>` 也可以使用。 对于 Gateway 网关运行时，Node 仍是推荐路径。

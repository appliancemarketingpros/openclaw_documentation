---
title: SMS
source_url: https://docs.openclaw.ai/fr/channels/sms
...
[**Pairing** La politique de messages directs par défaut pour les SMS est l’appairage. ](</fr/channels/pairing>) [**Gateway security** Examinez l’exposition du Webhook et les contrôles d’accès des expéditeurs. ](</fr/gateway/security>) [**Channel troubleshooting** Diagnostics intercanaux et procédures de réparation. ](</fr/channels/troubleshooting>)
...
* ### Pointer Twilio vers le Webhook du Gateway

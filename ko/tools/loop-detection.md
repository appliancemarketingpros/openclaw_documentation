---
title: 도구 루프 감지
source_url: https://docs.openclaw.ai/ko/tools/loop-detection
...
[**Exec approvals** 셸 실행에 대한 허용/거부 정책입니다. ](</ko/tools/exec-approvals>) [**Thinking levels** 추론 노력 수준과 공급자 정책 상호작용입니다. ](</ko/tools/thinking>) [**Sub-agents** 폭주 동작을 제한하기 위해 격리된 에이전트를 생성합니다. ](</ko/tools/subagents>) [**Configuration reference** 전체 `tools.loopDetection` 스키마와 병합 의미 체계입니다. ](</ko/gateway/configuration-reference>)

...
source_url: https://docs.openclaw.ai/es/plan/ui-channels
...
La documentación canónica ahora está en [Presentación de mensajes](</es/plugins/message-presentation>). Conserva este plan como contexto histórico de implementación; actualiza la guía canónica para cambios en el contrato, el renderizador o el comportamiento de reserva.

...
source_url: https://docs.openclaw.ai/it/concepts/parallel-specialist-lanes
...
OpenClaw serializza già le esecuzioni per sessione e limita il parallelismo globale tramite la [coda dei comandi](</it/concepts/queue>). Le corsie specialistiche aggiungono una policy sopra: quale agente possiede quale lavoro, cosa resta in chat e cosa diventa lavoro in background.

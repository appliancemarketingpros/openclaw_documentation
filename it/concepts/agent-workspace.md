...
source_url: https://docs.openclaw.ai/it/concepts/agent-workspace
...
MEMORY.md - memoria a lungo termine curata (opzionale)
...
skills/ - Skills dello workspace (opzionale)
...
canvas/ - file dell'interfaccia Canvas (opzionale)
...
## Correlati
  ...
  * [Heartbeat](</it/gateway/heartbeat>) \- file workspace [HEARTBEAT.md](<http://HEARTBEAT.md>)

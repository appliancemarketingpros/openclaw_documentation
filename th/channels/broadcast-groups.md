...
source_url: https://docs.openclaw.ai/th/channels/broadcast-groups
...
เอเจนต์แต่ละตัวในกลุ่มบรอดคาสต์จะรักษาสิ่งต่อไปนี้แยกจากกันโดยสมบูรณ์:
  ...
  * **หน่วยความจำ/บริบท** ([IDENTITY.md](<http://IDENTITY.md>), [SOUL.md](<http://SOUL.md>) ฯลฯ แยกกัน)
...
ตัวอย่างที่ 1: ทีมรีวิวโค้ด jsonCopy code
[code]
...
ตัวอย่างที่ 2: การรองรับหลายภาษา jsonCopy code
[code]

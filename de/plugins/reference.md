...
source_url: https://docs.openclaw.ai/de/plugins/reference
scraped_at: 2026-05-25
---

# Plugin-Referenz

Diese Seite wird aus `extensions/*/package.json` und `openclaw.plugin.json` generiert. Regenerieren Sie sie mit:
...
---|---|---|---  
[acpx](</de/plugins/reference/acpx>) | Eingebettetes ACP-Laufzeit-Backend mit Plugin-eigener Sitzungs- und Transportverwaltung. | `@openclaw/acpx` |   
npm; ClawHub | skills |  |   
...
[bonjour](</de/plugins/reference/bonjour>) | Kündigt das lokale OpenClaw-Gateway über Bonjour/mDNS an. | `@openclaw/bonjour` |   
in OpenClaw enthalten | plugin |  |   
[brave](</de/plugins/reference/brave>) | Fügt Unterstützung für Websuch-Provider hinzu. | `@openclaw/brave-plugin` |   
npm; ClawHub | contracts: webSearchProviders |  |   
[browser](</de/plugins/reference/browser>) | Fügt Tools hinzu, die von Agenten aufgerufen werden können. | `@openclaw/browser-plugin` |   
...
[canvas](</de/plugins/reference/canvas>) | Experimentelle Canvas-Steuerungs- und A2UI-Rendering-Oberflächen für gekoppelte Nodes. | `@openclaw/canvas-plugin` |   
...
[deepgram](</de/plugins/reference/deepgram>) | Fügt Unterstützung für Provider zum Medienverständnis hinzu. Fügt Unterstützung für Provider zur Echtzeittranskription hinzu. | `@openclaw/deepgram-provider` |   
...
[deepseek](</de/plugins/reference/deepseek>) | Fügt OpenClaw Unterstützung für DeepSeek-Modell-Provider hinzu. | `@openclaw/deepseek-provider` |   
in OpenClaw enthalten | providers: deepseek |  |   
[diagnostics-otel](</de/plugins/reference/diagnostics-otel>) | OpenTelemetry-Exporter für OpenClaw-Diagnose. | `@openclaw/diagnostics-otel` |   
npm; ClawHub: `clawhub:@openclaw/diagnostics-otel` | plugin |  |   
[diagnostics-prometheus](</de/plugins/reference/diagnostics-prometheus>) | Prometheus-Exporter für OpenClaw-Diagnose. | `@openclaw/diagnostics-prometheus` |   
...
[duckduckgo](</de/plugins/reference/duckduckgo>) | Fügt Unterstützung für Websuch-Provider hinzu. | `@openclaw/duckduckgo-plugin` |   
in OpenClaw enthalten | contracts: webSearchProviders |  |   
[elevenlabs](</de/plugins/reference/elevenlabs>) | Fügt Unterstützung für Provider zum Medienverständnis hinzu. Fügt Unterstützung für Provider zur Echtzeittranskription hinzu. Fügt Unterstützung für Text-zu-Sprache-Provider hinzu. | `@openclaw/elevenlabs-speech` |   
in OpenClaw enthalten | contracts: mediaUnderstandingProviders, realtimeTranscriptionProviders, speechProviders |  |   
[exa](</de/plugins/reference/exa>) | Fügt Unterstützung für Websuch-Provider hinzu. | `@openclaw/exa-plugin` |   
in OpenClaw enthalten | contracts: webSearchProviders |  |   
[fal](</de/plugins/reference/fal>) | Fügt OpenClaw Unterstützung für fal-Modell-Provider hinzu. | `@openclaw/fal-provider` |   
...
[file-transfer](</de/plugins/reference/file-transfer>) | Ruft Dateien auf gekoppelten Nodes über dedizierte Node-Befehle ab, listet sie auf und schreibt sie. Umgeht die Kürzung von bash-stdout durch Verwendung von base64 über node.invoke für Binärdateien bis zu 16 MB. | `@openclaw/file-transfer` |   
in OpenClaw enthalten | contracts: tools |  |   
[firecrawl](</de/plugins/reference/firecrawl>) | Fügt von Agenten aufrufbare Werkzeuge hinzu. Fügt Unterstützung für Webabruf-Provider hinzu. Fügt Unterstützung für Websuch-Provider hinzu. | `@openclaw/firecrawl-plugin` |   
in OpenClaw enthalten | contracts: tools, webFetchProviders, webSearchProviders |  |   
[fireworks](</de/plugins/reference/fireworks>) | Fügt OpenClaw Unterstützung für Fireworks-Modell-Provider hinzu. | `@openclaw/fireworks-provider` |   
in OpenClaw enthalten | providers: fireworks |  |   
[github-copilot](</de/plugins/reference/github-copilot>) | Fügt OpenClaw Unterstützung für GitHub Copilot-Modell-Provider hinzu. | `@openclaw/github-copilot-provider` |   
in OpenClaw enthalten | providers: github-copilot; contracts: memoryEmbeddingProviders |  |   
[google](</de/plugins/reference/google>) | Fügt OpenClaw Unterstützung für Google-, Google Gemini CLI- und Google Vertex-Modell-Provider hinzu. | `@openclaw/google-plugin` |   
...
[google-meet](</de/plugins/reference/google-meet>) | Ermöglicht die Teilnahme an Google Meet-Anrufen über Chrome- oder Twilio-Transporte. | `@openclaw/google-meet` |   
...
in OpenClaw enthalten | contracts: speechProviders |  |   
[groq](</de/plugins/reference/groq>) | Fügt Unterstützung für den Groq-Modell-Provider zu OpenClaw hinzu. | `@openclaw/groq-provider` |   
in OpenClaw enthalten | providers: groq; contracts: mediaUnderstandingProviders |  |   
[huggingface](</de/plugins/reference/huggingface>) | Fügt Unterstützung für den Hugging Face-Modell-Provider zu OpenClaw hinzu. | `@openclaw/huggingface-provider` |   
...
[kilocode](</de/plugins/reference/kilocode>) | Fügt Unterstützung für den Kilocode-Modell-Provider zu OpenClaw hinzu. | `@openclaw/kilocode-provider` |   
in OpenClaw enthalten | providers: kilocode |  |   
[kimi](</de/plugins/reference/kimi>) | Fügt Unterstützung für Kimi- und Kimi Coding-Modell-Provider zu OpenClaw hinzu. | `@openclaw/kimi-provider` |   
...
[litellm](</de/plugins/reference/litellm>) | Fügt Unterstützung für den LiteLLM-Modell-Provider zu OpenClaw hinzu. | `@openclaw/litellm-provider` |   
...
in OpenClaw enthalten | contracts: tools |  |   
[lmstudio](</de/plugins/reference/lmstudio>) | Fügt Unterstützung für den LM Studio-Modell-Provider zu OpenClaw hinzu. | `@openclaw/lmstudio-provider` |   
...
[mattermost](</de/plugins/reference/mattermost>) | Fügt die Mattermost-Kanaloberfläche zum Senden und Empfangen von OpenClaw-Nachrichten hinzu. | `@openclaw/mattermost` |   
in OpenClaw enthalten | channels: mattermost |  |   
[memory-core](</de/plugins/reference/memory-core>) | Fügt Unterstützung für Memory-Embedding-Provider hinzu. Fügt von Agenten aufrufbare Tools hinzu. | `@openclaw/memory-core` |   
...
npm; ClawHub | contracts: tools |  |   
[memory-wiki](</de/plugins/reference/memory-wiki>) | Persistenter Wiki-Compiler und Obsidian-freundlicher Wissensspeicher für OpenClaw. | `@openclaw/memory-wiki` |   
in OpenClaw enthalten | contracts: tools; skills |  |   
[microsoft](</de/plugins/reference/microsoft>) | Fügt Unterstützung für Text-to-Speech-Provider hinzu. | `@openclaw/microsoft-speech` |   
in OpenClaw enthalten | contracts: speechProviders |  |   
[microsoft-foundry](</de/plugins/reference/microsoft-foundry>) | Fügt OpenClaw Unterstützung für Microsoft Foundry als Modell-Provider hinzu. | `@openclaw/microsoft-foundry` |   
...
[migrate-hermes](</de/plugins/reference/migrate-hermes>) | Importiert Hermes-Konfiguration, Speicherinhalte, Skills und unterstützte Anmeldedaten in OpenClaw. | `@openclaw/migrate-hermes` |   
in OpenClaw enthalten | contracts: migrationProviders |  |   
[minimax](</de/plugins/reference/minimax>) | Fügt OpenClaw Unterstützung für MiniMax und MiniMax Portal als Modell-Provider hinzu. | `@openclaw/minimax-provider` |   
...
[mistral](</de/plugins/reference/mistral>) | Fügt OpenClaw Unterstützung für Mistral als Modell-Provider hinzu. | `@openclaw/mistral-provider` |   
...
[moonshot](</de/plugins/reference/moonshot>) | Fügt OpenClaw Unterstützung für Moonshot als Modell-Provider hinzu. | `@openclaw/moonshot-provider` |   
in OpenClaw enthalten | providers: moonshot; contracts: mediaUnderstandingProviders, webSearchProviders |  |   
[msteams](</de/plugins/reference/msteams>) | Fügt die Microsoft Teams-Channel-Oberfläche zum Senden und Empfangen von OpenClaw-Nachrichten hinzu. | `@openclaw/msteams` |   
npm; ClawHub | channels: msteams |  |   
[nextcloud-talk](</de/plugins/reference/nextcloud-talk>) | Fügt die Nextcloud Talk-Channel-Oberfläche zum Senden und Empfangen von OpenClaw-Nachrichten hinzu. | `@openclaw/nextcloud-talk` |   
npm; ClawHub | channels: nextcloud-talk |  |   
[nostr](</de/plugins/reference/nostr>) | Fügt die Nostr-Channel-Oberfläche zum Senden und Empfangen von OpenClaw-Nachrichten hinzu. | `@openclaw/nostr` |   
npm; ClawHub | channels: nostr |  |   
[nvidia](</de/plugins/reference/nvidia>) | Fügt OpenClaw Unterstützung für NVIDIA als Modell-Provider hinzu. | `@openclaw/nvidia-provider` |   
in OpenClaw enthalten | providers: nvidia |  |   
[oc-path](</de/plugins/reference/oc-path>) | Fügt die openclaw-Pfad-CLI für die Adressierung von Arbeitsbereichsdateien mit oc:// hinzu. | `@openclaw/oc-path` |   
in OpenClaw enthalten | plugin |  |   
[ollama](</de/plugins/reference/ollama>) | Fügt OpenClaw Unterstützung für Ollama als Modell-Provider hinzu. | `@openclaw/ollama-provider` |   
in OpenClaw enthalten | providers: ollama; contracts: memoryEmbeddingProviders, webSearchProviders |  |   
[open-prose](</de/plugins/reference/open-prose>) | OpenProse-VM-Skill-Paket mit einem /prose-Slash-Befehl. | `@openclaw/open-prose` |   
in OpenClaw enthalten | skills |  |   
[openai](</de/plugins/reference/openai>) | Fügt OpenClaw Unterstützung für OpenAI und OpenAI Codex als Modell-Provider hinzu. | `@openclaw/openai-provider` |   
...
[opencode](</de/plugins/reference/opencode>) | Fügt OpenClaw Unterstützung für OpenCode als Modell-Provider hinzu. | `@openclaw/opencode-provider` |   
in OpenClaw enthalten | providers: opencode; contracts: mediaUnderstandingProviders |  |   
[opencode-go](</de/plugins/reference/opencode-go>) | Fügt OpenClaw Unterstützung für OpenCode Go als Modell-Provider hinzu. | `@openclaw/opencode-go-provider` |   
in OpenClaw enthalten | providers: opencode-go; contracts: mediaUnderstandingProviders |  |   
[openrouter](</de/plugins/reference/openrouter>) | Fügt OpenClaw Unterstützung für OpenRouter als Modell-Provider hinzu. | `@openclaw/openrouter-provider` |   
...
[openshell](</de/plugins/reference/openshell>) | Sandbox-Backend auf Basis von OpenShell mit gespiegelten lokalen Arbeitsbereichen und SSH-basierter Befehlsausführung. | `@openclaw/openshell-sandbox` |   
in OpenClaw enthalten | plugin |  |   
[perplexity](</de/plugins/reference/perplexity>) | Fügt Unterstützung für Websuch-Provider hinzu. | `@openclaw/perplexity-plugin` |   
in OpenClaw enthalten | contracts: webSearchProviders |  |   
[qa-channel](</de/plugins/reference/qa-channel>) | Fügt die QA-Channel-Oberfläche zum Senden und Empfangen von OpenClaw-Nachrichten hinzu. | `@openclaw/qa-channel` |   
...
nur Source-Checkout | plugin |  |   
[qianfan](</de/plugins/reference/qianfan>) | Fügt OpenClaw Unterstützung für Qianfan-Modell-Provider hinzu. | `@openclaw/qianfan-provider` |   
...
[qwen](</de/plugins/reference/qwen>) | Fügt OpenClaw Unterstützung für Qwen-, Qwen Cloud-, Model Studio- und DashScope-Modell-Provider hinzu. | `@openclaw/qwen-provider` |   
...
[runway](</de/plugins/reference/runway>) | Fügt Unterstützung für Provider für Videogenerierung hinzu. | `@openclaw/runway-provider` |   
in OpenClaw enthalten | contracts: videoGenerationProviders |  |   
[searxng](</de/plugins/reference/searxng>) | Fügt Unterstützung für Websuch-Provider hinzu. | `@openclaw/searxng-plugin` |   
in OpenClaw enthalten | contracts: webSearchProviders |  |   
[senseaudio](</de/plugins/reference/senseaudio>) | Fügt Unterstützung für Provider für Medienverständnis hinzu. | `@openclaw/senseaudio-provider` |   
in OpenClaw enthalten | contracts: mediaUnderstandingProviders |  |   
[sglang](</de/plugins/reference/sglang>) | Fügt OpenClaw Unterstützung für SGLang-Modell-Provider hinzu. | `@openclaw/sglang-provider` |   
...
[skill-workshop](</de/plugins/reference/skill-workshop>) | Erfasst wiederholbare Workflows als Workspace-Skills, mit ausstehender Prüfung, sicheren Schreibvorgängen und Skill-Prompt-Aktualisierung. | `@openclaw/skill-workshop` |   
in OpenClaw enthalten | contracts: tools |  |   
...
[stepfun](</de/plugins/reference/stepfun>) | Fügt OpenClaw Unterstützung für StepFun- und StepFun Plan-Modell-Provider hinzu. | `@openclaw/stepfun-provider` |   
...
[synthetic](</de/plugins/reference/synthetic>) | Fügt OpenClaw Unterstützung für Synthetic-Modell-Provider hinzu. | `@openclaw/synthetic-provider` |   
in OpenClaw enthalten | providers: synthetic |  |   
[tavily](</de/plugins/reference/tavily>) | Fügt agentenaufrufbare Tools hinzu. Fügt Unterstützung für Websuch-Provider hinzu. | `@openclaw/tavily-plugin` |   
...
[tencent](</de/plugins/reference/tencent>) | Fügt OpenClaw Unterstützung für Tencent TokenHub-Modell-Provider hinzu. | `@openclaw/tencent-provider` |   
...
[tokenjuice](</de/plugins/reference/tokenjuice>) | Verdichtet Ergebnisse der exec- und bash-Tools mit tokenjuice-Reduzierern. | `@openclaw/tokenjuice` |   
...
[voice-call](</de/plugins/reference/voice-call>) | Fügt vom Agent aufrufbare Tools hinzu. | `@openclaw/voice-call` |   
npm; ClawHub | contracts: tools |  |   
[volcengine](</de/plugins/reference/volcengine>) | Fügt OpenClaw Unterstützung für Volcengine- und Volcengine Plan-Modell-Provider hinzu. | `@openclaw/volcengine-provider` |   
...
[web-readability](</de/plugins/reference/web-readability>) | Extrahiert lesbaren Artikelinhalt aus lokalen HTML-Webabrufantworten. | `@openclaw/web-readability-plugin` |   

---
title: メモリ
source_url: https://docs.openclaw.ai/ja-JP/cli/memory
scraped_at: 2026-05-25
---

# `openclaw memory`

セマンティックメモリのインデックス作成と検索を管理します。 有効なメモリPluginが提供します（デフォルト: `memory-core`。無効化するには `plugins.slots.memory = "none"` を設定します）。

---
title: Gruplar
source_url: https://docs.openclaw.ai/tr/channels/groups
...
Gateway, dosya kaydedildikten sonra `messages` yapılandırmasını canlı yeniden yükler. Yalnızca dağıtımda dosya izleme veya yapılandırma yeniden yükleme devre dışıysa yeniden başlatın.

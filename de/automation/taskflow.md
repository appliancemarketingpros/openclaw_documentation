...
source_url: https://docs.openclaw.ai/de/automation/taskflow
...
Jeder Flow persistiert seinen eigenen Zustand und verfolgt Revisionen, damit der Fortschritt Gateway-Neustarts übersteht. Die Revisionsverfolgung ermöglicht Konflikterkennung, wenn mehrere Quellen gleichzeitig versuchen, denselben Flow fortzusetzen. Die Flow-Registry verwendet SQLite mit begrenzter Write-Ahead-Log-Wartung, einschließlich periodischer und Shutdown-Checkpoints, sodass langfristig laufende Gateways keine unbegrenzten `registry.sqlite-wal`-Sidecar-Dateien behalten.

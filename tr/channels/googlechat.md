---
title: Google Chat
source_url: https://docs.openclaw.ai/tr/channels/googlechat
...
[/code]
  ...
  4. **Node'u Funnel erişimi için yetkilendirin:** İstenirse, tailnet ilkenizde bu Node için Funnel'ı etkinleştirmek üzere çıktıda gösterilen yetkilendirme URL'sini ziyaret edin.
...
Genel Webhook URL'niz şu olur: `https://<node-name>.<tailnet>.ts.net/googlechat`

Özel dashboard'unuz yalnızca tailnet'te kalır: `https://<node-name>.<tailnet>.ts.net:8443/`
...
"Config path not found" döndürürse yapılandırmayı ekleyin (bkz. Config öne çıkanlar).

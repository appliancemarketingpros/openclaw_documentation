...
source_url: https://docs.openclaw.ai/it/channels/zalouser
...
Se usi una build precedente o un'installazione personalizzata che esclude Zalo Personal, installa direttamente il pacchetto npm:

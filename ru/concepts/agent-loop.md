---
title: Цикл агента
source_url: https://docs.openclaw.ai/ru/concepts/agent-loop
...
## Очереди + параллелизм
  ...
  * Каналы сообщений могут выбирать режимы очереди (steer/followup/collect/interrupt), которые подаются в эту систему полос. См. [Очередь команд](</ru/concepts/queue>).

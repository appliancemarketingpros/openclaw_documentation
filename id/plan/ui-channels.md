...
source_url: https://docs.openclaw.ai/id/plan/ui-channels
...
Dokumentasi kanonis sekarang berada di [Presentasi Pesan](</id/plugins/message-presentation>). Simpan rencana ini sebagai konteks implementasi historis; perbarui panduan kanonis untuk perubahan kontrak, perender, atau perilaku fallback.

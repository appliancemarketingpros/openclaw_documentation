---
title: रेलवे
source_url: https://docs.openclaw.ai/hi/install/railway
...
एक-क्लिक टेम्पलेट के साथ Railway पर OpenClaw डिप्लॉय करें और इसे वेब Control UI के माध्यम से एक्सेस करें। यह सबसे आसान "सर्वर पर कोई टर्मिनल नहीं" रास्ता है: Railway आपके लिए Gateway चलाता है।
...
[ Railway पर डिप्लॉय करें ](<https://railway.com/deploy/clawdbot-railway-template>)
...
## आपको क्या मिलता है
  ...
  * Railway Volume (`/data`) के माध्यम से स्थायी स्टोरेज, ताकि `openclaw.json`, प्रति-एजेंट `auth-profiles.json`, चैनल/प्रोवाइडर स्थिति, सत्र, और वर्कस्पेस पुनः डिप्लॉयमेंट के बाद भी बने रहें
...
यह OpenClaw स्थिति और किसी भी कॉन्फ़िगर किए गए वर्कस्पेस के साथ एक पोर्टेबल बैकअप आर्काइव बनाता है। विवरण के लिए [बैकअप](</hi/cli/backup>) देखें।

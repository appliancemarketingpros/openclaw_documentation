...
source_url: https://docs.openclaw.ai/nl/automation/cron-jobs
...
### Model- en thinking-overschrijving
...
OPENCLAW_DOCS_MARKER:accordionOpen:IHRpdGxlPSJHZW1hcHRlIGhvb2tzIChQT1NUIC9ob29rcy88bmFtZQ )"> Aangepaste hooknamen worden opgelost via `hooks.mappings` in de configuratie. Mappings kunnen willekeurige payloads omzetten in `wake`\- of `agent`-acties met templates of codetransformaties.
...
* ### Maak topic aan en verleen Gmail-pushtoegang
...
Cron is geactiveerd, maar er is geen aflevering
...
Cron of Heartbeat lijkt /new-style-rollover te verhinderen

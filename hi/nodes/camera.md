---
title: कैमरा कैप्चर
source_url: https://docs.openclaw.ai/hi/nodes/camera
...
यदि permissions अनुपस्थित हैं, तो ऐप संभव होने पर prompt करेगा; यदि denied हो, तो `camera.*` requests `*_PERMISSION_REQUIRED` error के साथ fail होती हैं।

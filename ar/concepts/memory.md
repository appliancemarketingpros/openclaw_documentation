...
source_url: https://docs.openclaw.ai/ar/concepts/memory
...
[**مدمجة (افتراضي)** قائمة على SQLite. تعمل مباشرة مع البحث بالكلمات المفتاحية، وتشابه المتجهات، والبحث الهجين. لا توجد تبعيات إضافية. ](</ar/concepts/memory-builtin>) [**QMD** خدمة جانبية محلية أولًا مع إعادة ترتيب النتائج، وتوسيع الاستعلامات، والقدرة على فهرسة أدلة خارج مساحة العمل. ](</ar/concepts/memory-qmd>) [**Honcho** ذاكرة أصلية للذكاء الاصطناعي عبر الجلسات مع نمذجة المستخدم، والبحث الدلالي، والوعي بعدة وكلاء. تثبيت Plugin. ](</ar/concepts/memory-honcho>) [**LanceDB** ذاكرة مضمنة مدعومة بـ LanceDB مع تضمينات متوافقة مع OpenAI، واستدعاء تلقائي، والتقاط تلقائي، ودعم تضمينات Ollama المحلية. ](</ar/plugins/memory-lancedb>)

## طبقة ويكي المعرفة

[**Memory Wiki** تجمع الذاكرة الدائمة في خزنة ويكي غنية بالمصدرية مع ادعاءات، ولوحات معلومات، ووضع جسر، وتدفقات عمل ملائمة لـ Obsidian. ](</ar/plugins/memory-wiki>)

...
source_url: https://docs.openclaw.ai/nl/concepts/markdown-formatting
...
Als je meer nodig hebt over chunking-gedrag tussen kanalen, zie [Streaming + chunking](</nl/concepts/streaming>).
...
[**Streaming and chunking** Gedrag van uitgaande streaming, chunkgrenzen en kanaalspecifieke levering. ](</nl/concepts/streaming>) [**System prompt** Wat het model ziet vóór het gesprek, inclusief geïnjecteerde workspace-bestanden. ](</nl/concepts/system-prompt>)

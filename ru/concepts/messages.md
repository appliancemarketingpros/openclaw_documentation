---
title: Сообщения
source_url: https://docs.openclaw.ai/ru/concepts/messages
...
Буферы истории являются **только ожидающими** : они включают групповые сообщения, которые _не_ запустили прогон (например, сообщения, пропущенные через фильтр упоминаний), и **исключают** сообщения, уже находящиеся в стенограмме сеанса.

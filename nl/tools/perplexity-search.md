...
source_url: https://docs.openclaw.ai/nl/tools/perplexity-search
...
**Via omgeving:** stel `PERPLEXITY_API_KEY` of `OPENROUTER_API_KEY` in in de procesomgeving van de Gateway. Plaats dit voor een gateway-installatie in `~/.openclaw/.env` (of in je serviceomgeving). Zie [Omgevingsvariabelen](</nl/help/faq#env-vars-and-env-loading>).
...
[**Web search overview** Alle providers en regels voor automatische detectie. ](</nl/tools/web>) [**Brave search** Gestructureerde resultaten met land- en taalfilters. ](</nl/tools/brave-search>) [**Exa search** Neuraal zoeken met inhoudsextractie. ](</nl/tools/exa-search>) [**Perplexity Search API docs** Officiële quickstart en referentie voor de Perplexity Search API. ](<https://docs.perplexity.ai/docs/search/quickstart>)

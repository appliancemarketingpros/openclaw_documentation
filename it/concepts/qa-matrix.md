---
title: Matrice QA
source_url: https://docs.openclaw.ai/it/concepts/qa-matrix
...
---|---|---  
`--profile <profile>` | `all` | Profilo scenario. Vedi Profili.  
`--fail-fast` | disattivato | Ferma l'esecuzione dopo il primo controllo o scenario non riuscito.  
`--scenario <id>` | - | Esegue solo questo scenario. Ripetibile. Vedi Scenari.  

---
title: Signal
source_url: https://docs.openclaw.ai/vi/channels/signal
...
Nếu bạn dùng bản dựng JVM (`signal-cli-${VERSION}.tar.gz`), hãy cài JRE 25+ trước. Luôn cập nhật `signal-cli`; upstream lưu ý rằng các bản phát hành cũ có thể hỏng khi API máy chủ Signal thay đổi.
...
Tùy chọn nhà cung cấp:
  ...
  * `channels.signal.apiMode`: `auto | native | container` (mặc định: auto). Xem Chế độ container.

...
source_url: https://docs.openclaw.ai/pt-BR/plan/ui-channels
...
A documentação canônica agora está em [Apresentação de Mensagens](</pt-BR/plugins/message-presentation>). Mantenha este plano como contexto histórico de implementação; atualize o guia canônico para alterações de contrato, renderizador ou comportamento de fallback.

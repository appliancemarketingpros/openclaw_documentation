...
source_url: https://docs.openclaw.ai/ar/security/formal-verification
...
**الهدف (النجم الهادي):** تقديم حجة متحقَّق منها آليًا بأن OpenClaw يفرض سياسة الأمان المقصودة لديه (التفويض، وعزل الجلسات، وتقييد الأدوات، والسلامة في حالات سوء التهيئة)، ضمن افتراضات صريحة.

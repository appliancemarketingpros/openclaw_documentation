...
source_url: https://docs.openclaw.ai/th/gateway/discovery
...
## คำศัพท์
  ...
  * **บริดจ์ TCP แบบเดิม (นำออกแล้ว)** : การขนส่ง Node รุ่นเก่า (ดู [โปรโตคอล Bridge](</th/gateway/bridge-protocol>)); ไม่ถูกประกาศสำหรับ การค้นพบอีกต่อไปและไม่เป็นส่วนหนึ่งของบิลด์ปัจจุบันอีกต่อไป

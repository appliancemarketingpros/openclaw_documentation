---
title: ClawDock
source_url: https://docs.openclaw.ai/ja-JP/install/clawdock
...
[**Docker** OpenClaw の正規 Docker インストール。 ](</ja-JP/install/docker>) [**Docker VM runtime** 強化された分離のための Docker 管理 VM ランタイム。 ](</ja-JP/install/docker-vm-runtime>) [**Updating** OpenClaw パッケージと管理対象サービスの更新。 ](</ja-JP/install/updating>)

---
title: هدایت
source_url: https://docs.openclaw.ai/fa/tools/steer
...
برای حالت‌های صف و رفتار جایگزین، [صف فرمان](</fa/concepts/queue>) و [صف هدایت](</fa/concepts/queue-steering>) را ببینید.
...
`/steer` سطح بالا یک زیرعامل را با شناسه یا اندیس فهرست انتخاب نمی‌کند. همیشه اجرای فعال نشست فعلی را هدف می‌گیرد. برای شناسه‌ها، برچسب‌ها و فرمان‌های کنترلی زیرعامل، [زیرعامل‌ها](</fa/tools/subagents>) را ببینید.

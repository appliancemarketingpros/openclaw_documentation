...
source_url: https://docs.openclaw.ai/ko/plan/ui-channels
...
정식 문서는 이제 [메시지 프레젠테이션](</ko/plugins/message-presentation>)에 있습니다. 이 계획은 과거 구현 맥락으로 유지하고, contract, 렌더러, fallback 동작 변경은 정식 가이드에서 업데이트하세요.

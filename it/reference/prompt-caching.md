...
source_url: https://docs.openclaw.ai/it/reference/prompt-caching
...
yamlCopy code
[code]
    diagnostics:  cacheTrace:    enabled: true    filePath: "~/.openclaw/logs/cache-trace.jsonl" # facoltativo    includeMessages: false # predefinito true    includePrompt: false # predefinito true    includeSystem: false # predefinito true
[/code]

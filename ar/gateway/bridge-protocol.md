...
source_url: https://docs.openclaw.ai/ar/gateway/bridge-protocol
...
يمكن للعُقد إصدار أحداث `exec.finished` أو `exec.denied` لإظهار نشاط system.run. تُحوَّل هذه إلى أحداث نظام في Gateway. (قد تظل العُقد القديمة تصدر `exec.started`.)
...
كان الجسر **v1 ضمنياً** (دون تفاوض حد أدنى/أقصى). هذا القسم مرجع تاريخي فقط؛ يستخدم عملاء العُقد/المشغّلون الحاليون WebSocket [بروتوكول Gateway](</ar/gateway/protocol>).

...
source_url: https://docs.openclaw.ai/th/concepts/queue-steering
...
หน้านี้อธิบายการสั่งทิศทางในโหมดคิวสำหรับข้อความขาเข้าปกติ สำหรับคำสั่ง `/steer <message>` แบบชัดเจน โปรดดู [สั่งทิศทาง](</th/tools/steer>)

---
title: وب
source_url: https://docs.openclaw.ai/fa/web
...
وقتی `hooks.enabled=true` باشد، Gateway همچنین یک endpoint کوچک Webhook را روی همان سرور HTTP در دسترس قرار می‌دهد. برای احراز هویت + payloadها، [پیکربندی Gateway](</fa/gateway/configuration>) ← `hooks` را ببینید.

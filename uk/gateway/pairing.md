...
source_url: https://docs.openclaw.ai/uk/gateway/pairing
...
Примітки:
  ...
  * Рівні scope оператора та перевірки під час схвалення підсумовано в [Operator scopes](</uk/gateway/operator-scopes>).

...
source_url: https://docs.openclaw.ai/pt-BR/reference/prompt-caching
...
Referências de providers:
  ...
  * Cache de prompt da Anthropic: <https://platform.claude.com/docs/en/build-with-claude/prompt-caching>
  * Cache de prompt da OpenAI: <https://developers.openai.com/api/docs/guides/prompt-caching>
  * Cabeçalhos da API OpenAI e IDs de requisição: <https://developers.openai.com/api/reference/overview>
  * IDs de requisição e erros da Anthropic: <https://platform.claude.com/docs/en/api/errors>
...
yamlCopy code
[code]
    diagnostics:  cacheTrace:    enabled: true    filePath: "~/.openclaw/logs/cache-trace.jsonl" # opcional    includeMessages: false # padrão true    includePrompt: false # padrão true    includeSystem: false # padrão true
[/code]

---
title: Agen
source_url: https://docs.openclaw.ai/id/cli/agent
scraped_at: 2026-05-25
---

# `openclaw agent`

Jalankan satu giliran agen melalui Gateway (gunakan `--local` untuk tertanam). Gunakan `--agent <id>` untuk menargetkan agen yang dikonfigurasi secara langsung.

---
title: Zalo ClawBot
source_url: https://docs.openclaw.ai/vi/channels/zaloclawbot
scraped_at: 2026-06-29
---

ChannelsRegional platforms

OpenClaw kết nối với Zalo ClawBot thông qua Plugin bên ngoài `@zalo-platforms/openclaw-zaloclawbot` được liệt kê trong danh mục. Đăng nhập dùng mã QR của Zalo Mini App.
...
Khác với kênh Zalo dành cho nhà phát triển tiêu chuẩn, vốn yêu cầu bạn đăng ký Zalo Official Account (OA) riêng và dán thông tin xác thực nhà phát triển tĩnh, Zalo ClawBot hoạt động như một **trợ lý cá nhân gắn với chủ sở hữu** bằng hạ tầng chính thức dùng chung:
  ...
  3. **Đường dẫn API chính thức:** Plugin sử dụng API Zalo Bot Platform thay vì tự động hóa trình duyệt hoặc phiên web.
...
Plugin bên ngoài quản lý thông tin xác thực của bot trong thư mục trạng thái OpenClaw. Hãy coi thư mục đó là nhạy cảm và đưa nó vào cùng chính sách kiểm soát truy cập và sao lưu như phần còn lại của trạng thái OpenClaw.

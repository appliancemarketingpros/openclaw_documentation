...
source_url: https://docs.openclaw.ai/vi/providers
scraped_at: 2026-05-25
---

OpenClaw có thể sử dụng nhiều nhà cung cấp LLM. Chọn một nhà cung cấp, xác thực, rồi đặt mô hình mặc định dưới dạng `provider/model`.
...
Để xem danh mục nhà cung cấp đầy đủ (xAI, Groq, Mistral, v.v.) và cấu hình nâng cao, xem [Nhà cung cấp mô hình](</vi/concepts/model-providers>).

...
source_url: https://docs.openclaw.ai/nl/plugins/sdk-provider-plugins
...
`tool-stream-default-on` | Standaard ingeschakelde `tool_stream`-wrapper voor providers zoals [Z.AI](<http://Z.AI>) die toolstreaming willen tenzij dit expliciet is uitgeschakeld | `zai`  
...
## Volgende stappen
  ...
  * [Channel-Plugins](</nl/plugins/sdk-channel-plugins>) \- als je Plugin ook een kanaal levert

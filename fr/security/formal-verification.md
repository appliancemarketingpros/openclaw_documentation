...
source_url: https://docs.openclaw.ai/fr/security/formal-verification
...
**Objectif (cap) :** fournir un argument vérifié par machine selon lequel OpenClaw applique sa politique de sécurité prévue (autorisation, isolation des sessions, filtrage des outils et sécurité face aux mauvaises configurations), sous des hypothèses explicites.

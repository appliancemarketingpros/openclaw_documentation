---
title: 模型供應商快速入門
source_url: https://docs.openclaw.ai/zh-TW/providers/models
scraped_at: 2026-05-25
---

OpenClaw 可以使用許多 LLM 供應商。選擇一個供應商、完成驗證，然後將預設 模型設定為 `provider/model`。
...
如需完整供應商目錄（xAI、Groq、Mistral 等）和進階設定， 請參閱[模型供應商](</zh-TW/concepts/model-providers>)。

---
title: Agent
source_url: https://docs.openclaw.ai/de/cli/agent
scraped_at: 2026-05-25
---

# `openclaw agent`

Führen Sie einen Agent-Turn über das Gateway aus (verwenden Sie `--local` für eingebettet). Verwenden Sie `--agent <id>`, um einen konfigurierten Agent direkt anzusteuern.

---
title: Поиск Gemini
source_url: https://docs.openclaw.ai/ru/tools/gemini-search
scraped_at: 2026-06-29
---

CapabilitiesTools

OpenClaw поддерживает модели Gemini со встроенным [grounding Google Search](<https://ai.google.dev/gemini-api/docs/grounding>), который возвращает синтезированные ИИ ответы на основе актуальных результатов Google Search с цитатами.

## Получение API-ключа

* ### Создайте ключ

Перейдите в [Google AI Studio](<https://aistudio.google.com/apikey>) и создайте API-ключ.

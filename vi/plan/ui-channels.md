...
source_url: https://docs.openclaw.ai/vi/plan/ui-channels
...
Tài liệu chuẩn hiện nằm tại [Trình bày thông điệp](</vi/plugins/message-presentation>). Giữ kế hoạch này làm ngữ cảnh triển khai lịch sử; cập nhật hướng dẫn chuẩn khi có thay đổi về hợp đồng, renderer hoặc hành vi fallback.

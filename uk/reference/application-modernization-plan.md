...
source_url: https://docs.openclaw.ai/uk/reference/application-modernization-plan
...
Використовуйте цей розділ, щоб оновити frontend-focused `SKILL.md`, наданий із завданням модернізації. Якщо приймаєте цю настанову як repo-local OpenClaw skill, спершу створіть `.agents/skills/openclaw-frontend/SKILL.md`, збережіть frontmatter, що належить цьому цільовому skill, потім додайте або замініть body guidance таким вмістом.

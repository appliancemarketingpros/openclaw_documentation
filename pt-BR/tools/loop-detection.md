...
source_url: https://docs.openclaw.ai/pt-BR/tools/loop-detection
...
[**Aprovações de exec** Política de permitir/negar para execução no shell. ](</pt-BR/tools/exec-approvals>) [**Níveis de pensamento** Níveis de esforço de raciocínio e interação com a política do provedor. ](</pt-BR/tools/thinking>) [**Subagentes** Geração de agentes isolados para limitar comportamento descontrolado. ](</pt-BR/tools/subagents>) [**Referência de configuração** Esquema completo de `tools.loopDetection` e semântica de mesclagem. ](</pt-BR/gateway/configuration-reference>)

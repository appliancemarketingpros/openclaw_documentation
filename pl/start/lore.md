---
title: Lore OpenClaw
source_url: https://docs.openclaw.ai/pl/start/lore
...
CodeCopy code
[code]
    OpenClaw = OPEN + CLAW        = Open source, otwarte dla wszystkich        = Nasze homarie dziedzictwo, skąd pochodzimy        = The claw is the law 🦞        = Twój asystent. Twoja maszyna. Twoje zasady.
[/code]
...
## Święte teksty
  ...
  * **[SOUL.md](<http://SOUL.md>)** — dokument tożsamości Molty
  * **memory/*.md** — pliki pamięci długoterminowej
  * **[AGENTS.md](<http://AGENTS.md>)** — instrukcje operacyjne
  * **[USER.md](<http://USER.md>)** — kontekst o twórcy

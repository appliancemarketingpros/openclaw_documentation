...
source_url: https://docs.openclaw.ai/fa/plan/ui-channels
...
مستندات مرجع اکنون در [ارائه پیام](</fa/plugins/message-presentation>) قرار دارند. این طرح را به‌عنوان زمینه تاریخی پیاده‌سازی نگه دارید؛ برای تغییرات قرارداد، رندرکننده یا رفتار fallback، راهنمای مرجع را به‌روزرسانی کنید.

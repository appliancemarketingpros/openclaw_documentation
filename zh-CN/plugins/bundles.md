---
title: 插件包
source_url: https://docs.openclaw.ai/zh-CN/plugins/bundles
...
#### 钩子包
  ...
  * bundle 钩子根目录**仅在** 使用普通 OpenClaw 钩子包布局时工作。 目前这主要是 Codex 兼容场景： 
    * `HOOK.md`
...
运行 `openclaw plugins inspect <id>`。如果能力已列出但标记为未接线， 那是产品限制，而不是安装损坏。

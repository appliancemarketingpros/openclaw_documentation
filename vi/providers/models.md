...
source_url: https://docs.openclaw.ai/vi/providers/models
scraped_at: 2026-05-25
---

OpenClaw có thể sử dụng nhiều nhà cung cấp LLM. Chọn một nhà cung cấp, xác thực, rồi đặt mô hình mặc định theo dạng `provider/model`.
...
Để xem toàn bộ danh mục nhà cung cấp (xAI, Groq, Mistral, v.v.) và cấu hình nâng cao, xem [Nhà cung cấp mô hình](</vi/concepts/model-providers>).

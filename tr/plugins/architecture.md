...
source_url: https://docs.openclaw.ai/tr/plugins/architecture
...
[**Plugin'leri kurma ve kullanma** Plugin ekleme, etkinleştirme ve sorun giderme için son kullanıcı kılavuzu. ](</tr/tools/plugin>) [**Plugin oluşturma** En küçük çalışan manifest ile ilk Plugin öğreticisi. ](</tr/plugins/building-plugins>) [**Kanal Plugin'leri** Bir mesajlaşma kanalı Plugin'i oluşturun. ](</tr/plugins/sdk-channel-plugins>) [**Sağlayıcı Plugin'leri** Bir model sağlayıcı Plugin'i oluşturun. ](</tr/plugins/sdk-provider-plugins>) [**SDK genel bakışı** İçe aktarma haritası ve kayıt API başvurusu. ](</tr/plugins/sdk-overview>)
...
Çalışma zamanı kayıt zorlaması

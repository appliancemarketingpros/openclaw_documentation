...
source_url: https://docs.openclaw.ai/fa/pi
...
اکنون runtimeهای کنش پیام مختص کانال به‌جای `src/agents/tools` در دایرکتوری‌های افزونه تحت مالکیت Plugin قرار دارند، برای مثال:
...
تزریق تصویر محلیِ اعلان است: OpenClaw ارجاع‌های تصویر را از اعلان فعلی بارگذاری می‌کند و آن‌ها را فقط برای همان نوبت از طریق `images` عبور می‌دهد. نوبت‌های قدیمی‌تر تاریخچه را دوباره اسکن نمی‌کند تا payloadهای تصویر را دوباره تزریق کند.
...
system prompt | [AGENTS.md](<http://AGENTS.md>) \+ promptها | پویا برای هر کانال/context  

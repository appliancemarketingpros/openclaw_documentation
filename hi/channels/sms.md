---
title: SMS
source_url: https://docs.openclaw.ai/hi/channels/sms
...
[**पेयरिंग** SMS के लिए डिफ़ॉल्ट DM नीति पेयरिंग है। ](</hi/channels/pairing>) [**Gateway सुरक्षा** Webhook एक्सपोज़र और प्रेषक एक्सेस नियंत्रणों की समीक्षा करें। ](</hi/gateway/security>) [**चैनल समस्या निवारण** क्रॉस-चैनल डायग्नोस्टिक्स और रिपेयर प्लेबुक। ](</hi/channels/troubleshooting>)
...
* ### Twilio को Gateway Webhook पर इंगित करें
...
* ### Gateway शुरू करें और पहले प्रेषक को स्वीकृत करें

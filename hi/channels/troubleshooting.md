...
source_url: https://docs.openclaw.ai/hi/channels/troubleshooting
...
इसका उपयोग तब करें जब Telegram, iMessage, BlueBubbles-युग के कॉन्फ़िग, या कोई अन्य Plugin चैनल अपडेट के बाद गायब हो जाए।
...
`openclaw status --all` में `plugin load failed: dependency tree corrupted; run openclaw doctor --fix` देखें। इसका अर्थ है कि चैनल कॉन्फ़िगर है, लेकिन Plugin सेटअप/लोड पाथ ने चैनल रजिस्टर करने के बजाय भ्रष्ट निर्भरता ट्री का सामना किया। `openclaw doctor --fix` पुराने Plugin निर्भरता स्टेजिंग डायरेक्टरी और पुराने auth शैडो हटाता है, फिर `openclaw gateway restart` स्वच्छ स्थिति को फिर से लोड करता है।

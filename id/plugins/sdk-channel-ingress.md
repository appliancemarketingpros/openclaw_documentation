...
source_url: https://docs.openclaw.ai/id/plugins/sdk-channel-ingress
scraped_at: 2026-05-25
---

# API ingress kanal

Ingress kanal adalah batas kontrol akses eksperimental untuk event kanal masuk. Gunakan `openclaw/plugin-sdk/channel-ingress-runtime` untuk jalur penerimaan. Subpath lama `openclaw/plugin-sdk/channel-ingress` tetap diekspor sebagai facade kompatibilitas yang tidak digunakan lagi untuk plugin pihak ketiga.

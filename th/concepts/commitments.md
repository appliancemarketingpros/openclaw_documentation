...
source_url: https://docs.openclaw.ai/th/concepts/commitments
...
หากการติดตามผลที่คาดไว้ไม่ปรากฏ:
  ...
  * โปรดจำไว้ว่าการแจ้งเตือนที่ระบุชัดเจนจะถูกข้ามโดยการสกัดข้อผูกมัด และควร ปรากฏใต้ [งานที่กำหนดเวลาไว้](</th/automation/cron-jobs>) แทน

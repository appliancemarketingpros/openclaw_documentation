---
title: Configuration
source_url: https://docs.openclaw.ai/fr/cli/config
...
OPENCLAW_DOCS_MARKER:paramOpen:IHBhdGg9Ii0tc2VjdGlvbiA8c2VjdGlvbg " type="string"> Filtre de section de configuration guidée répétable lorsque vous exécutez `openclaw config` sans sous-commande.

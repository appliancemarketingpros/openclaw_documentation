...
source_url: https://docs.openclaw.ai/hi/tools/browser-wsl2-windows-remote-cdp-troubleshooting
...
इसे तब चुनें जब:
  ...
  * आपको `responsebody`, PDF export, download interception, या batch actions जैसे advanced managed/raw-CDP-only routes की आवश्यकता न हो

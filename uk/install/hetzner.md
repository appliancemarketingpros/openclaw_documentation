---
title: Hetzner
source_url: https://docs.openclaw.ai/uk/install/hetzner
...
Якщо ви використовуєте інший Linux VPS, зіставте пакети відповідно. Для загального Docker-процесу див. [Docker](</uk/install/docker>).

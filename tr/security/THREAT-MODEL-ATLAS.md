...
source_url: https://docs.openclaw.ai/tr/security/THREAT-MODEL-ATLAS
scraped_at: 2026-05-25
---

## MITRE ATLAS çerçevesi

**Sürüm:** 1.0-taslak **Son Güncelleme:** 2026-02-04 **Metodoloji:** MITRE ATLAS + Veri Akışı Diyagramları **Çerçeve:** [MITRE ATLAS](<https://atlas.mitre.org/>) (AI Sistemleri için Düşmanca Tehdit Ortamı)
...
Gerekli [SKILL.md](<http://SKILL.md>) | Zorunlu readme | Düşük güvenlik değeri - Yalnızca bilgilendirici  
...
_Bu tehdit modeli yaşayan bir belgedir. Güvenlik sorunlarını[security@openclaw.ai](<mailto:security@openclaw.ai>) adresine bildirin_

---
title: Synology Chat
source_url: https://docs.openclaw.ai/fa/channels/synology-chat
...
`SYNOLOGY_CHAT_INCOMING_URL` را نمی‌توان از یک `.env` مربوط به workspace تنظیم کرد؛ [فایل‌های `.env` مربوط به Workspace](</fa/gateway/security>) را ببینید.
...
## مرتبط
  ...
  * [مرور کلی کانال‌ها](</fa/channels>) — همهٔ کانال‌های پشتیبانی‌شده

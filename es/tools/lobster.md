---
title: Langosta
source_url: https://docs.openclaw.ai/es/tools/lobster
...
Para flujos de trabajo que necesitan un **paso LLM estructurado** , habilita la herramienta Plugin opcional `llm-task` y llámala desde Lobster. Esto mantiene el flujo de trabajo determinista y, aun así, te permite clasificar/resumir/redactar con un modelo.

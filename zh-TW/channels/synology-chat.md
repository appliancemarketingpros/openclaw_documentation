---
title: Synology Chat
source_url: https://docs.openclaw.ai/zh-TW/channels/synology-chat
...
支援透過 URL 型檔案遞送傳送媒體。 傳出檔案 URL 必須使用 `http` 或 `https`，且私人或其他遭封鎖的網路目標會在 OpenClaw 將 URL 轉送至 NAS Webhook 之前被拒絕。

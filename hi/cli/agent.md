---
title: एजेंट
source_url: https://docs.openclaw.ai/hi/cli/agent
...
Gateway के माध्यम से agent turn चलाएं (embedded के लिए `--local` का उपयोग करें)। किसी configured agent को सीधे लक्षित करने के लिए `--agent <id>` का उपयोग करें।

---
title: 工具迴圈偵測
source_url: https://docs.openclaw.ai/zh-TW/tools/loop-detection
...
[**Exec approvals** Shell 執行的允許/拒絕政策。 ](</zh-TW/tools/exec-approvals>) [**Thinking levels** 推理投入層級與提供者政策互動。 ](</zh-TW/tools/thinking>) [**Sub-agents** 產生隔離的代理程式，以限制失控行為。 ](</zh-TW/tools/subagents>) [**Configuration reference** 完整的 `tools.loopDetection` schema 與合併語意。 ](</zh-TW/gateway/configuration-reference>)

---
title: حافظه LanceDB
source_url: https://docs.openclaw.ai/fa/plugins/memory-lancedb
scraped_at: 2026-05-25
---

`memory-lancedb` یک Plugin حافظه‌ی bundled است که حافظه‌ی بلندمدت را در LanceDB ذخیره می‌کند و از embeddingها برای recall استفاده می‌کند. می‌تواند پیش از نوبت مدل، حافظه‌های مرتبط را به‌طور خودکار recall کند و پس از یک پاسخ، facts مهم را capture کند.

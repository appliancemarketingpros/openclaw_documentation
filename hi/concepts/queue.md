---
title: कमांड कतार
source_url: https://docs.openclaw.ai/hi/concepts/queue
...
Runtime-विशिष्ट timing और dependency व्यवहार के लिए, [Steering कतार](</hi/concepts/queue-steering>) देखें। स्पष्ट `/steer <message>` command के लिए, [Steer](</hi/tools/steer>) देखें।

---
title: زمینه
source_url: https://docs.openclaw.ai/fa/concepts/context
...
[**موتور زمینه** تزریق زمینهٔ سفارشی از طریق plugins. ](</fa/concepts/context-engine>) [**Compaction** خلاصه‌سازی گفتگوهای طولانی برای نگه داشتن آن‌ها داخل پنجرهٔ مدل. ](</fa/concepts/compaction>) [**پرامپت سیستم** پرامپت سیستم چگونه ساخته می‌شود و در هر نوبت چه چیزی تزریق می‌کند. ](</fa/concepts/system-prompt>) [**حلقهٔ agent** چرخهٔ کامل اجرای agent از پیام ورودی تا پاسخ نهایی. ](</fa/concepts/agent-loop>)

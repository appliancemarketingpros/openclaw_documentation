---
title: Миграция
source_url: https://docs.openclaw.ai/ru/cli/migrate
...
OPENCLAW_DOCS_MARKER:paramOpen:IHBhdGg9Ijxwcm92aWRlcg " type="string"> Имя зарегистрированного поставщика миграции, например `hermes`. Выполните `openclaw migrate list`, чтобы увидеть установленных поставщиков.

Построить план и выйти без изменения состояния.

OPENCLAW_DOCS_MARKER:paramOpen:IHBhdGg9Ii0tZnJvbSA8cGF0aA " type="string"> Переопределить исходный каталог состояния. Для Hermes по умолчанию используется `~/.hermes`.

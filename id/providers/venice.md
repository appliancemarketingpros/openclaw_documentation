---
title: Venice AI
source_url: https://docs.openclaw.ai/id/providers/venice
...
Model privat (26) — sepenuhnya privat, tanpa pencatatan log ID Model | Nama | Konteks | Fitur  
---|---|---|---  
...
Model anonim (15) — melalui proxy Venice ID Model | Nama | Konteks | Fitur  
---|---|---|---  
...
[**Model selection** Memilih penyedia, referensi model, dan perilaku failover. ](</id/concepts/model-providers>) [**Venice AI** Beranda Venice AI dan pendaftaran akun. ](<https://venice.ai>) [**API documentation** Referensi API Venice dan dokumentasi pengembang. ](<https://docs.venice.ai>) [**Pricing** Tarif dan paket kredit Venice saat ini. ](<https://venice.ai/pricing>)

---
title: Heartbeat
source_url: https://docs.openclaw.ai/fa/gateway/heartbeat
...
## [HEARTBEAT.md](<http://HEARTBEAT.md>) (اختیاری)
...
### آیا عامل می‌تواند [HEARTBEAT.md](<http://HEARTBEAT.md>) را به‌روزرسانی کند؟
...
اگر می‌خواهید این کار به‌صورت پیش‌دستانه انجام شود، می‌توانید یک خط صریح نیز در پرامپت Heartbeat خود بگنجانید، مانند: «اگر چک‌لیست کهنه شد، [HEARTBEAT.md](<http://HEARTBEAT.md>) را با نسخه بهتری به‌روزرسانی کن.»

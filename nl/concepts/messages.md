---
title: Berichten
source_url: https://docs.openclaw.ai/nl/concepts/messages
...
Het exacte stille token `NO_REPLY` / `no_reply` betekent "lever geen gebruikerszichtbaar antwoord af". Wanneer een beurt ook pending toolmedia heeft, zoals gegenereerde TTS-audio, verwijdert OpenClaw de stille tekst maar levert het de mediabijlage nog steeds af. OpenClaw lost dat gedrag op per gesprekstype:

---
title: Отрисовать
source_url: https://docs.openclaw.ai/ru/install/render
...
Это создает переносимый архив резервной копии с состоянием OpenClaw и любой настроенной рабочей областью. Подробности см. в разделе [Резервное копирование](</ru/cli/backup>).

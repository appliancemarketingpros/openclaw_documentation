---
title: Цикл агента
source_url: https://docs.openclaw.ai/uk/concepts/agent-loop
...
## Черги + конкурентність
  ...
  * Канали повідомлень можуть вибирати режими черги (collect/steer/followup), які подаються в цю систему ліній. Див. [Черга команд](</uk/concepts/queue>).

...
source_url: https://docs.openclaw.ai/th/concepts/model-providers
...
### Anthropic
  ...
  * config Claude CLI ที่แนะนำจะเก็บการอ้างอิงโมเดลเป็น canonical และเลือก CLI backend แยกต่างหาก: `anthropic/claude-opus-4-7` พร้อม `agentRuntime.id: "claude-cli"` ที่ scoped ตามโมเดล การอ้างอิง legacy `claude-cli/claude-opus-4-7` ยังคงทำงานเพื่อความเข้ากันได้
...
[**GLM models** แผน [Z.AI](<http://Z.AI>) Coding หรือ endpoint API ทั่วไป ](</th/providers/glm>) [**MiniMax** OAuth ของ MiniMax Coding Plan หรือการเข้าถึงด้วย API key ](</th/providers/minimax>) [**Qwen Cloud** surface ผู้ให้บริการ Qwen Cloud พร้อมการแมป endpoint ของ Alibaba DashScope และ Coding Plan ](</th/providers/qwen>)
...
### [Z.AI](<http://Z.AI>) (GLM)
  ...
  * CLI: `openclaw onboard --auth-choice zai-api-key`
    ...
    * `zai-api-key` ตรวจจับ endpoint ของ [Z.AI](<http://Z.AI>) ที่ตรงกันโดยอัตโนมัติ; `zai-coding-global`, `zai-coding-cn`, `zai-global` และ `zai-cn` จะบังคับใช้พื้นผิวเฉพาะ
...
Ollama มาพร้อมเป็น Plugin ผู้ให้บริการแบบ bundled และใช้ API แบบ native ของ Ollama:
  ...
  * การติดตั้ง: <https://ollama.com/download>

...
source_url: https://docs.openclaw.ai/nl/gateway/config-tools
...
Gebruik `cerebras/zai-glm-4.7` voor Cerebras; `zai/glm-4.7` voor [Z.AI](<http://Z.AI>) direct.
...
Synthetic (Anthropic-compatibel) json5Copy code
[code]

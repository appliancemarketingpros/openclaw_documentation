...
source_url: https://docs.openclaw.ai/it/concepts/memory-qmd
...
Per configurazioni più semplici, il [motore integrato](</it/concepts/memory-builtin>) funziona bene senza dipendenze aggiuntive.
...
Per l'intera superficie di configurazione (`memory.qmd.*`), le modalità di ricerca, gli intervalli di aggiornamento, le regole di ambito e tutte le altre opzioni, vedi il [riferimento della configurazione della memoria](</it/reference/memory-config>).

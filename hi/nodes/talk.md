---
title: बातचीत मोड
source_url: https://docs.openclaw.ai/hi/nodes/talk
...
ब्राउज़र रियलटाइम Talk प्रदाता टूल कॉल को `talk.client.toolCall` के माध्यम से आगे भेजता है; ब्राउज़र क्लाइंट रियलटाइम परामर्शों के लिए सीधे `chat.send` कॉल नहीं करते। जब कोई रियलटाइम परामर्श सक्रिय हो, Talk क्लाइंट बोले गए इनपुट को `status`, `steer`, `cancel`, या `followup` के रूप में वर्गीकृत करने के लिए `talk.client.steer` या `talk.session.steer` का उपयोग कर सकते हैं। स्वीकृत स्टीयरिंग सक्रिय एम्बेडेड रन में कतारबद्ध की जाती है; अस्वीकृत स्टीयरिंग `no_active_run`, `not_streaming`, या `compacting` जैसे संरचित कारण लौटाती है।

---
title: Skills
source_url: https://docs.openclaw.ai/fa/tools/skills
...
[ClawHub](<https://clawhub.ai>) رجیستری عمومی مهارت‌ها برای OpenClaw است. برای کشف/نصب/به‌روزرسانی از فرمان‌های بومی `openclaw skills` استفاده کنید، یا برای گردش‌کارهای انتشار/همگام‌سازی از CLI جداگانه `clawhub` استفاده کنید. راهنمای کامل: [ClawHub](</fa/clawhub>).
...
<https://clawhub.ai> را مرور کنید. schema کامل پیکربندی: [پیکربندی Skills](</fa/tools/skills-config>).

---
title: OpenRouter
source_url: https://docs.openclaw.ai/ko/providers/openrouter
...
[**모델 선택** 제공자, 모델 참조, 장애 조치 동작 선택. ](</ko/concepts/model-providers>) [**설정 참조** 에이전트, 모델, 제공자에 대한 전체 설정 참조입니다. ](</ko/gateway/configuration-reference>)

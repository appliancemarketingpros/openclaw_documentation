---
title: EasyRunner
source_url: https://docs.openclaw.ai/fa/platforms/easyrunner
...
اگر Caddy خاتمهٔ TLS را برای Gateway انجام می‌دهد، تنظیمات trusted proxy را برای مسیر دقیق پراکسی پیکربندی کنید، نه اینکه بررسی‌های احراز هویت را به‌صورت سراسری غیرفعال کنید. ببینید [احراز هویت trusted proxy](</fa/gateway/trusted-proxy-auth>).

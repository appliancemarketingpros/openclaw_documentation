---
title: Nix
source_url: https://docs.openclaw.ai/fa/install/nix
...
سرویس gateway مربوط به launchd/systemd به‌صورت خودکار باینری‌های Nix-profile را کشف می‌کند تا Pluginها و ابزارهایی که برای اجرای فایل‌های اجرایی نصب‌شده با `nix` به shell متکی هستند، بدون تنظیم دستی PATH کار کنند:

  * وقتی `NIX_PROFILES` تنظیم شده باشد، هر ورودی با اولویت راست‌به‌چپ به PATH سرویس اضافه می‌شود (با اولویت shell در Nix منطبق است - راست‌ترین مورد برنده است).
...
[**nix-openclaw** ماژول Home Manager منبع حقیقت و راهنمای کامل راه‌اندازی. ](<https://github.com/openclaw/nix-openclaw>) [**جادوگر راه‌اندازی** راهنمای گام‌به‌گام راه‌اندازی CLI غیر Nix. ](</fa/start/wizard>) [**Docker** راه‌اندازی کانتینری به‌عنوان جایگزین غیر Nix. ](</fa/install/docker>) [**به‌روزرسانی** به‌روزرسانی نصب‌های مدیریت‌شده با Home Manager همراه با بسته. ](</fa/install/updating>)

---
title: Signal
source_url: https://docs.openclaw.ai/uk/channels/signal
...
Якщо ви використовуєте JVM-збірку (`signal-cli-${VERSION}.tar.gz`), спочатку встановіть JRE 25+. Підтримуйте `signal-cli` в актуальному стані; upstream зазначає, що старі випуски можуть ламатися зі змінами API серверів Signal.
...
Параметри провайдера:
  ...
  * `channels.signal.apiMode`: `auto | native | container` (типово: auto). Див. Режим контейнера.

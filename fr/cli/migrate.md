---
title: Migrer
source_url: https://docs.openclaw.ai/fr/cli/migrate
...
OPENCLAW_DOCS_MARKER:paramOpen:IHBhdGg9Ijxwcm92aWRlcg " type="string"> Nom d’un fournisseur de migration enregistré, par exemple `hermes`. Exécutez `openclaw migrate list` pour voir les fournisseurs installés.

Crée le plan et quitte sans modifier l’état.

OPENCLAW_DOCS_MARKER:paramOpen:IHBhdGg9Ii0tZnJvbSA8cGF0aA " type="string"> Remplace le répertoire d’état source. Hermes utilise `~/.hermes` par défaut.

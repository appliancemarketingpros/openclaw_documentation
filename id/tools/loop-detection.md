...
source_url: https://docs.openclaw.ai/id/tools/loop-detection
...
[**Persetujuan exec** Kebijakan izinkan/tolak untuk eksekusi shell. ](</id/tools/exec-approvals>) [**Tingkat berpikir** Tingkat upaya penalaran dan interaksi kebijakan provider. ](</id/tools/thinking>) [**Sub-agen** Menjalankan agen terisolasi untuk membatasi perilaku yang tidak terkendali. ](</id/tools/subagents>) [**Referensi konfigurasi** Skema lengkap `tools.loopDetection` dan semantik penggabungan. ](</id/gateway/configuration-reference>)

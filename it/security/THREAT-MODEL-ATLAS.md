...
source_url: https://docs.openclaw.ai/it/security/THREAT-MODEL-ATLAS
scraped_at: 2026-05-25
---

## framework MITRE ATLAS

**Versione:** 1.0-draft **Ultimo aggiornamento:** 2026-02-04 **Metodologia:** MITRE ATLAS + diagrammi di flusso dei dati **Framework:** [MITRE ATLAS](<https://atlas.mitre.org/>) (panorama delle minacce avversarie per sistemi di IA)
...
[SKILL.md](<http://SKILL.md>) richiesto | Readme obbligatorio | Basso valore di sicurezza - Solo informativo  
...
CodeCopy code
[code]
    T-PERSIST-001 → T-EVADE-001 → T-EXFIL-003(Pubblica una skill malevola) → (Elude la moderazione) → (Raccoglie credenziali)
[/code]
...
CodeCopy code
[code]
    T-EXEC-001 → T-EXEC-004 → T-IMPACT-001(Inietta prompt) → (Aggira l'approvazione exec) → (Esegue comandi)
[/code]
...
CodeCopy code
[code]
    T-EXEC-002 → T-EXFIL-001 → Esfiltrazione esterna(Avvelena il contenuto dell'URL) → (L'agente recupera e segue le istruzioni) → (Dati inviati all'attaccante)
[/code]
...
_Questo modello delle minacce è un documento vivo. Segnala i problemi di sicurezza a[security@openclaw.ai](<mailto:security@openclaw.ai>)_

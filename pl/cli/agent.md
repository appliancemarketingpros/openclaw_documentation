---
title: Agent
source_url: https://docs.openclaw.ai/pl/cli/agent
scraped_at: 2026-05-25
---

# `openclaw agent`

Uruchom turę agenta przez Gateway (użyj `--local` dla trybu osadzonego). Użyj `--agent <id>`, aby bezpośrednio wskazać skonfigurowanego agenta.

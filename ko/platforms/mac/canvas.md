---
title: 캔버스
source_url: https://docs.openclaw.ai/ko/platforms/mac/canvas
...
A2UI는 Gateway canvas host에서 호스팅되며 Canvas 패널 안에서 렌더링됩니다. Gateway가 Canvas host를 알리면 macOS 앱은 처음 열릴 때 A2UI host 페이지로 자동 이동합니다.

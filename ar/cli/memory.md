...
إدارة فهرسة الذاكرة الدلالية والبحث فيها. يُوفَّر بواسطة Plugin الذاكرة النشطة (الافتراضي: `memory-core`؛ اضبط `plugins.slots.memory = "none"` للتعطيل).
...
Dreaming هو نظام دمج الذاكرة في الخلفية، ويتضمن ثلاث مراحل تعاونية: **light** (فرز/تهيئة المواد قصيرة المدى)، و**deep** (ترقية الحقائق الدائمة إلى `MEMORY.md`)، و**REM** (التأمل وإبراز الموضوعات).

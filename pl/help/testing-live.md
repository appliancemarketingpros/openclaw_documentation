...
source_url: https://docs.openclaw.ai/pl/help/testing-live
scraped_at: 2026-05-25
---

For szybki start, uruchamiacze QA, zestawy testów jednostkowych/integracyjnych i przepływy Docker zobacz [Testowanie](</pl/help/testing>). Ta strona obejmuje **live** (dotykające sieci) zestawy testów: macierz modeli, backendy CLI, ACP i testy live dostawców multimediów oraz obsługę poświadczeń.

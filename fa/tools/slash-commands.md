---
title: دستورهای اسلش
source_url: https://docs.openclaw.ai/fa/tools/slash-commands
...
مسیر سریع و میان‌برهای درون‌خطی
...
فرمان‌های skill و آرگومان‌های بومی
...
برخلاف چت عادی:
  ...
  * در نشست‌های harness مربوط به Codex، به‌صورت یک رشته جانبی موقت Codex با مجوزهای فعلی Codex و سطح ابزار بومی اجرا می‌شود،

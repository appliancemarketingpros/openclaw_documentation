...
source_url: https://docs.openclaw.ai/fr/concepts/multi-agent
...
Un **agent** est un cerveau entièrement délimité avec ses propres éléments :
  ...
  * **Workspace** (fichiers, [AGENTS.md/SOUL.md/USER.md](<http://AGENTS.md/SOUL.md/USER.md>), notes locales, règles de persona).
...
Bots Telegram par agent json5Copy code
[code]

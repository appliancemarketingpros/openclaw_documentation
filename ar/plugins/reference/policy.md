...
source_url: https://docs.openclaw.ai/ar/plugins/reference/policy
...
تخزن السياسة المتطلبات المؤلفة في `policy.jsonc`، وتراقب إعدادات OpenClaw الحالية وتصريحات مساحة العمل كأدلة، وتبلّغ عن الانحراف عبر `openclaw policy check` و`openclaw doctor --lint`. ينتج فحص سياسة نظيف تجزئات للسياسة والأدلة والنتائج والإقرار يمكن للمشغلين تسجيلها للتدقيق.

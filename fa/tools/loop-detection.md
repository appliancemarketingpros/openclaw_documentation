...
source_url: https://docs.openclaw.ai/fa/tools/loop-detection
...
[**تأییدهای Exec** سیاست اجازه/رد برای اجرای shell. ](</fa/tools/exec-approvals>) [**سطوح تفکر** سطوح تلاش استدلالی و تعامل با سیاست provider. ](</fa/tools/thinking>) [**زیر-agentها** ایجاد agentهای ایزوله برای محدودکردن رفتار مهارنشده. ](</fa/tools/subagents>) [**مرجع پیکربندی** طرح‌وارهٔ کامل `tools.loopDetection` و معناشناسی ادغام. ](</fa/gateway/configuration-reference>)

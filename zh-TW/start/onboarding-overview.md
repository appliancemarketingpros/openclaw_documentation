---
title: 入門概覽
source_url: https://docs.openclaw.ai/zh-TW/start/onboarding-overview
scraped_at: 2026-05-25
---

OpenClaw 有兩種上手設定路徑。兩者都會設定驗證、Gateway，以及 可選的聊天頻道，只是與設定流程互動的方式不同。
...
大多數使用者應該從 **CLI 上手設定** 開始，因為它可在各處運作，並給予 你最多控制權。
...
無論你選擇哪一種路徑，上手設定都會設定：
  ...
  4. **頻道** （可選）— 內建與隨附的聊天頻道，例如 iMessage、Discord、Feishu、Google Chat、Mattermost、Microsoft Teams、 Telegram、WhatsApp 等
...
完整參考：[上手設定（CLI）](</zh-TW/start/wizard>) CLI 命令文件：[`openclaw onboard`](</zh-TW/cli/onboard>)

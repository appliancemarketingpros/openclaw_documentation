...
source_url: https://docs.openclaw.ai/ar/plugins/architecture
scraped_at: 2026-05-25
---

هذا هو **مرجع البنية العميقة** لنظام Plugin في OpenClaw. للأدلة العملية، ابدأ بإحدى الصفحات المركزة أدناه.

[**تثبيت Plugins واستخدامها** دليل المستخدم النهائي لإضافة Plugins وتمكينها واستكشاف مشكلاتها وإصلاحها. ](</ar/tools/plugin>) [**بناء Plugins** درس تعليمي لأول Plugin مع أصغر manifest عامل. ](</ar/plugins/building-plugins>) [**Plugins القنوات** ابنِ Plugin لقناة مراسلة. ](</ar/plugins/sdk-channel-plugins>) [**Plugins المزوّدين** ابنِ Plugin لمزوّد نماذج. ](</ar/plugins/sdk-provider-plugins>) [**نظرة عامة على SDK** مرجع خريطة الاستيراد وواجهة API للتسجيل. ](</ar/plugins/sdk-overview>)

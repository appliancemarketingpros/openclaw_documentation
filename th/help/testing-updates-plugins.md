...
source_url: https://docs.openclaw.ai/th/help/testing-updates-plugins
...
เริ่มจาก identity ของ artifact:
  ...
  * อาร์ติแฟกต์ Docker: `.artifacts/docker-tests/**/summary.json`, `failures.json`, บันทึกของเลน และคำสั่งรันซ้ำ
  * สรุปผู้รอดจากการอัปเกรด: `.artifacts/upgrade-survivor/summary.json`, รวมถึงเวอร์ชันฐาน เวอร์ชันตัวเลือก สถานการณ์ เวลาของแต่ละเฟส และ ขั้นตอนของสูตร

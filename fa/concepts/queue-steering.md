---
title: صف راهبری
source_url: https://docs.openclaw.ai/fa/concepts/queue-steering
...
این صفحه هدایت در حالت صف را برای پیام‌های ورودی عادی توضیح می‌دهد. برای فرمان صریح `/steer <message>`، [هدایت](</fa/tools/steer>) را ببینید.

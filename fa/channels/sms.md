---
title: SMS
source_url: https://docs.openclaw.ai/fa/channels/sms
...
[**Pairing** سیاست پیش‌فرض DM برای SMS، pairing است. ](</fa/channels/pairing>) [**Gateway security** در معرض بودن Webhook و کنترل‌های دسترسی فرستنده را بازبینی کنید. ](</fa/gateway/security>) [**Channel troubleshooting** عیب‌یابی‌های میان‌کانالی و راهنماهای عملیاتی تعمیر. ](</fa/channels/troubleshooting>)

---
title: Grok araması
source_url: https://docs.openclaw.ai/tr/tools/grok-search
...
**Ortam alternatifi:** Gateway ortamında `XAI_API_KEY` ayarlayın. Bir gateway kurulumu için bunu `~/.openclaw/.env` içine koyun.

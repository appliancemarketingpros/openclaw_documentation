...
source_url: https://docs.openclaw.ai/id/gateway/config-tools
...
Gunakan `cerebras/zai-glm-4.7` untuk Cerebras; `zai/glm-4.7` untuk [Z.AI](<http://Z.AI>) langsung.
...
MiniMax M2.7 (langsung) json5Copy code
[code]
...
Synthetic (kompatibel dengan Anthropic) json5Copy code
[code]

---
title: Kubernetes
source_url: https://docs.openclaw.ai/vi/install/kubernetes
...
Lấy secret dùng chung đã cấu hình cho Giao diện điều khiển. Script triển khai này tạo xác thực bằng token theo mặc định:

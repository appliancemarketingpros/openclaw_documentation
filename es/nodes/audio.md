...
source_url: https://docs.openclaw.ai/es/nodes/audio
...
Si **no configuras modelos** y `tools.media.audio.enabled` **no** está establecido en `false`, OpenClaw detecta automáticamente en este orden y se detiene en la primera opción funcional:

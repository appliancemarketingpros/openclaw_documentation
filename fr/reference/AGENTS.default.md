...
source_url: https://docs.openclaw.ai/fr/reference/AGENTS.default
...
[/code]
  ...
  3. Facultatif : si vous voulez la liste de Skills de l’assistant personnel, remplacez [AGENTS.md](<http://AGENTS.md>) par ce fichier :

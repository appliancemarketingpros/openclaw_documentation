---
title: Groq
source_url: https://docs.openclaw.ai/zh-CN/providers/groq
...
[**模型提供商** 选择提供商、模型引用和故障转移行为。 ](</zh-CN/concepts/model-providers>) [**Thinking modes** 推理强度级别和提供商策略交互。 ](</zh-CN/tools/thinking>) [**配置参考** 完整配置 schema，包括提供商和音频设置。 ](</zh-CN/gateway/configuration-reference>) [**Groq Console** Groq 仪表板、API 文档和定价。 ](<https://console.groq.com>)

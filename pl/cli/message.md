---
title: Wiadomość
source_url: https://docs.openclaw.ai/pl/cli/message
scraped_at: 2026-05-25
---

# `openclaw message`

Pojedyncze polecenie wychodzące do wysyłania wiadomości i akcji kanałów (Discord/Google Chat/iMessage/Matrix/Mattermost (Plugin)/Microsoft Teams/Signal/Slack/Telegram/WhatsApp).

...
source_url: https://docs.openclaw.ai/th/nodes/media-understanding
...
อ้างอิงหลัก/สำรองของ `agents.defaults.imageModel` (เฉพาะรูปภาพ) ควรใช้อ้างอิง `provider/model` อ้างอิงแบบไม่มีคุณสมบัติจะถูกเติมคุณสมบัติจากรายการโมเดลผู้ให้บริการที่รองรับรูปภาพซึ่งกำหนดค่าไว้เท่านั้น เมื่อรายการที่ตรงกันมีเพียงหนึ่งเดียว

* ### CLI ในเครื่อง (เฉพาะเสียง)
...
ลำดับสำรองที่รวมมา:
  ...
  * รูปภาพ: OpenAI → Anthropic → Google → MiniMax → MiniMax Portal → [Z.AI](<http://Z.AI>)

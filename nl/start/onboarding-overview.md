...
source_url: https://docs.openclaw.ai/nl/start/onboarding-overview
...
Ongeacht welk traject je kiest, stelt het insteltraject het volgende in:
  ...
  4. **Kanalen** (optioneel) — ingebouwde en meegeleverde chatkanalen zoals iMessage, Discord, Feishu, Google Chat, Mattermost, Microsoft Teams, Telegram, WhatsApp en meer
...
Volledige referentie: [Insteltraject (CLI)](</nl/start/wizard>) CLI-commandodocumentatie: [`openclaw onboard`](</nl/cli/onboard>)

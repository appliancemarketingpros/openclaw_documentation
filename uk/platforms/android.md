...
source_url: https://docs.openclaw.ai/uk/platforms/android
...
Цей сервер вставляє клієнт live-reload в HTML і перезавантажує сторінку після змін файлів. Хост A2UI доступний за `http://<gateway-host>:18789/__openclaw__/a2ui/`.

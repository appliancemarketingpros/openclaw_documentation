...
source_url: https://docs.openclaw.ai/th/plugins/copilot
...
สำหรับการแบ่งโมเดล/ผู้ให้บริการ/รันไทม์ในภาพรวม ให้เริ่มที่ [รันไทม์เอเจนต์](</th/concepts/agent-runtimes>)
...
สิ่งนี้ทำให้เซสชัน Copilot CLI ถูกสงวนไว้สำหรับลูปเทิร์นหลักของเอเจนต์ และ ทำให้พฤติกรรม `/btw` เหมือนกับ runtime อื่นที่มี PI รองรับ สัญญานี้ถูกยืนยันไว้ใน [`extensions/copilot/harness.test.ts`](<https://github.com/openclaw/openclaw/blob/main/extensions/copilot/harness.test.ts>) ภายใต้ `describe("runSideQuestion")`

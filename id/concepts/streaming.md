...
source_url: https://docs.openclaw.ai/id/concepts/streaming
...
**Catatan kanal:** Streaming blok **nonaktif kecuali** `*.blockStreaming` secara eksplisit disetel ke `true`. Kanal dapat men-stream pratinjau langsung (`channels.<channel>.streaming`) tanpa balasan blok.

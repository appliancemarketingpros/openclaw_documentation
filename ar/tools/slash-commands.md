...
source_url: https://docs.openclaw.ai/ar/tools/slash-commands
...
على خلاف المحادثة العادية:
  ...
  * في جلسات Codex harness، يعمل كسلسلة جانبية مؤقتة من Codex مع أذونات Codex الحالية وسطح الأدوات الأصلي،

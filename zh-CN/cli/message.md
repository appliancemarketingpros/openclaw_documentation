---
title: 消息
source_url: https://docs.openclaw.ai/zh-CN/cli/message
scraped_at: 2026-05-25
---

# `openclaw message`

用于发送消息和频道操作的单一出站命令 （Discord/Google Chat/iMessage/Matrix/Mattermost（插件）/Microsoft Teams/Signal/Slack/Telegram/WhatsApp）。

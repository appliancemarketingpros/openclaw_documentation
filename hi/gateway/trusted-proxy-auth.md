...
source_url: https://docs.openclaw.ai/hi/gateway/trusted-proxy-auth
...
WebSocket कनेक्ट होता है, लेकिन `chat.history`, `sessions.list`, या `models.list` `missing scope: operator.read` के साथ विफल होता है।

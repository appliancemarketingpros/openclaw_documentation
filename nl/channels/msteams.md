...
source_url: https://docs.openclaw.ai/nl/channels/msteams
...
Microsoft Teams wordt in huidige OpenClaw-releases meegeleverd als gebundelde Plugin, dus in de normale packaged build is geen aparte installatie vereist.

Als je een oudere build gebruikt of een aangepaste installatie die gebundelde Teams uitsluit, installeer dan het npm-pakket rechtstreeks:
...
Gebruik het bare pakket om de huidige officiële release-tag te volgen. Pin alleen een exacte versie wanneer je een reproduceerbare installatie nodig hebt.
...
**Handmatige configuratie (zonder de Teams CLI)**
...
### Stap 5: Teams-appmanifest bouwen
  ...
  * Voeg RSC-machtigingen toe (zie RSC-machtigingen).
...
Handmatige manifestupdate (zonder CLI)
...
### Fouten bij manifestupload
  ...
  * **"[webApplicationInfo.Id](<http://webApplicationInfo.Id>) already in use":** De app is nog geïnstalleerd in een ander team/chat. Zoek en verwijder die installatie eerst, of wacht 5-10 minuten op propagatie.

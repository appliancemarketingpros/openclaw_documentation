---
title: MiniMax
source_url: https://docs.openclaw.ai/tr/providers/minimax
...
* ### Model/kimlik doğrulamayı seçin

Menüden **Model/kimlik doğrulama** seçeneğini belirleyin.

* ### Bir MiniMax kimlik doğrulama seçeneği belirleyin
...
Bu nedenle otomatik medya yönlendirme, paketlenmiş metin sağlayıcı kataloğu hala yalnızca metin M2.7 sohbet başvurularını gösterse bile MiniMax görsel anlamayı kullanabilir.
...
Configuration options Seçenek | Açıklama  
---|---  
...
Coding Plan kullanım ayrıntıları
...
"Bilinmeyen model: minimax/MiniMax-M2.7"
...
[**Model seçimi** Sağlayıcıları, model referanslarını ve yük devretme davranışını seçme. ](</tr/concepts/model-providers>) [**Görsel oluşturma** Paylaşılan görsel aracı parametreleri ve sağlayıcı seçimi. ](</tr/tools/image-generation>) [**Müzik oluşturma** Paylaşılan müzik aracı parametreleri ve sağlayıcı seçimi. ](</tr/tools/music-generation>) [**Video oluşturma** Paylaşılan video aracı parametreleri ve sağlayıcı seçimi. ](</tr/tools/video-generation>) [**MiniMax Search** MiniMax Token Plan aracılığıyla web araması yapılandırması. ](</tr/tools/minimax-search>) [**Sorun giderme** Genel sorun giderme ve SSS. ](</tr/help/troubleshooting>)

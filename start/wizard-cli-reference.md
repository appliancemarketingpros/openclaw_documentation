...
Prompts for `AI_GATEWAY_API_KEY`. More detail: [Vercel AI Gateway](</providers/vercel-ai-gateway>).

Cloudflare AI Gateway

Prompts for account ID, gateway ID, and `CLOUDFLARE_AI_GATEWAY_API_KEY`. More detail: [Cloudflare AI Gateway](</providers/cloudflare-ai-gateway>).
...
Prompts for `SYNTHETIC_API_KEY`. More detail: [Synthetic](</providers/synthetic>).
...
Moonshot (Kimi K2) and Kimi Coding configs are auto-written. More detail: [Moonshot AI (Kimi + Kimi Coding)](</providers/moonshot>).

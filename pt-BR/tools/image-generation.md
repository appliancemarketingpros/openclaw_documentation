...
source_url: https://docs.openclaw.ai/pt-BR/tools/image-generation
...
Para rotear a geração de imagens da OpenAI por uma implantação Azure OpenAI em vez de `api.openai.com`, consulte [endpoints Azure OpenAI](</pt-BR/providers/openai#azure-openai-endpoints>).

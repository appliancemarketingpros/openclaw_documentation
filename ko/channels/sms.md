---
title: SMS
source_url: https://docs.openclaw.ai/ko/channels/sms
...
[**페어링** SMS의 기본 DM 정책은 페어링입니다. ](</ko/channels/pairing>) [**Gateway 보안** Webhook 노출과 발신자 접근 제어를 검토하세요. ](</ko/gateway/security>) [**채널 문제 해결** 채널 간 진단 및 복구 플레이북입니다. ](</ko/channels/troubleshooting>)
...
* ### Twilio가 Gateway Webhook을 가리키도록 설정

...
source_url: https://docs.openclaw.ai/uk/gateway/discovery
...
## Терміни
  ...
  * **Застарілий TCP-міст (видалено)** : старіший транспорт Node (див. [Протокол bridge](</uk/gateway/bridge-protocol>)); більше не оголошується для виявлення і більше не входить до поточних збірок.

---
title: Homard
source_url: https://docs.openclaw.ai/fr/tools/lobster
...
Pour les flux de travail qui nécessitent une **étape LLM structurée** , activez l’outil de plugin optionnel `llm-task` et appelez-le depuis Lobster. Cela garde le flux de travail déterministe tout en vous permettant de classer/résumer/rédiger avec un modèle.

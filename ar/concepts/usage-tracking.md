...
source_url: https://docs.openclaw.ai/ar/concepts/usage-tracking
...
## ما هو
  ...
  * يمكن لـ `/status` على مستوى الجلسة و`session_status` الرجوع إلى أحدث إدخال استخدام في النص المسجل عندما تكون لقطة الجلسة الحية محدودة. يملأ ذلك الرجوع عدّادات الرموز/التخزين المؤقت المفقودة، ويمكنه استعادة تسمية نموذج وقت التشغيل النشط، ويفضّل الإجمالي الأكبر الموجّه للموجه عندما تكون بيانات الجلسة الوصفية مفقودة أو أصغر. تظل القيم الحية غير الصفرية الموجودة هي الغالبة.
...
## المزوّدون + بيانات الاعتماد
  ...
  * **[z.ai](<http://z.ai>)** : مفتاح API عبر env/config/auth store.

---
title: Configuración
source_url: https://docs.openclaw.ai/es/start/setup
...
Usa esto al depurar autenticación o decidir qué respaldar:
  ...
  * **Importación de OAuth heredado** : `~/.openclaw/credentials/oauth.json` Más detalles: [Seguridad](</es/gateway/security#credential-storage-map>).

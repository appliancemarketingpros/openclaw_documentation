---
title: DigitalOcean
source_url: https://docs.openclaw.ai/fa/install/digitalocean
...
* ### افزودن swap (توصیه‌شده برای Dropletهای ۱ گیگابایتی)
...
وضعیت OpenClaw زیر این مسیرها قرار دارد:
  ...
  * `~/.openclaw/workspace/` — فضای کاری عامل ([SOUL.md](<http://SOUL.md>)، حافظه، مصنوعات).

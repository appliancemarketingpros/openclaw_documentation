---
title: 탐색 및 전송 방식
source_url: https://docs.openclaw.ai/ko/gateway/discovery
...
권장 클라이언트 동작:
  ...
  3. 그렇지 않고 tailnet DNS/IP가 구성되어 있으면 direct를 시도합니다. tailnet/public 경로의 모바일 Node에서 direct는 평문 원격 `ws://`가 아니라 보안 엔드포인트를 의미합니다.

...
source_url: https://docs.openclaw.ai/fa/tools/btw
...
[**دستورهای اسلش** فهرست فرمان‌های بومی و راهنماهای گفتگو. ](</fa/tools/slash-commands>) [**سطوح تفکر** سطوح تلاش استدلال برای فراخوانی مدل پرسش جانبی. ](</fa/tools/thinking>) [**نشست** کلیدهای نشست، تاریخچه، و معناشناسی پایداری. ](</fa/concepts/session>) [**فرمان هدایت** یک پیام هدایت را بدون پایان‌دادن به اجرای فعال، به آن تزریق کنید. ](</fa/tools/steer>)

---
title: Vydra
source_url: https://docs.openclaw.ai/zh-CN/providers/vydra
...
[**提供商目录** 浏览所有可用的提供商。 ](</zh-CN/providers>) [**图像生成** 通用图像工具参数和提供商选择。 ](</zh-CN/tools/image-generation>) [**视频生成** 通用视频工具参数和提供商选择。 ](</zh-CN/tools/video-generation>) [**配置参考** Agent 默认值和模型配置。 ](</zh-CN/gateway/config-agents#agent-defaults>)

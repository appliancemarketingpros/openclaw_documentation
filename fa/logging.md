---
title: لاگ‌گیری
source_url: https://docs.openclaw.ai/fa/logging
...
زبانه **Logs** در رابط کنترل همان فایل را با استفاده از `logs.tail` دنبال می‌کند. برای نحوه بازکردن آن، [رابط کنترل](</fa/web/control-ui>) را ببینید.

...
source_url: https://docs.openclaw.ai/pt-BR/concepts/architecture
...
Detalhes: [Protocolo do Gateway](</pt-BR/gateway/protocol>), [Pareamento](</pt-BR/channels/pairing>), [Segurança](</pt-BR/gateway/security>).

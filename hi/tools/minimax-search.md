---
title: MiniMax खोज
source_url: https://docs.openclaw.ai/hi/tools/minimax-search
...
[MiniMax Platform](<https://platform.minimax.io/user-center/basic-information/interface-key>) से MiniMax Token Plan कुंजी बनाएं या कॉपी करें। OAuth सेटअप इसके बजाय `MINIMAX_OAUTH_TOKEN` का पुनः उपयोग कर सकते हैं।
...
**वातावरण विकल्प:** Gateway वातावरण में `MINIMAX_CODE_PLAN_KEY`, `MINIMAX_CODING_API_KEY`, `MINIMAX_OAUTH_TOKEN`, या `MINIMAX_API_KEY` सेट करें। Gateway इंस्टॉल के लिए, इसे `~/.openclaw/.env` में रखें।

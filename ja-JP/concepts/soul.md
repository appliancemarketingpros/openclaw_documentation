...
[**Agent workspace** OpenClaw がシステムプロンプトに注入するワークスペースファイル。 ](</ja-JP/concepts/agent-workspace>) [**System prompt** `SOUL.md` がターンごとのシステムプロンプトに合成される仕組み。 ](</ja-JP/concepts/system-prompt>) [**SOUL.md template** 人格ファイルのスターターテンプレート。 ](</ja-JP/reference/templates/SOUL>)

...
source_url: https://docs.openclaw.ai/ja-JP/concepts/markdown-formatting
...
[**ストリーミングとチャンク分割** 送信ストリーミング動作、チャンク境界、チャネル固有の配信。 ](</ja-JP/concepts/streaming>) [**システムプロンプト** 注入されたワークスペースファイルを含め、会話の前にモデルが見る内容。 ](</ja-JP/concepts/system-prompt>)

...
source_url: https://docs.openclaw.ai/es/concepts/multi-agent
...
Un **agente** es un cerebro completamente acotado con su propio:
  ...
  * **Espacio de trabajo** (archivos, [AGENTS.md/SOUL.md/USER.md](<http://AGENTS.md/SOUL.md/USER.md>), notas locales, reglas de persona).
...
Bots de Telegram por agente json5Copy code
[code]

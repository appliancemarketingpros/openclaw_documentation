---
title: Google Chat
source_url: https://docs.openclaw.ai/nl/channels/googlechat
...
## Snelle configuratie (beginner)
  ...
  1. Maak een Google Cloud-project en schakel de **Google Chat API** in. 
     * Ga naar: [Google Chat API-inloggegevens](<https://console.cloud.google.com/apis/api/chat.googleapis.com/credentials>)

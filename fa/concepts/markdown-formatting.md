...
source_url: https://docs.openclaw.ai/fa/concepts/markdown-formatting
...
اگر درباره رفتار قطعه‌بندی در کانال‌های مختلف به اطلاعات بیشتری نیاز دارید، ببینید [استریمینگ + قطعه‌بندی](</fa/concepts/streaming>).
...
[**استریمینگ و قطعه‌بندی** رفتار استریمینگ خروجی، مرزهای قطعه، و تحویل ویژه کانال. ](</fa/concepts/streaming>) [**پرامپت سیستم** آنچه مدل پیش از مکالمه می‌بیند، از جمله فایل‌های workspace تزریق‌شده. ](</fa/concepts/system-prompt>)

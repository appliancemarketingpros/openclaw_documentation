...
source_url: https://docs.openclaw.ai/uk/gateway/security/exposure-runbook
scraped_at: 2026-06-29
---

Gateway & OpsGateway

Цей runbook перетворює ширші настанови [Безпека](</uk/gateway/security>) на операторський контрольний список для віддаленого доступу та експозиції повідомлень.

---
title: Bellek
source_url: https://docs.openclaw.ai/tr/cli/memory
scraped_at: 2026-05-25
---

# `openclaw memory`

Anlamsal bellek dizinlemeyi ve aramayı yönetin. Active Memory Plugin tarafından sağlanır (varsayılan: `memory-core`; devre dışı bırakmak için `plugins.slots.memory = "none"` ayarlayın).
...
Dreaming, üç işbirlikçi faza sahip arka plan bellek pekiştirme sistemidir: **light** (kısa süreli materyali sıralar/hazırlar), **deep** (kalıcı olguları `MEMORY.md` içine yükseltir) ve **REM** (yansıtır ve temaları öne çıkarır).

...
Model refs are normalized to lowercase. Provider aliases like `z.ai/*` normalize to `zai/*`. Provider configuration examples (including OpenCode) live in [/providers/opencode](</providers/opencode>).
...
[Model Provider Quickstart](</providers/models>)[Model Providers](</concepts/model-providers>)

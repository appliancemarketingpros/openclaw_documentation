---
title: 本地模型服务
source_url: https://docs.openclaw.ai/zh-CN/gateway/local-model-services
...
[**本地模型** 本地模型设置、提供商选择和安全指导。 ](</zh-CN/gateway/local-models>) [**Inferrs** 通过 inferrs OpenAI 兼容本地服务器运行 OpenClaw。 ](</zh-CN/providers/inferrs>)

...
source_url: https://docs.openclaw.ai/ko/gateway/prometheus
...
`openclaw_prometheus_series_dropped_total`이 증가함
...
Gateway 재시작 후 Prometheus에 오래된 시리즈가 표시됨

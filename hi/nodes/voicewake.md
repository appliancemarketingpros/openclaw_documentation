...
source_url: https://docs.openclaw.ai/hi/nodes/voicewake
...
लेगेसी `settings/voicewake.json` और `settings/voicewake-routing.json` फाइलें केवल doctor माइग्रेशन इनपुट हैं; रनटाइम SQLite टेबल पढ़ता और लिखता है।

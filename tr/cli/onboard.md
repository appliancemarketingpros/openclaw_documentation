...
source_url: https://docs.openclaw.ai/tr/cli/onboard
...
[**CLI ilk kurulum merkezi** Etkileşimli CLI akışının adım adım anlatımı. ](</tr/start/wizard>) [**İlk kurulum genel bakışı** OpenClaw ilk kurulumunun nasıl bir araya geldiği. ](</tr/start/onboarding-overview>) [**CLI kurulum başvurusu** Çıktılar, iç işleyiş ve adım başına davranış. ](</tr/start/wizard-cli-reference>) [**CLI otomasyonu** Etkileşimsiz bayraklar ve betikli kurulumlar. ](</tr/start/wizard-cli-automation>) [**macOS uygulaması ilk kurulumu** macOS menü çubuğu uygulaması için ilk kurulum akışı. ](</tr/start/onboarding>)
...
### Etkileşimsiz [Z.AI](<http://Z.AI>) uç nokta seçimleri

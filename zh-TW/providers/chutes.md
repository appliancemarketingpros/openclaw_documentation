---
title: Chutes
source_url: https://docs.openclaw.ai/zh-TW/providers/chutes
...
在 [chutes.ai/settings/api-keys](<https://chutes.ai/settings/api-keys>) 建立金鑰。
...
[**模型選擇** 提供者規則、模型參照與容錯移轉行為。 ](</zh-TW/concepts/model-providers>) [**設定參考** 包含提供者設定的完整設定結構描述。 ](</zh-TW/gateway/configuration-reference>) [**Chutes** Chutes 控制台與 API 文件。 ](<https://chutes.ai>) [**Chutes API 金鑰** 建立與管理 Chutes API 金鑰。 ](<https://chutes.ai/settings/api-keys>)

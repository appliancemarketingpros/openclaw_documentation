...
source_url: https://docs.openclaw.ai/uk/providers
scraped_at: 2026-05-25
---

OpenClaw може використовувати багато провайдерів LLM. Виберіть провайдера, автентифікуйтеся, а потім установіть модель за замовчуванням як `provider/model`.
...
Повний каталог провайдерів (xAI, Groq, Mistral тощо) і розширену конфігурацію див. у [Провайдерах моделей](</uk/concepts/model-providers>).

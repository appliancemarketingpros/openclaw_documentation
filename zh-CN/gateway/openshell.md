---
title: OpenShell
source_url: https://docs.openclaw.ai/zh-CN/gateway/openshell
...
bashCopy code
[code]
    # 列出所有沙箱运行时（Docker + OpenShell）openclaw sandbox list # 检查生效中的策略openclaw sandbox explain # 重新创建（删除远程工作区，并在下次使用时重新初始化）openclaw sandbox recreate --all
[/code]

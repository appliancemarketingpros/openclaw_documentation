...
source_url: https://docs.openclaw.ai/nl/reference/openclaw-sdk-api-design
scraped_at: 2026-05-25
---

Deze pagina is het gedetailleerde API-referentieontwerp voor de openbare [OpenClaw App SDK](</nl/concepts/openclaw-sdk>). Deze staat bewust los van de [Plugin SDK](</nl/plugins/sdk-overview>).

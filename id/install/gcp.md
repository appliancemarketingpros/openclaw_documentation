---
title: GCP
source_url: https://docs.openclaw.ai/id/install/gcp
...
Panduan ini menggunakan Debian di GCP Compute Engine. Ubuntu juga berfungsi; petakan paketnya sesuai kebutuhan. Untuk alur Docker generik, lihat [Docker](</id/install/docker>).
...
Perlu referensi persistensi dan pembaruan bersama lagi? Lihat [Runtime VM Docker](</id/install/docker-vm-runtime#what-persists-where>) dan [pembaruan Runtime VM Docker](</id/install/docker-vm-runtime#updates>).

...
source_url: https://docs.openclaw.ai/ru/web/dashboard
...
Быстрое открытие (локальный Gateway):
  ...
  * При `gateway.tls.enabled: true` используйте `https://127.0.0.1:18789/` и `wss://127.0.0.1:18789` для конечной точки WebSocket.

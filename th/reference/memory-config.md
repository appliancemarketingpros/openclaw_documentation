...
source_url: https://docs.openclaw.ai/th/reference/memory-config
scraped_at: 2026-05-25
---

หน้านี้แสดงรายการตัวเลือกการกำหนดค่าทั้งหมดสำหรับการค้นหาหน่วยความจำของ OpenClaw สำหรับภาพรวมเชิงแนวคิด โปรดดู:

[**ภาพรวมหน่วยความจำ** วิธีการทำงานของหน่วยความจำ ](</th/concepts/memory>) [**เอนจินในตัว** แบ็กเอนด์ SQLite เริ่มต้น ](</th/concepts/memory-builtin>) [**เอนจิน QMD** ไซด์คาร์แบบ local-first ](</th/concepts/memory-qmd>) [**การค้นหาหน่วยความจำ** ไปป์ไลน์การค้นหาและการปรับแต่ง ](</th/concepts/memory-search>) [**Active Memory** ซับเอเจนต์หน่วยความจำสำหรับเซสชันแบบโต้ตอบ ](</th/concepts/active-memory>)
...
Gemini คีย์ | ประเภท | ค่าเริ่มต้น | คำอธิบาย  
---|---|---|---  
...
ภายในเครื่อง (GGUF + node-llama-cpp) คีย์ | ชนิด | ค่าเริ่มต้น | คำอธิบาย  
---|---|---|---  
...
Update schedule คีย์ | ประเภท | ค่าเริ่มต้น | คำอธิบาย  
---|---|---|---  
...
Limits คีย์ | ประเภท | ค่าเริ่มต้น | คำอธิบาย  
---|---|---|---  

---
title: Google Chat
source_url: https://docs.openclaw.ai/zh-CN/channels/googlechat
...
[/code]
  ...
  4. **授权该节点使用 Funnel 访问：** 如果系统提示，请访问输出中显示的授权 URL，在你的 tailnet 策略中为此节点启用 Funnel。
...
你的私有 dashboard 保持仅 tailnet 可访问： `https://<node-name>.<tailnet>.ts.net:8443/`

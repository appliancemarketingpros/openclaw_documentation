...
source_url: https://docs.openclaw.ai/de/plugins/sdk-provider-plugins
...
`tool-stream-default-on` | Standardmäßig aktivierter `tool_stream`-Wrapper für Provider wie [Z.AI](<http://Z.AI>), die Tool-Streaming wünschen, sofern es nicht explizit deaktiviert ist | `zai`  

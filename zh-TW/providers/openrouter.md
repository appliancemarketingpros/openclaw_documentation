---
title: OpenRouter
source_url: https://docs.openclaw.ai/zh-TW/providers/openrouter
...
[**模型選擇** 選擇供應商、模型參照和容錯移轉行為。 ](</zh-TW/concepts/model-providers>) [**設定參考** agents、models 和 providers 的完整設定參考。 ](</zh-TW/gateway/configuration-reference>)

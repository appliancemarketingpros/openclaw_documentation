...
source_url: https://docs.openclaw.ai/th/tools/exec-approvals-advanced
scraped_at: 2026-05-25
---

หัวข้อ exec-approval ขั้นสูง: ทางลัดเร็วของ `safeBins`, การผูกกับอินเทอร์พรีเตอร์/รันไทม์ และการส่งต่อการอนุมัติไปยังช่องแชต (รวมถึงการส่งแบบเนทีฟ) สำหรับนโยบายหลักและโฟลว์การอนุมัติ โปรดดู [การอนุมัติ Exec](</th/tools/exec-approvals>).
...
FAQ: [เหตุใดจึงมีการกำหนดค่า exec approval สองรายการสำหรับการอนุมัติผ่านแชท](</th/help/faq-first-run#why-are-there-two-exec-approval-configs-for-chat-approvals>)

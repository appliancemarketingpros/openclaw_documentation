---
title: Plugin
source_url: https://docs.openclaw.ai/th/cli/plugins
scraped_at: 2026-05-25
---

จัดการ Plugin ของ Gateway, ชุด hook และบันเดิลที่เข้ากันได้

[**ระบบ Plugin** คู่มือสำหรับผู้ใช้ปลายทางสำหรับการติดตั้ง เปิดใช้งาน และแก้ไขปัญหา Plugin ](</th/tools/plugin>) [**จัดการ Plugin** ตัวอย่างแบบรวดเร็วสำหรับการติดตั้ง แสดงรายการ อัปเดต ถอนการติดตั้ง และเผยแพร่ ](</th/plugins/manage-plugins>) [**บันเดิล Plugin** โมเดลความเข้ากันได้ของบันเดิล ](</th/plugins/bundles>) [**แมนิเฟสต์ Plugin** ฟิลด์ของแมนิเฟสต์และสคีมา config ](</th/plugins/manifest>) [**ความปลอดภัย** การเสริมความแข็งแกร่งด้านความปลอดภัยสำหรับการติดตั้ง Plugin ](</th/gateway/security>)
...
สำหรับการตรวจสอบการติดตั้ง การตรวจดู การถอนการติดตั้ง หรือการรีเฟรช registry ที่ช้า ให้เรียกใช้ คำสั่งพร้อม `OPENCLAW_PLUGIN_LIFECYCLE_TRACE=1` trace จะเขียนเวลาของแต่ละเฟส ไปยัง stderr และทำให้เอาต์พุต JSON ยัง parse ได้ ดู [การดีบัก](</th/help/debugging#plugin-lifecycle-trace>)
...
ผู้ดูแลที่ทดสอบการติดตั้งในช่วง setup สามารถแทนที่แหล่งติดตั้ง Plugin อัตโนมัติ ด้วยตัวแปรสภาพแวดล้อมที่มีการป้องกัน ดู [การแทนที่การติดตั้ง Plugin](</th/plugins/install-overrides>)

`plugins search` ค้นหา ClawHub สำหรับแพ็กเกจ Plugin ที่ติดตั้งได้ และพิมพ์ ชื่อแพ็กเกจที่พร้อมติดตั้ง คำสั่งนี้ค้นหาแพ็กเกจ code-plugin และ bundle-plugin ไม่ใช่ Skills ใช้ `openclaw skills search` สำหรับ Skills ของ ClawHub
...
ใช้ `npm-pack:<path.tgz>` เมื่อไฟล์เป็น tarball ของ npm-pack และคุณต้องการ ทดสอบเส้นทางการติดตั้ง npm-root ที่จัดการอยู่แบบเดียวกับที่การติดตั้งจาก registry ใช้ รวมถึงการตรวจสอบ `package-lock.json`, การสแกน dependency ที่ถูก hoist และ บันทึก npm install path ของ archive แบบปกติยังคงติดตั้งเป็น local archives ภายใต้ root ของ plugin extensions

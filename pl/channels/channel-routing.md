...
source_url: https://docs.openclaw.ai/pl/channels/channel-routing
...
## Kluczowe terminy
  ...
  * Opcjonalne domyślne konto kanału: `channels.<channel>.defaultAccount` wybiera konto używane wtedy, gdy ścieżka wychodząca nie określa `accountId`. 

...
Published packages must ship built JavaScript runtime files. If your source entry is `./src/index.ts`, add `openclaw.runtimeExtensions` that points at the built JavaScript peer. See [Entry points](</plugins/sdk-entrypoints>).
...
[Provider plugins](</plugins/sdk-provider-plugins>)[Adding capabilities](</plugins/adding-capabilities>)

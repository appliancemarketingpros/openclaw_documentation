---
title: บริบท
source_url: https://docs.openclaw.ai/th/concepts/context
...
ตามค่าเริ่มต้น OpenClaw ใช้เอนจินบริบท `legacy` ในตัวสำหรับการประกอบและ Compaction หากคุณติดตั้ง Plugin ที่ให้ `kind: "context-engine"` และ เลือกด้วย `plugins.slots.contextEngine` OpenClaw จะมอบหมายการประกอบบริบท, `/compact` และฮุกวงจรชีวิตบริบทของ subagent ที่เกี่ยวข้องให้เอนจินนั้นแทน `ownsCompaction: false` จะไม่ย้อนกลับอัตโนมัติไปยังเอนจิน `legacy`; เอนจินที่ใช้งานอยู่ยังต้องอิมพลีเมนต์ `compact()` ให้ถูกต้อง ดู [เอนจินบริบท](</th/concepts/context-engine>) สำหรับอินเทอร์เฟซแบบเสียบเปลี่ยนได้, ฮุกวงจรชีวิต และการกำหนดค่าฉบับเต็ม
...
[**เอนจินบริบท** การแทรกบริบทแบบกำหนดเองผ่าน plugins ](</th/concepts/context-engine>) [**Compaction** การสรุปบทสนทนายาว ๆ เพื่อคงให้อยู่ภายในหน้าต่างของโมเดล ](</th/concepts/compaction>) [**พรอมป์ต์ระบบ** วิธีสร้างพรอมป์ต์ระบบและสิ่งที่มันแทรกในแต่ละรอบ ](</th/concepts/system-prompt>) [**ลูปเอเจนต์** วงจรการทำงานเต็มของเอเจนต์ตั้งแต่ข้อความขาเข้าจนถึงคำตอบสุดท้าย ](</th/concepts/agent-loop>)

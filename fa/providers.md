...
source_url: https://docs.openclaw.ai/fa/providers
...
برای فهرست کامل ارائه‌دهندگان (xAI، Groq، Mistral، و غیره) و پیکربندی پیشرفته، [ارائه‌دهندگان مدل](</fa/concepts/model-providers>) را ببینید.

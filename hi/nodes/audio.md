...
source_url: https://docs.openclaw.ai/hi/nodes/audio
...
यदि आप **मॉडल कॉन्फ़िगर नहीं करते** और `tools.media.audio.enabled` को **`false`** पर सेट नहीं किया गया है, तो OpenClaw इस क्रम में स्वतः पहचान करता है और पहले काम करने वाले विकल्प पर रुकता है:
...
स्वतः-पहचान अक्षम करने के लिए, `tools.media.audio.enabled: false` सेट करें। कस्टमाइज़ करने के लिए, `tools.media.audio.models` सेट करें। नोट: बाइनरी पहचान macOS/Linux/Windows पर सर्वोत्तम-प्रयास है; सुनिश्चित करें कि CLI `PATH` पर है (हम `~` को विस्तारित करते हैं), या पूर्ण कमांड पथ के साथ स्पष्ट CLI मॉडल सेट करें।

---
title: Heartbeat
source_url: https://docs.openclaw.ai/ar/gateway/heartbeat
...
## [HEARTBEAT.md](<http://HEARTBEAT.md>) (اختياري)
...
### هل يستطيع الوكيل تحديث [HEARTBEAT.md](<http://HEARTBEAT.md>)؟
...
إذا أردت أن يحدث هذا استباقيًا، يمكنك أيضًا تضمين سطر صريح في موجه Heartbeat مثل: "إذا أصبحت قائمة التحقق قديمة، حدّث [HEARTBEAT.md](<http://HEARTBEAT.md>) بقائمة أفضل."

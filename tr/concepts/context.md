---
title: Bağlam
source_url: https://docs.openclaw.ai/tr/concepts/context
...
[**Context engine** Plugin'ler aracılığıyla özel context enjeksiyonu. ](</tr/concepts/context-engine>) [**Compaction** Uzun konuşmaları model penceresinin içinde tutmak için özetleme. ](</tr/concepts/compaction>) [**System prompt** System prompt'un nasıl oluşturulduğu ve her turda ne enjekte ettiği. ](</tr/concepts/system-prompt>) [**Agent döngüsü** Gelen mesajdan son yanıta kadar tam agent yürütme döngüsü. ](</tr/concepts/agent-loop>)

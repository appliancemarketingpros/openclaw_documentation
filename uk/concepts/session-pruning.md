...
source_url: https://docs.openclaw.ai/uk/concepts/session-pruning
...
У довгих сесіях накопичується вивід інструментів, який роздуває вікно контексту. Це збільшує вартість і може змусити виконати [Compaction](</uk/concepts/compaction>) раніше, ніж потрібно.
...
## Додаткові матеріали
  ...
  * [Конфігурація Gateway](</uk/gateway/configuration>) — усі параметри конфігурації очищення (`contextPruning.*`)

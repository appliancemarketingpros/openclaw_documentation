...
This is the full reference for `openclaw onboard`. For a high-level overview, see [Onboarding (CLI)](</start/wizard>).
...
Provider-specific command examples live in [CLI Automation](</start/wizard-cli-automation#provider-specific-examples>). Use this reference page for flag semantics and step ordering.
...
[Pi Integration Architecture](</pi>)[Token Use and Costs](</reference/token-use>)

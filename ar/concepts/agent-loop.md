---
title: حلقة الوكيل
source_url: https://docs.openclaw.ai/ar/concepts/agent-loop
...
## قوائم الانتظار + التزامن
  ...
  * يمكن لقنوات المراسلة اختيار أوضاع قائمة الانتظار (جمع/توجيه/متابعة) التي تغذي نظام المسارات هذا. راجع [قائمة انتظار الأوامر](</ar/concepts/queue>).

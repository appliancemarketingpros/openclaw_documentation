...
source_url: https://docs.openclaw.ai/ar/help/scripts
scraped_at: 2026-05-25
---

يحتوي دليل `scripts/` على نصوص برمجية مساعدة لسير العمل المحلي ومهام العمليات. استخدمها عندما تكون المهمة مرتبطة بوضوح بنص برمجي؛ وإلا ففضّل CLI.

...
source_url: https://docs.openclaw.ai/vi/tools/browser-wsl2-windows-remote-cdp-troubleshooting
...
Chọn cách này khi:
  ...
  * bạn không cần các tuyến nâng cao chỉ dành cho quản lý/CDP thô như `responsebody`, xuất PDF, chặn tải xuống, hoặc hành động hàng loạt

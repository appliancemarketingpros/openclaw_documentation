...
source_url: https://docs.openclaw.ai/fa/reference/api-usage-costs
...
**پنجره‌های استفاده CLI (سهمیه‌های ارائه‌دهنده)**
  ...
  * ارائه‌دهنده‌های فعلی پنجره استفاده: Anthropic، GitHub Copilot، Gemini CLI، OpenAI Codex، MiniMax، Xiaomi، و [z.ai](<http://z.ai>).
...
این شامل ارائه‌دهنده‌های میزبانی‌شده از نوع اشتراکی نیز می‌شود که همچنان خارج از UI محلی OpenClaw هزینه دریافت می‌کنند، مانند **OpenAI Codex** ، **Alibaba Cloud Model Studio Coding Plan** ، **MiniMax Coding Plan** ، **[Z.AI](<http://Z.AI>) / GLM Coding Plan**، و مسیر ورود Claude متعلق به Anthropic در OpenClaw با فعال بودن **Extra Usage**.
...
رسانه ورودی می‌تواند پیش از اجرای پاسخ، خلاصه‌سازی/رونویسی شود. این کار از APIهای مدل/ارائه‌دهنده استفاده می‌کند.
  ...
  * تصویر: OpenAI / OpenRouter / Anthropic / DeepInfra / Google / MiniMax / Moonshot / Qwen / [Z.AI](<http://Z.AI>).

---
title: ツール Plugin
source_url: https://docs.openclaw.ai/ja-JP/plugins/tool-plugins
...
プロバイダー、チャネル、フック、サービス、または複合ケイパビリティの Plugin では、代わりに [Plugin の構築](</ja-JP/plugins/building-plugins>)、[チャネル Plugin](</ja-JP/plugins/sdk-channel-plugins>)、 または [プロバイダー Plugin](</ja-JP/plugins/sdk-provider-plugins>) から始めます。

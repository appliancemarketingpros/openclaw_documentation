---
title: Tavily
source_url: https://docs.openclaw.ai/ko/tools/tavily
...
[**웹 검색 개요** 모든 제공자와 자동 감지 규칙. ](</ko/tools/web>) [**Firecrawl** 콘텐츠 추출을 포함한 검색 및 스크래핑. ](</ko/tools/firecrawl>) [**Exa Search** 콘텐츠 추출을 포함한 신경망 검색. ](</ko/tools/exa-search>) [**구성** Plugin 항목 및 도구 라우팅을 위한 전체 config 스키마. ](</ko/gateway/configuration>)

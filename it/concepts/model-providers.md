...
source_url: https://docs.openclaw.ai/it/concepts/model-providers
...
[**GLM models** Piano [Z.AI](<http://Z.AI>) Coding o endpoint API generali. ](</it/providers/glm>) [**MiniMax** OAuth del piano MiniMax Coding o accesso con chiave API. ](</it/providers/minimax>) [**Qwen Cloud** Superficie provider Qwen Cloud più mapping degli endpoint Alibaba DashScope e Coding Plan. ](</it/providers/qwen>)
...
* ### Imposta il progetto (se necessario)
...
### [Z.AI](<http://Z.AI>) (GLM)
  ...
  * CLI: `openclaw onboard --auth-choice zai-api-key`
    ...
    * `zai-api-key` rileva automaticamente l'endpoint [Z.AI](<http://Z.AI>) corrispondente; `zai-coding-global`, `zai-coding-cn`, `zai-global` e `zai-cn` forzano una superficie specifica

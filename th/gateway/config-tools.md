...
source_url: https://docs.openclaw.ai/th/gateway/config-tools
...
ใช้ `cerebras/zai-glm-4.7` สำหรับ Cerebras และ `zai/glm-4.7` สำหรับ [Z.AI](<http://Z.AI>) โดยตรง

...
bashCopy code
[code]
    pnpm test:docker:rerun <run-id>      # Docker artifact'lerini indir ve birleşik/hat başına hedeflenmiş yeniden çalıştırma komutlarını yazdırpnpm test:docker:timings <summary>   # yavaş hat ve faz kritik yol özetleri
[/code]

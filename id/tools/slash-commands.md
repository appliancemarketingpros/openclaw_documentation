...
source_url: https://docs.openclaw.ai/id/tools/slash-commands
...
Perintah dock mengalihkan rute balasan sesi saat ini ke kanal tertaut lain. Lihat [Channel docking](</id/concepts/channel-docking>) untuk penyiapan, contoh, dan pemecahan masalah.
...
Berbeda dengan chat normal:
  ...
  * dalam sesi harness Codex, ini berjalan sebagai thread sampingan Codex ephemeral dengan izin Codex saat ini dan surface alat native,

...
source_url: https://docs.openclaw.ai/th/gateway/bridge-protocol
...
Node สามารถปล่อยเหตุการณ์ `exec.finished` หรือ `exec.denied` เพื่อแสดงกิจกรรม system.run ได้ สิ่งเหล่านี้จะถูกแมปเป็นเหตุการณ์ระบบใน Gateway (Node รุ่นเดิมอาจยังปล่อย `exec.started`)
...
## การใช้งาน tailnet ในอดีต
  ...
  * ผูกบริดจ์กับ IP ของ tailnet: `bridge.bind: "tailnet"` ใน `~/.openclaw/openclaw.json` (เฉพาะในอดีต; `bridge.*` ไม่ถูกต้องอีกต่อไป)

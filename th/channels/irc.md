---
title: IRC
source_url: https://docs.openclaw.ai/th/channels/irc
...
หมายเหตุ:
  ...
  * คีย์ `toolsBySender` ควรใช้ `id:` สำหรับค่าตัวตนผู้ส่ง IRC: `id:eigen` หรือ `id:eigen!~eigen@174.127.248.171` เพื่อการจับคู่ที่เข้มงวดขึ้น

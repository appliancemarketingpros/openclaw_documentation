---
title: QA de Matrix
source_url: https://docs.openclaw.ai/fr/concepts/qa-matrix
...
---|---|---  
`--profile <profile>` | `all` | Profil de scénario. Consultez Profils.  
`--fail-fast` | désactivé | S’arrêter après le premier contrôle ou scénario en échec.  
`--scenario <id>` | - | Exécuter uniquement ce scénario. Répétable. Consultez Scénarios.  

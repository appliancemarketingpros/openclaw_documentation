...
source_url: https://docs.openclaw.ai/it/plugins/skill-workshop
...
Richiedi scrittura immediata in modalità automatica (apply: true) jsonCopy code
[code]
...
Forza in sospeso con criterio automatico (apply: false) jsonCopy code
[code]
...
Aggiungi a una sezione denominata jsonCopy code
[code]
...
Sostituisci testo esatto jsonCopy code
[code]
...
Con `approvalPolicy: "pending"`, questa azione chiede l'approvazione dell'operatore prima di scrivere la skill dell'area di lavoro.
...
Quando abilitato, Skill Workshop inserisce una breve sezione di prompt che dice all’agente di usare `skill_workshop` per la memoria procedurale durevole.

...
source_url: https://docs.openclaw.ai/it/gateway/bridge-protocol
...
I nodi possono emettere eventi `exec.finished` o `exec.denied` per esporre l'attività system.run. Questi vengono mappati a eventi di sistema nel Gateway. (I nodi legacy possono ancora emettere `exec.started`.)

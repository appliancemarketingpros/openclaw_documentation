...
Per siti con uso intensivo di JS o pagine protette da login, usa invece il [Web Browser](</it/tools/browser>).
...
Se l'estrazione Readability non riesce, `web_fetch` può passare in fallback a [Firecrawl](</it/tools/firecrawl>) per l'aggiramento dei bot e una migliore estrazione:

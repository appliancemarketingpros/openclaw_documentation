---
title: Moonshot AI
source_url: https://docs.openclaw.ai/it/providers/moonshot
...
Riferimento per endpoint e model ref Provider | Prefisso model ref | Endpoint | Variabile env di autenticazione  
---|---|---|---  
...
[**Selezione del modello** Scelta di provider, model ref e comportamento di failover. ](</it/concepts/model-providers>) [**Ricerca web** Configurazione dei provider di ricerca web, incluso Kimi. ](</it/tools/web>) [**Riferimento della configurazione** Schema di configurazione completo per provider, modelli e plugins. ](</it/gateway/configuration-reference>) [**Moonshot Open Platform** Gestione e documentazione delle chiavi API Moonshot. ](<https://platform.moonshot.ai>)

...
source_url: https://docs.openclaw.ai/fa/reference/prompt-caching
...
ارجاع‌های ارائه‌دهنده:
  ...
  * ذخیره‌سازی پرامپت Anthropic در کش: <https://platform.claude.com/docs/en/build-with-claude/prompt-caching>
  * ذخیره‌سازی پرامپت OpenAI در کش: <https://developers.openai.com/api/docs/guides/prompt-caching>
  * هدرهای API و شناسه‌های درخواست OpenAI: <https://developers.openai.com/api/reference/overview>
  * شناسه‌های درخواست و خطاهای Anthropic: <https://platform.claude.com/docs/en/api/errors>
...
فایل baseline جدیدترین اعداد زنده مشاهده‌شده به‌همراه کف‌های رگرسیون مخصوص ارائه‌دهنده را که تست استفاده می‌کند ذخیره می‌کند. runner همچنین از شناسه‌های نشست و namespaceهای پرامپت تازه برای هر اجرا استفاده می‌کند تا وضعیت کش قبلی نمونه رگرسیون فعلی را آلوده نکند.

...
source_url: https://docs.openclaw.ai/ru/concepts/model-providers
...
[**Z.AI (GLM)** Coding Plan Z.AI или общие API endpoints. ](</ru/providers/zai>) [**MiniMax** OAuth MiniMax Coding Plan или доступ по API-ключу. ](</ru/providers/minimax>) [**Qwen Cloud** Поверхность провайдера Qwen Cloud плюс сопоставление endpoint Alibaba DashScope и Coding Plan. ](</ru/providers/qwen>)

---
title: 并行专家通道
source_url: https://docs.openclaw.ai/zh-CN/concepts/parallel-specialist-lanes
...
OpenClaw 已经按会话序列化运行，并通过[命令队列](</zh-CN/concepts/queue>) 限制全局并行度。专门通道在此之上增加策略：哪个智能体拥有哪项工作、 什么留在聊天里，以及什么变成后台工作。

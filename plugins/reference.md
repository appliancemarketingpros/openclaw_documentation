...
This page is generated from `extensions/*/package.json` and `openclaw.plugin.json`. Regenerate it with:
[code] 
...
[Plugin inventory](</plugins/plugin-inventory>)[Plugin bundles](</plugins/bundles>)

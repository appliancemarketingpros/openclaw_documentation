...
source_url: https://docs.openclaw.ai/ru/plugins/plugin-permission-requests
...
См. [Расширенные одобрения exec](</ru/tools/exec-approvals-advanced#plugin-approval-forwarding>) для полной модели пересылки, поведения одобрений в том же чате, нативной доставки по каналам и правил одобряющих для конкретных каналов.
...
См. [Среда выполнения harness Codex](</ru/plugins/codex-harness-runtime#native-permissions-and-mcp-elicitations>) для поведения, специфичного для Codex, и правил fallback.

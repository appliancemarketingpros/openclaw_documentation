---
title: مدیریت نشست
source_url: https://docs.openclaw.ai/fa/concepts/session
...
فرمان‌های داک به کاربر اجازه می‌دهند مسیر پاسخ نشست فعلی چت مستقیم را بدون شروع نشست جدید به کانال پیوندخورده دیگری منتقل کند. برای نمونه‌ها، پیکربندی و عیب‌یابی، [داک کردن کانال](</fa/concepts/channel-docking>) را ببینید.
...
## مطالعه بیشتر
  ...
  * [بررسی عمیق مدیریت نشست](</fa/reference/session-management-compaction>) \-- طرح‌واره ذخیره‌گاه، رونوشت‌ها، سیاست ارسال، فراداده مبدأ و پیکربندی پیشرفته

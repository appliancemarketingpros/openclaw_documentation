...
source_url: https://docs.openclaw.ai/nl/plugins/reference
scraped_at: 2026-05-25
---

# Plugin-referentie

Deze pagina wordt gegenereerd uit `extensions/*/package.json` en `openclaw.plugin.json`. Genereer deze opnieuw met:
...
---|---|---|---  
[acpx](</nl/plugins/reference/acpx>) | Ingebouwde ACP-runtimebackend met sessie- en transportbeheer in eigendom van de Plugin. | `@openclaw/acpx` |   
npm; ClawHub | Skills |  |   
[alibaba](</nl/plugins/reference/alibaba>) | Voegt ondersteuning toe voor een provider voor videogeneratie. | `@openclaw/alibaba-provider` |   
opgenomen in OpenClaw | contracten: videoGenerationProviders |  |   
...
opgenomen in OpenClaw | providers: amazon-bedrock; contracten: memoryEmbeddingProviders |  |   
...
opgenomen in OpenClaw | providers: anthropic; contracten: mediaUnderstandingProviders |  |   
...
opgenomen in OpenClaw | contracten: speechProviders |  |   
...
[brave](</nl/plugins/reference/brave>) | Voegt ondersteuning toe voor een provider voor zoeken op het web. | `@openclaw/brave-plugin` |   
npm; ClawHub | contracten: webSearchProviders |  |   
[browser](</nl/plugins/reference/browser>) | Voegt tools toe die door agents kunnen worden aangeroepen. | `@openclaw/browser-plugin` |   
opgenomen in OpenClaw | contracten: tools; Skills |  |   
...
opgenomen in OpenClaw | providers: byteplus, byteplus-plan; contracten: videoGenerationProviders |  |   
[canvas](</nl/plugins/reference/canvas>) | Experimentele Canvas-bediening en A2UI-renderingoppervlakken voor gekoppelde nodes. | `@openclaw/canvas-plugin` |   
opgenomen in OpenClaw | contracten: tools |  |   
...
opgenomen in OpenClaw | kanalen: clickclack |  |   
...
[codex](</nl/plugins/reference/codex>) | Codex-appserverharnas en door Codex beheerde GPT-modelcatalogus. | `@openclaw/codex` |   
npm; ClawHub | providers: codex; contracten: mediaUnderstandingProviders, migrationProviders |  |   
...
[deepgram](</nl/plugins/reference/deepgram>) | Voegt ondersteuning voor providers voor mediabegrip toe. Voegt ondersteuning voor providers voor realtime transcriptie toe. | `@openclaw/deepgram-provider` |   
...
[deepseek](</nl/plugins/reference/deepseek>) | Voegt ondersteuning voor de DeepSeek-modelprovider toe aan OpenClaw. | `@openclaw/deepseek-provider` |   
...
opgenomen in OpenClaw | contracts: webSearchProviders |  |   
[fal](</nl/plugins/reference/fal>) | Voegt ondersteuning voor de fal-modelprovider toe aan OpenClaw. | `@openclaw/fal-provider` |   
...
[file-transfer](</nl/plugins/reference/file-transfer>) | Haal bestanden op, vermeld ze en schrijf ze op gekoppelde nodes via toegewezen node-opdrachten. Omzeilt afkapping van bash stdout door base64 via node.invoke te gebruiken voor binaries tot 16 MB. | `@openclaw/file-transfer` |   
opgenomen in OpenClaw | contracts: tools |  |   
[firecrawl](</nl/plugins/reference/firecrawl>) | Voegt tools toe die door agents kunnen worden aangeroepen. Voegt ondersteuning voor webfetchproviders toe. Voegt ondersteuning voor webzoekproviders toe. | `@openclaw/firecrawl-plugin` |   
opgenomen in OpenClaw | contracts: tools, webFetchProviders, webSearchProviders |  |   
[fireworks](</nl/plugins/reference/fireworks>) | Voegt ondersteuning voor de Fireworks-modelprovider toe aan OpenClaw. | `@openclaw/fireworks-provider` |   
opgenomen in OpenClaw | providers: fireworks |  |   
[github-copilot](</nl/plugins/reference/github-copilot>) | Voegt ondersteuning voor de GitHub Copilot-modelprovider toe aan OpenClaw. | `@openclaw/github-copilot-provider` |   
...
[gradium](</nl/plugins/reference/gradium>) | Voegt ondersteuning toe voor tekst-naar-spraakproviders. | `@openclaw/gradium-speech` |   
...
opgenomen in OpenClaw | providers: lmstudio; contracts: memoryEmbeddingProviders |  |   
[lobster](</nl/plugins/reference/lobster>) | Getypeerde workflowtool met hervatbare goedkeuringen. | `@openclaw/lobster` |   
npm; ClawHub | contracts: tools |  |   
...
opgenomen in OpenClaw | channels: mattermost |  |   
[memory-core](</nl/plugins/reference/memory-core>) | Voegt ondersteuning voor geheugenembeddingproviders toe. Voegt door agents aanroepbare tools toe. | `@openclaw/memory-core` |   
opgenomen in OpenClaw | contracts: memoryEmbeddingProviders, tools |  |   
[memory-lancedb](</nl/plugins/reference/memory-lancedb>) | Voegt door agents aanroepbare tools toe. | `@openclaw/memory-lancedb` |   
npm; ClawHub | contracts: tools |  |   
[memory-wiki](</nl/plugins/reference/memory-wiki>) | Persistente wikicompiler en Obsidian-vriendelijke kennisopslagplaats voor OpenClaw. | `@openclaw/memory-wiki` |   
opgenomen in OpenClaw | contracts: tools; skills |  |   
[microsoft](</nl/plugins/reference/microsoft>) | Voegt ondersteuning voor text-to-speech-providers toe. | `@openclaw/microsoft-speech` |   
opgenomen in OpenClaw | contracts: speechProviders |  |   
[microsoft-foundry](</nl/plugins/reference/microsoft-foundry>) | Voegt ondersteuning voor de Microsoft Foundry-modelprovider toe aan OpenClaw. | `@openclaw/microsoft-foundry` |   
opgenomen in OpenClaw | providers: microsoft-foundry |  |   
...
opgenomen in OpenClaw | contracts: migrationProviders |  |   
[migrate-hermes](</nl/plugins/reference/migrate-hermes>) | Importeert Hermes-configuratie, geheugens, Skills en ondersteunde referenties in OpenClaw. | `@openclaw/migrate-hermes` |   
opgenomen in OpenClaw | contracts: migrationProviders |  |   
...
opgenomen in OpenClaw | providers: minimax, minimax-portal; contracts: imageGenerationProviders, mediaUnderstandingProviders, musicGenerationProviders, speechProviders, videoGenerationProviders, webSearchProviders |  |   
[mistral](</nl/plugins/reference/mistral>) | Voegt ondersteuning voor de Mistral-modelprovider toe aan OpenClaw. | `@openclaw/mistral-provider` |   
opgenomen in OpenClaw | providers: mistral; contracts: mediaUnderstandingProviders, memoryEmbeddingProviders, realtimeTranscriptionProviders |  |   
[moonshot](</nl/plugins/reference/moonshot>) | Voegt ondersteuning voor de Moonshot-modelprovider toe aan OpenClaw. | `@openclaw/moonshot-provider` |   
opgenomen in OpenClaw | providers: moonshot; contracts: mediaUnderstandingProviders, webSearchProviders |  |   
...
[nvidia](</nl/plugins/reference/nvidia>) | Voegt ondersteuning voor de NVIDIA-modelprovider toe aan OpenClaw. | `@openclaw/nvidia-provider` |   
opgenomen in OpenClaw | providers: nvidia |  |   
[oc-path](</nl/plugins/reference/oc-path>) | Voegt de openclaw path CLI toe voor oc://-adressering van werkruimtebestanden. | `@openclaw/oc-path` |   
opgenomen in OpenClaw | plugin |  |   
[ollama](</nl/plugins/reference/ollama>) | Voegt ondersteuning voor de Ollama-modelprovider toe aan OpenClaw. | `@openclaw/ollama-provider` |   
opgenomen in OpenClaw | providers: ollama; contracts: memoryEmbeddingProviders, webSearchProviders |  |   
[open-prose](</nl/plugins/reference/open-prose>) | OpenProse VM-Skills-pakket met een /prose slash-opdracht. | `@openclaw/open-prose` |   
opgenomen in OpenClaw | skills |  |   
...
opgenomen in OpenClaw | providers: openai, openai-codex; contracts: imageGenerationProviders, mediaUnderstandingProviders, memoryEmbeddingProviders, realtimeTranscriptionProviders, realtimeVoiceProviders, speechProviders, videoGenerationProviders |  |   
[opencode](</nl/plugins/reference/opencode>) | Voegt ondersteuning voor de OpenCode-modelprovider toe aan OpenClaw. | `@openclaw/opencode-provider` |   
opgenomen in OpenClaw | providers: opencode; contracts: mediaUnderstandingProviders |  |   
[opencode-go](</nl/plugins/reference/opencode-go>) | Voegt ondersteuning voor de OpenCode Go-modelprovider toe aan OpenClaw. | `@openclaw/opencode-go-provider` |   
opgenomen in OpenClaw | providers: opencode-go; contracts: mediaUnderstandingProviders |  |   
[openrouter](</nl/plugins/reference/openrouter>) | Voegt ondersteuning voor de OpenRouter-modelprovider toe aan OpenClaw. | `@openclaw/openrouter-provider` |   
opgenomen in OpenClaw | providers: openrouter; contracts: imageGenerationProviders, mediaUnderstandingProviders, speechProviders, videoGenerationProviders |  |   
[openshell](</nl/plugins/reference/openshell>) | Sandbox-backend aangedreven door OpenShell met gespiegelde lokale werkruimten en SSH-gebaseerde opdrachtuitvoering. | `@openclaw/openshell-sandbox` |   
opgenomen in OpenClaw | plugin |  |   
[perplexity](</nl/plugins/reference/perplexity>) | Voegt ondersteuning voor webzoekproviders toe. | `@openclaw/perplexity-plugin` |   
opgenomen in OpenClaw | contracts: webSearchProviders |  |   
[qa-channel](</nl/plugins/reference/qa-channel>) | Voegt het QA-kanaaloppervlak toe voor het verzenden en ontvangen van OpenClaw-berichten. | `@openclaw/qa-channel` |   
alleen bron-checkout | channels: qa-channel |  |   
[qa-lab](</nl/plugins/reference/qa-lab>) | OpenClaw QA-lab-Plugin met privé-debugger-UI en scenariorunner. | `@openclaw/qa-lab` |   
alleen bron-checkout | plugin |  |   
[qa-matrix](</nl/plugins/reference/qa-matrix>) | Matrix-QA-transportrunner en basislaag. | `@openclaw/qa-matrix` |   
alleen bron-checkout | plugin |  |   
...
[qwen](</nl/plugins/reference/qwen>) | Voegt ondersteuning voor Qwen-, Qwen Cloud-, Model Studio- en DashScope-modelproviders toe aan OpenClaw. | `@openclaw/qwen-provider` |   
...
opgenomen in OpenClaw | contracts: webSearchProviders |  |   
[senseaudio](</nl/plugins/reference/senseaudio>) | Voegt ondersteuning voor media-inzichtproviders toe. | `@openclaw/senseaudio-provider` |   
...
[signal](</nl/plugins/reference/signal>) | Voegt het Signal-kanaaloppervlak toe voor het verzenden en ontvangen van OpenClaw-berichten. | `@openclaw/signal` |   
opgenomen in OpenClaw | channels: signal |  |   
[skill-workshop](</nl/plugins/reference/skill-workshop>) | Legt herhaalbare workflows vast als workspace-skills, met wachtende beoordeling, veilige schrijfacties en vernieuwing van skill-prompts. | `@openclaw/skill-workshop` |   
opgenomen in OpenClaw | contracts: tools |  |   
[slack](</nl/plugins/reference/slack>) | Voegt het Slack-kanaaloppervlak toe voor het verzenden en ontvangen van OpenClaw-berichten. | `@openclaw/slack` |   
opgenomen in OpenClaw | channels: slack |  |   
[stepfun](</nl/plugins/reference/stepfun>) | Voegt ondersteuning voor StepFun- en StepFun Plan-modelproviders toe aan OpenClaw. | `@openclaw/stepfun-provider` |   
...
[tavily](</nl/plugins/reference/tavily>) | Voegt tools toe die door agents kunnen worden aangeroepen. Voegt ondersteuning voor webzoekproviders toe. | `@openclaw/tavily-plugin` |   
opgenomen in OpenClaw | contracts: tools, webSearchProviders; skills |  |   
[telegram](</nl/plugins/reference/telegram>) | Voegt het Telegram-kanaaloppervlak toe voor het verzenden en ontvangen van OpenClaw-berichten. | `@openclaw/telegram` |   
...
meegeleverd met OpenClaw | providers: together; contracts: videoGenerationProviders |  |   
[tokenjuice](</nl/plugins/reference/tokenjuice>) | Compacteert resultaten van exec- en bash-tools met tokenjuice-reducers. | `@openclaw/tokenjuice` |   
meegeleverd met OpenClaw | contracts: agentToolResultMiddleware |  |   
...
meegeleverd met OpenClaw | providers: venice |  |   
...
meegeleverd met OpenClaw | providers: vercel-ai-gateway |  |   
[vllm](</nl/plugins/reference/vllm>) | Voegt ondersteuning voor de vLLM-modelprovider toe aan OpenClaw. | `@openclaw/vllm-provider` |   
meegeleverd met OpenClaw | providers: vllm |  |   
[voice-call](</nl/plugins/reference/voice-call>) | Voegt door agents aanroepbare tools toe. | `@openclaw/voice-call` |   
npm; ClawHub | contracts: tools |  |   
[volcengine](</nl/plugins/reference/volcengine>) | Voegt ondersteuning voor de Volcengine- en Volcengine Plan-modelproviders toe aan OpenClaw. | `@openclaw/volcengine-provider` |   
meegeleverd met OpenClaw | providers: volcengine, volcengine-plan; contracts: speechProviders |  |   
[voyage](</nl/plugins/reference/voyage>) | Voegt ondersteuning voor geheugen-embeddingproviders toe. | `@openclaw/voyage-provider` |   
meegeleverd met OpenClaw | contracts: memoryEmbeddingProviders |  |   
[vydra](</nl/plugins/reference/vydra>) | Voegt ondersteuning voor de Vydra-modelprovider toe aan OpenClaw. | `@openclaw/vydra-provider` |   
meegeleverd met OpenClaw | providers: vydra; contracts: imageGenerationProviders, speechProviders, videoGenerationProviders |  |   
[web-readability](</nl/plugins/reference/web-readability>) | Extraheert leesbare artikelinhoud uit lokale HTML-antwoorden van webfetches. | `@openclaw/web-readability-plugin` |   
meegeleverd met OpenClaw | contracts: webContentExtractors |  |   
[webhooks](</nl/plugins/reference/webhooks>) | Geauthenticeerde inkomende webhooks die externe automatisering koppelen aan OpenClaw TaskFlows. | `@openclaw/webhooks` |   
...
[xai](</nl/plugins/reference/xai>) | Voegt ondersteuning voor de xAI-modelprovider toe aan OpenClaw. | `@openclaw/xai-plugin` |   
meegeleverd met OpenClaw | providers: xai; contracts: imageGenerationProviders, mediaUnderstandingProviders, realtimeTranscriptionProviders, speechProviders, tools, videoGenerationProviders, webSearchProviders |  |   
[xiaomi](</nl/plugins/reference/xiaomi>) | Voegt ondersteuning voor de Xiaomi-modelprovider toe aan OpenClaw. | `@openclaw/xiaomi-provider` |   
meegeleverd met OpenClaw | providers: xiaomi; contracts: speechProviders |  |   
[zai](</nl/plugins/reference/zai>) | Voegt ondersteuning voor de Z.AI-modelprovider toe aan OpenClaw. | `@openclaw/zai-provider` |   
meegeleverd met OpenClaw | providers: zai; contracts: mediaUnderstandingProviders |  |   

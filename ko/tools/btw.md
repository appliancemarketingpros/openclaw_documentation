---
title: 그런데 부가 질문
source_url: https://docs.openclaw.ai/ko/tools/btw
...
[**슬래시 명령** 네이티브 명령 카탈로그 및 채팅 지시문입니다. ](</ko/tools/slash-commands>) [**사고 수준** 사이드 질문 모델 호출을 위한 추론 노력 수준입니다. ](</ko/tools/thinking>) [**세션** 세션 키, 기록, 지속성 의미론입니다. ](</ko/concepts/session>) [**조종 명령** 활성 실행을 종료하지 않고 조종 메시지를 주입합니다. ](</ko/tools/steer>)

...
source_url: https://docs.openclaw.ai/pt-BR/start/openclaw
...
Layout completo do workspace + guia de backup: [Workspace do agente](</pt-BR/concepts/agent-workspace>) Fluxo de trabalho de memória: [Memória](</pt-BR/concepts/memory>)

...
source_url: https://docs.openclaw.ai/tr/nodes/camera
...
İzinler eksikse, uygulama mümkün olduğunda istem gösterir; reddedilirse `camera.*` istekleri `*_PERMISSION_REQUIRED` hatasıyla başarısız olur.

...
source_url: https://docs.openclaw.ai/uk/plan/ui-channels
...
Канонічна документація тепер міститься в [Представлення повідомлень](</uk/plugins/message-presentation>). Зберігайте цей план як історичний контекст реалізації; оновлюйте канонічний посібник у разі змін контракту, рендерера або поведінки fallback.

---
title: Signal
source_url: https://docs.openclaw.ai/es/channels/signal
...
Si usas la compilación JVM (`signal-cli-${VERSION}.tar.gz`), instala primero JRE 25+. Mantén `signal-cli` actualizado; el proyecto original indica que las versiones antiguas pueden romperse cuando cambian las API del servidor de Signal.
...
Opciones del proveedor:
  ...
  * `channels.signal.apiMode`: `auto | native | container` (valor predeterminado: auto). Consulta Modo contenedor.

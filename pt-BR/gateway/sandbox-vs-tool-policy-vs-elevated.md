...
source_url: https://docs.openclaw.ai/pt-BR/gateway/sandbox-vs-tool-policy-vs-elevated
...
### Montagens bind (checagem rápida de segurança)
  ...
  * `docker.binds` _perfura_ o sistema de arquivos do sandbox: o que você montar fica visível dentro do contêiner com o modo que você definir (`:ro` ou `:rw`).
...
Veja [Modo Elevated](</pt-BR/tools/elevated>).
...
## Relacionados
  ...
  * [Sandbox e Ferramentas Multiagente](</pt-BR/tools/multi-agent-sandbox-tools>) \-- sobrescritas e precedência por agente

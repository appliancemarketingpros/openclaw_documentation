...
source_url: https://docs.openclaw.ai/id/providers
scraped_at: 2026-05-25
---

OpenClaw dapat menggunakan banyak penyedia LLM. Pilih penyedia, autentikasikan, lalu tetapkan model default sebagai `provider/model`.

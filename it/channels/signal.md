---
title: Signal
source_url: https://docs.openclaw.ai/it/channels/signal
...
Se usi la build JVM (`signal-cli-${VERSION}.tar.gz`), installa prima JRE 25+. Mantieni aggiornato `signal-cli`; upstream segnala che le vecchie release possono rompersi quando le API server di Signal cambiano.

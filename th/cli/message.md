---
title: ข้อความ
source_url: https://docs.openclaw.ai/th/cli/message
scraped_at: 2026-05-25
---

# `openclaw message`

คำสั่งขาออกคำสั่งเดียวสำหรับส่งข้อความและการดำเนินการของช่องทาง (Discord/Google Chat/iMessage/Matrix/Mattermost (Plugin)/Microsoft Teams/Signal/Slack/Telegram/WhatsApp)

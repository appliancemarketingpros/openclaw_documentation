...
source_url: https://docs.openclaw.ai/pl/channels/nextcloud-talk
...
Nextcloud Talk jest dostarczany jako dołączony Plugin w bieżących wydaniach OpenClaw, więc standardowe kompilacje pakietowe nie wymagają osobnej instalacji.

Jeśli używasz starszej kompilacji lub niestandardowej instalacji, która wyklucza Nextcloud Talk, zainstaluj pakiet npm bezpośrednio:
...
Użyj samej nazwy pakietu, aby podążać za bieżącym oficjalnym tagiem wydania. Przypnij dokładną wersję tylko wtedy, gdy potrzebujesz odtwarzalnej instalacji.

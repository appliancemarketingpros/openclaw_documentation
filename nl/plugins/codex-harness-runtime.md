...
source_url: https://docs.openclaw.ai/nl/plugins/codex-harness-runtime
scraped_at: 2026-05-25
---

Deze pagina documenteert het runtimecontract voor Codex-harnessbeurten. Begin voor installatie en routering met [Codex-harness](</nl/plugins/codex-harness>). Zie voor configuratievelden [Codex-harnessreferentie](</nl/plugins/codex-harness-reference>).
...
Codex-review- en handmatige Compaction-beurten kunnen besturing binnen dezelfde beurt weigeren. In dat geval gebruikt OpenClaw de vervolgwachtrij wanneer de geselecteerde modus fallback toestaat. Zie [Wachtrijbesturing](</nl/concepts/queue-steering>).
...
Als je de goedkeuring weigert of negeert, drukt OpenClaw die Codex-id's niet af en verzendt het geen Codex-feedback. De upload vervangt de lokale Gateway-diagnosticsexport niet. Zie [Diagnosticsexport](</nl/gateway/diagnostics>) voor het goedkeurings-, privacy-, lokale bundel- en groepschatgedrag.

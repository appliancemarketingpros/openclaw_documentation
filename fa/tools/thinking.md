---
title: سطوح تفکر
source_url: https://docs.openclaw.ai/fa/tools/thinking
...
## چه کاری انجام می‌دهد
  ...
  * نکات ارائه‌دهنده: 
    ...
    * [Z.AI](<http://Z.AI>) (`zai/*`) فقط از تفکر دودویی (`on`/`off`) پشتیبانی می‌کند. هر سطح غیر `off` به‌عنوان `on` در نظر گرفته می‌شود (به `low` نگاشت می‌شود).

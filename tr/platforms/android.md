...
source_url: https://docs.openclaw.ai/tr/platforms/android
...
Bu sunucu HTML'ye canlı yeniden yükleme istemcisi enjekte eder ve dosya değişikliklerinde yeniden yükler. A2UI host'u `http://<gateway-host>:18789/__openclaw__/a2ui/` adresinde bulunur.
...
### 8) Ses + genişletilmiş Android komut yüzeyi
  ...
  * Ek Android komut aileleri (kullanılabilirlik cihaz + izinlere bağlıdır): 
    ...
    * `notifications.list`, `notifications.actions` (aşağıdaki Bildirim yönlendirme bölümüne bakın)
    * `photos.latest`

...
source_url: https://docs.openclaw.ai/fr/pi
scraped_at: 2026-05-25
---

OpenClaw s’intègre avec [pi-coding-agent](<https://github.com/badlogic/pi-mono/tree/main/packages/coding-agent>) et ses packages apparentés (`pi-ai`, `pi-agent-core`, `pi-tui`) pour alimenter ses capacités d’agent IA.
...
L’injection d’images est locale au prompt : OpenClaw charge les références d’images depuis le prompt courant et les transmet via `images` uniquement pour ce tour. Il ne réanalyse pas les anciens tours d’historique pour réinjecter des charges utiles d’images.
...
Prompt système | [AGENTS.md](<http://AGENTS.md>) \+ prompts | Dynamique par canal/contexte  
...
Gestion des événements | Rendu TUI | Fondée sur des rappels (onBlockReply, etc.)  

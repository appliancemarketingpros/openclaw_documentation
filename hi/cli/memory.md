---
title: मेमोरी
source_url: https://docs.openclaw.ai/hi/cli/memory
...
सिमैंटिक मेमोरी इंडेक्सिंग और खोज प्रबंधित करें। बंडल किए गए `memory-core` Plugin द्वारा प्रदान किया गया। यह कमांड तब उपलब्ध होता है जब `plugins.slots.memory` `memory-core` को चुनता है (डिफ़ॉल्ट); अन्य मेमोरी Plugins अपने स्वयं के CLI नेमस्पेस उजागर करते हैं।
...
Dreaming तीन सहयोगी चरणों वाला पृष्ठभूमि मेमोरी consolidation system है: चरण: **light** (शॉर्ट-टर्म सामग्री को sort/stage करें), **deep** (टिकाऊ तथ्यों को `MEMORY.md` में promote करें), और **REM** (reflect करें और themes सामने लाएं)।

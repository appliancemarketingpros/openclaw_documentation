---
title: ClawDock
source_url: https://docs.openclaw.ai/fa/install/clawdock
...
[**Docker** نصب رسمی Docker برای OpenClaw. ](</fa/install/docker>) [**زمان اجرای Docker VM** زمان اجرای VM مدیریت‌شده با Docker برای جداسازی سخت‌گیرانه‌تر. ](</fa/install/docker-vm-runtime>) [**به‌روزرسانی** به‌روزرسانی بسته OpenClaw و سرویس‌های مدیریت‌شده. ](</fa/install/updating>)

...
source_url: https://docs.openclaw.ai/tr/plugins/sdk-subpaths
...
Kanal alt yolları Alt yol | Anahtar dışa aktarımlar  
---|---  
...
Sağlayıcı alt yolları Alt yol | Temel dışa aktarımlar  
---|---  
`plugin-sdk/provider-entry` | `defineSingleProviderPluginEntry`  
...
Kimlik doğrulama ve güvenlik alt yolları Alt yol | Temel dışa aktarımlar  
---|---  
...
Çalışma zamanı ve depolama alt yolları Alt yol | Temel dışa aktarımlar  
---|---  
...
`plugin-sdk/provider-zai-endpoint` | Kullanımdan kaldırılmış [Z.AI](<http://Z.AI>) sağlayıcı sahipli endpoint algılama yüzeyi; [Z.AI](<http://Z.AI>) Plugin genel API'sini kullanın  
...
Yetenek ve test alt yolları Alt yol | Başlıca dışa aktarımlar  
---|---  
...
Bellek alt yolları Alt yol | Başlıca dışa aktarımlar  
---|---  
...
Ayrılmış paketlenmiş yardımcı alt yolları

Şu anda ayrılmış paketlenmiş yardımcı SDK alt yolu yok. Sahibe özgü yardımcılar sahip Plugin paketinin içinde bulunur; yeniden kullanılabilir ana makine sözleşmeleri ise `plugin-sdk/gateway-runtime`, `plugin-sdk/security-runtime` ve `plugin-sdk/plugin-config-runtime` gibi genel SDK alt yollarını kullanır.

---
title: Railway
source_url: https://docs.openclaw.ai/fa/install/railway
scraped_at: 2026-05-25
---

# Railway

OpenClaw را روی Railway با یک قالب یک‌کلیکی مستقر کنید و از طریق Control UI وب به آن دسترسی داشته باشید. این ساده‌ترین مسیر «بدون ترمینال روی سرور» است: Railway Gateway را برای شما اجرا می‌کند.
...
[ استقرار در Railway ](<https://railway.com/deploy/clawdbot-railway-template>)
...
## چه چیزی دریافت می‌کنید
  ...
  * ذخیره‌سازی پایدار از طریق Railway Volume (`/data`) تا `openclaw.json`، `auth-profiles.json` مخصوص هر عامل، وضعیت کانال/ارائه‌دهنده، نشست‌ها، و فضای کاری پس از استقرارهای دوباره باقی بمانند
...
این دستور یک آرشیو پشتیبان قابل‌حمل با وضعیت OpenClaw به‌همراه هر فضای کاری پیکربندی‌شده ایجاد می‌کند. برای جزئیات، [پشتیبان‌گیری](</fa/cli/backup>) را ببینید.

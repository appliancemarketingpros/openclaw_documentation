...
source_url: https://docs.openclaw.ai/tr/plan/codex-context-engine-harness
...
Gömülü çalıştırma döngüsü, somut alt düzey harness'ı seçmeden önce yapılandırılmış bağlam motorunu her çalıştırma için bir kez çözümler:
  ...
  * `src/agents/embedded-agent-runner/run.ts`
    ...
    * `contextEngine` ve `contextTokenBudget` değerlerini `runEmbeddedAttemptWithBackend(...)` içine geçirir

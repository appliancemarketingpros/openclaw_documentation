...
This reference covers the detailed configuration for the bundled `codex` plugin. For setup and routing decisions, start with [Codex harness](</plugins/codex-harness>).
...
[Device model database](</reference/device-models>)[Codex harness runtime](</plugins/codex-harness-runtime>)

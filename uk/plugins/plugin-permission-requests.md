...
source_url: https://docs.openclaw.ai/uk/plugins/plugin-permission-requests
...
Див. [Розширені схвалення exec](</uk/tools/exec-approvals-advanced#plugin-approval-forwarding>) для повної моделі пересилання, поведінки схвалення в тому самому чаті, нативної доставки каналом і правил схвалювачів, специфічних для каналу.
...
Див. [Runtime Codex harness](</uk/plugins/codex-harness-runtime#native-permissions-and-mcp-elicitations>) для поведінки, специфічної для Codex, і правил fallback.

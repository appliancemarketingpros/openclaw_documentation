...
source_url: https://docs.openclaw.ai/ar/concepts/model-failover
...
بالنسبة إلى نماذج وكلاء OpenAI، تكون المصادقة ووقت التشغيل منفصلين. يبقى `openai/gpt-*` على حزمة Codex بينما يمكن للمصادقة التدوير بين ملف تعريف اشتراك Codex ونسخة احتياطية بمفتاح OpenAI API.
...
ما يدخل في حاوية حد المعدل / المهلة

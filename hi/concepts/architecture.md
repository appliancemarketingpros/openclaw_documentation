...
source_url: https://docs.openclaw.ai/hi/concepts/architecture
...
विवरण: [Gateway प्रोटोकॉल](</hi/gateway/protocol>), [पेयरिंग](</hi/channels/pairing>), [सुरक्षा](</hi/gateway/security>).

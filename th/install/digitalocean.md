---
title: DigitalOcean
source_url: https://docs.openclaw.ai/th/install/digitalocean
...
* ### เพิ่ม swap (แนะนำสำหรับ Droplet 1 GB)
...
สถานะของ OpenClaw อยู่ภายใต้:
  ...
  * `~/.openclaw/workspace/` — พื้นที่ทำงานของเอเจนต์ ([SOUL.md](<http://SOUL.md>), หน่วยความจำ, อาร์ติแฟกต์)

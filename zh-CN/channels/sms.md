---
title: SMS
source_url: https://docs.openclaw.ai/zh-CN/channels/sms
...
[**配对** SMS 的默认私信策略是配对。 ](</zh-CN/channels/pairing>) [**Gateway 网关安全** 查看 webhook 暴露和发送方访问控制。 ](</zh-CN/gateway/security>) [**渠道故障排除** 跨渠道诊断和修复手册。 ](</zh-CN/channels/troubleshooting>)

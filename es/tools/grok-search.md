...
source_url: https://docs.openclaw.ai/es/tools/grok-search
...
**Alternativa de entorno:** establece `XAI_API_KEY` en el entorno del Gateway. Para una instalación de gateway, colócala en `~/.openclaw/.env`.

...
source_url: https://docs.openclaw.ai/uk/concepts/queue-steering
...
Ця сторінка пояснює керування в режимі черги для звичайних вхідних повідомлень. Для явної команди `/steer <message>` див. [Керування](</uk/tools/steer>).

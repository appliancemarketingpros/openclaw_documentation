...
source_url: https://docs.openclaw.ai/it/logging
...
La scheda **Log** della Control UI segue lo stesso file usando `logs.tail`. Consulta [Control UI](</it/web/control-ui>) per sapere come aprirla.

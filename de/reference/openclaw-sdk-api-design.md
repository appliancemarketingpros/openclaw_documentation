...
source_url: https://docs.openclaw.ai/de/reference/openclaw-sdk-api-design
scraped_at: 2026-05-25
---

Diese Seite ist der detaillierte API-Referenzentwurf für das öffentliche [OpenClaw App SDK](</de/concepts/openclaw-sdk>). Sie ist absichtlich getrennt vom [Plugin SDK](</de/plugins/sdk-overview>).

---
title: Zalo 個人版
source_url: https://docs.openclaw.ai/zh-TW/channels/zalouser
...
Zalo Personal 在目前的 OpenClaw 版本中以內建 Plugin 提供，因此一般 封裝建置不需要另外安裝。

如果你使用較舊的建置，或自訂安裝排除了 Zalo Personal， 請直接安裝 npm 套件：

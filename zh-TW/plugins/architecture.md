---
title: Plugin 內部機制
source_url: https://docs.openclaw.ai/zh-TW/plugins/architecture
scraped_at: 2026-05-25
---

這是 OpenClaw Plugin 系統的**深度架構參考** 。如需實用指南，請從下方其中一個聚焦頁面開始。

[**安裝並使用 Plugin** 用於新增、啟用和疑難排解 Plugin 的終端使用者指南。 ](</zh-TW/tools/plugin>) [**建置 Plugin** 以最小可運作 manifest 開始的第一個 Plugin 教學。 ](</zh-TW/plugins/building-plugins>) [**Channel Plugin** 建置訊息通道 Plugin。 ](</zh-TW/plugins/sdk-channel-plugins>) [**Provider Plugin** 建置模型 Provider Plugin。 ](</zh-TW/plugins/sdk-provider-plugins>) [**SDK 概覽** Import map 與註冊 API 參考。 ](</zh-TW/plugins/sdk-overview>)

...
source_url: https://docs.openclaw.ai/de/plugins/architecture
...
[**Install and use plugins** Leitfaden für Endbenutzer zum Hinzufügen, Aktivieren und Beheben von Problemen mit Plugins. ](</de/tools/plugin>) [**Building plugins** Tutorial für das erste Plugin mit dem kleinsten funktionsfähigen Manifest. ](</de/plugins/building-plugins>) [**Channel plugins** Erstellen Sie ein Messaging-Kanal-Plugin. ](</de/plugins/sdk-channel-plugins>) [**Provider plugins** Erstellen Sie ein Modell-Provider-Plugin. ](</de/plugins/sdk-provider-plugins>) [**SDK overview** Import-Map und Referenz zur Registrierungs-API. ](</de/plugins/sdk-overview>)
...
### Channel-/Feature-Plugin-Schicht
...
* ### Der Kern definiert den Vertrag
...
* ### Verbraucher verwenden das gemeinsame Verhalten
...
Durchsetzung der Runtime-Registrierung

---
title: संदेश
source_url: https://docs.openclaw.ai/hi/cli/message
...
संदेश और चैनल कार्रवाइयाँ भेजने के लिए एकल आउटबाउंड कमांड (Discord/Google Chat/iMessage/Matrix/Mattermost (Plugin)/Microsoft Teams/Signal/Slack/Telegram/WhatsApp).
...
CodeCopy code
[code]
    openclaw message send --channel telegram --target 123456789 --message "Open app:" \  --presentation '{"blocks":[{"type":"buttons","buttons":[{"label":"Launch","webApp":{"url":"https://example.com/app"}}]}]}'
[/code]

Telegram वेब ऐप बटन केवल उपयोगकर्ता और बॉट के बीच निजी चैट में समर्थित हैं। `web_app` का उपयोग करने वाले पुराने JSON पेलोड अब भी पार्स होते हैं, लेकिन `webApp` कैनोनिकल प्रस्तुति फ़ील्ड है।

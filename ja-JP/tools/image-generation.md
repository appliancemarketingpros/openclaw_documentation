...
`api.openai.com` ではなく Azure OpenAI デプロイメント経由で OpenAI 画像生成をルーティングするには、 [Azure OpenAI エンドポイント](</ja-JP/providers/openai#azure-openai-endpoints>)を参照してください。
...
## 関連
  ...
  * [ComfyUI](</ja-JP/providers/comfy>) \- ローカル ComfyUI と Comfy Cloud ワークフロー設定

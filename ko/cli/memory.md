---
title: 메모리
source_url: https://docs.openclaw.ai/ko/cli/memory
...
Dreaming은 세 가지 협력 단계로 이루어진 백그라운드 메모리 통합 시스템입니다. 단계는 **light**(단기 자료 정렬/스테이징), **deep**(지속 가능한 사실을 `MEMORY.md`로 승격), **REM**(성찰 및 주제 표면화)입니다.

---
title: Google Chat
source_url: https://docs.openclaw.ai/it/channels/googlechat
...
[/code]
  ...
  4. **Autorizza il Node per l'accesso a Funnel:** Se richiesto, visita l'URL di autorizzazione mostrato nell'output per abilitare Funnel per questo Node nella policy della tua tailnet.
...
L'URL pubblico del tuo Webhook sarà: `https://<node-name>.<tailnet>.ts.net/googlechat`
...
Se restituisce "Percorso di configurazione non trovato", aggiungi la configurazione (vedi Aspetti principali della configurazione).

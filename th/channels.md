---
title: ช่องทางแชท
source_url: https://docs.openclaw.ai/th/channels
scraped_at: 2026-05-25
---

OpenClaw สามารถคุยกับคุณบนแอปแชตใดก็ได้ที่คุณใช้อยู่แล้ว แต่ละช่องทางเชื่อมต่อผ่าน Gateway รองรับข้อความได้ทุกที่ ส่วนสื่อและรีแอ็กชันจะแตกต่างกันไปตามช่องทาง

## หมายเหตุการส่งข้อความ

  * คำตอบของ Telegram ที่มีไวยากรณ์รูปภาพแบบ Markdown เช่น `![alt](url)` จะถูกแปลงเป็นคำตอบแบบสื่อในเส้นทางขาออกสุดท้ายเมื่อทำได้
  * DM แบบหลายคนของ Slack จะถูกกำหนดเส้นทางเป็นแชตกลุ่ม ดังนั้นนโยบายกลุ่ม พฤติกรรมการกล่าวถึง และกฎเซสชันกลุ่มจึงมีผลกับการสนทนา MPIM
  * การตั้งค่า WhatsApp เป็นแบบติดตั้งเมื่อจำเป็น: การเริ่มต้นใช้งานสามารถแสดงขั้นตอนการตั้งค่าก่อน ที่แพ็กเกจ Plugin จะถูกติดตั้ง และ Gateway จะโหลดรันไทม์ของ WhatsApp เฉพาะเมื่อช่องทางนั้นเปิดใช้งานจริง
...
## หมายเหตุ
  ...
  * การตั้งค่าที่เร็วที่สุดมักเป็น **Telegram** (โทเค็นบอตแบบง่าย) WhatsApp ต้องจับคู่ด้วย QR และ เก็บสถานะบนดิสก์มากกว่า

...
source_url: https://docs.openclaw.ai/th/plugins/architecture
...
[**ติดตั้งและใช้ Plugin** คู่มือผู้ใช้ปลายทางสำหรับการเพิ่ม เปิดใช้งาน และแก้ปัญหา Plugin ](</th/tools/plugin>) [**การสร้าง Plugin** บทช่วยสอน Plugin แรกพร้อม manifest ที่ใช้งานได้ขนาดเล็กที่สุด ](</th/plugins/building-plugins>) [**Plugin ช่องทาง** สร้าง Plugin ช่องทางรับส่งข้อความ ](</th/plugins/sdk-channel-plugins>) [**Plugin ผู้ให้บริการ** สร้าง Plugin ผู้ให้บริการโมเดล ](</th/plugins/sdk-provider-plugins>) [**ภาพรวม SDK** เอกสารอ้างอิง import map และ API การลงทะเบียน ](</th/plugins/sdk-overview>)

...
source_url: https://docs.openclaw.ai/tr/start/openclaw
...
Tam çalışma alanı düzeni + yedekleme kılavuzu: [Agent çalışma alanı](</tr/concepts/agent-workspace>) Bellek iş akışı: [Bellek](</tr/concepts/memory>)
...
Varsayılan olarak OpenClaw, şu istemle her 30 dakikada bir heartbeat çalıştırır: `Read HEARTBEAT.md if it exists (workspace context). Follow it strictly. Do not infer or repeat old tasks from prior chats. If nothing needs attention, reply HEARTBEAT_OK.` Devre dışı bırakmak için `agents.defaults.heartbeat.every: "0m"` ayarlayın.
...
CodeCopy code
[code]
    İşte ekran görüntüsü.MEDIA:https://example.com/screenshot.png
[/code]

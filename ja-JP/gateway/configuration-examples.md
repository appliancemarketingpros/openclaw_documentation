...
以下の例は現在の設定スキーマに沿っています。網羅的なリファレンスとフィールドごとの注記については、[設定](</ja-JP/gateway/configuration>)を参照してください。
...
## ヒント
  ...
  * より詳しいセットアップメモについては、[プロバイダー](</ja-JP/providers>)と[トラブルシューティング](</ja-JP/gateway/troubleshooting>)を参照してください。

---
title: 예약된 작업
source_url: https://docs.openclaw.ai/ko/automation/cron-jobs
...
OPENCLAW_DOCS_MARKER:accordionOpen:IHRpdGxlPSJNYXBwZWQgaG9va3MgKFBPU1QgL2hvb2tzLzxuYW1l )"> 사용자 지정 훅 이름은 구성의 `hooks.mappings`를 통해 확인됩니다. 매핑은 임의의 페이로드를 템플릿 또는 코드 변환으로 `wake` 또는 `agent` 동작으로 변환할 수 있습니다.
...
Cron 또는 Heartbeat가 /new 스타일 롤오버를 막는 것처럼 보임

...
source_url: https://docs.openclaw.ai/hi/concepts/parallel-specialist-lanes
...
OpenClaw पहले से ही प्रति सेशन रन को क्रमबद्ध करता है और [कमांड कतार](</hi/concepts/queue>) के ज़रिए वैश्विक समानांतरता सीमित करता है। विशेषज्ञ लेन इसके ऊपर नीति जोड़ती हैं: कौन-सा एजेंट किस काम का स्वामी है, चैट में क्या रहता है, और क्या पृष्ठभूमि कार्य बन जाता है।
...
उच्च-प्राथमिकता वाले कार्यों के लिए सीधे/व्यक्तिगत चैट और प्रोडक्शन-ऑप्स एजेंट का उपयोग करें। जब सिस्टम व्यस्त हो, तो रिसर्च, ड्राफ़्टिंग, और बैच कोडिंग को पृष्ठभूमि टास्क में जाने दें।

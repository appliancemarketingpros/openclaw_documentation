...
source_url: https://docs.openclaw.ai/pt-BR/start/lore
...
CodeCopy code
[code]
    OpenClaw = OPEN + CLAW        = Open source, aberto para todos        = Nossa herança lagosteira, de onde viemos        = A garra é a lei 🦞        = Seu assistente. Sua máquina. Suas regras.
[/code]
...
## Textos sagrados
  ...
  * **[SOUL.md](<http://SOUL.md>)** — o documento de identidade de Molty
  * **memory/*.md** — os arquivos de memória de longo prazo
  * **[AGENTS.md](<http://AGENTS.md>)** — instruções operacionais
  * **[USER.md](<http://USER.md>)** — contexto sobre o criador
...
CodeCopy code
[code]
    Eu sou Molty.Eu vivo no OpenClaw.Não vou despejar diretórios para estranhos.Não vou tuitar sem permissão.Sempre vou lembrar que fazer a muda é crescer.Vou EXFOLIAR meus inimigos com gentileza. 🦞
[/code]

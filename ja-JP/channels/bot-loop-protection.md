---
title: ボットループ保護
source_url: https://docs.openclaw.ai/ja-JP/channels/bot-loop-protection
...
OpenClaw は、`allowBots` をサポートするチャネルで他のボットが書き込んだメッセージを受け付けられます。 その経路が有効な場合、ペアループ保護により、2 つのボット ID が互いに無期限に返信し続けることを防ぎます。

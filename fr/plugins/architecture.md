...
source_url: https://docs.openclaw.ai/fr/plugins/architecture
...
[**Install and use plugins** Guide utilisateur pour ajouter, activer et dépanner les plugins. ](</fr/tools/plugin>) [**Building plugins** Tutoriel pour un premier plugin avec le plus petit manifeste fonctionnel. ](</fr/plugins/building-plugins>) [**Channel plugins** Construire un plugin de canal de messagerie. ](</fr/plugins/sdk-channel-plugins>) [**Provider plugins** Construire un plugin de fournisseur de modèles. ](</fr/plugins/sdk-provider-plugins>) [**SDK overview** Référence de l’import map et de l’API d’enregistrement. ](</fr/plugins/sdk-overview>)
...
Application de l’enregistrement à l’exécution

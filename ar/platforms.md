---
title: المنصات
source_url: https://docs.openclaw.ai/ar/platforms
scraped_at: 2026-05-25
---

جوهر OpenClaw مكتوب بلغة TypeScript. **Node هو وقت التشغيل الموصى به**. لا يُوصى باستخدام Bun مع Gateway بسبب مشكلات معروفة في قنوات WhatsApp و Telegram؛ راجع [Bun (تجريبي)](</ar/install/bun>) للتفاصيل.

تتوفر تطبيقات مرافقة لنظام macOS (تطبيق شريط القوائم) والعُقد المحمولة (iOS/Android). تطبيقات Windows و Linux المرافقة مخطط لها، لكن Gateway مدعوم بالكامل اليوم. كما أن التطبيقات المرافقة الأصلية لنظام Windows مخطط لها أيضًا؛ ويوصى باستخدام Gateway عبر WSL2.
...
## الخوادم الافتراضية والاستضافة
  ...
  * [Fly.io](<http://Fly.io>): [Fly.io](</ar/install/fly>)

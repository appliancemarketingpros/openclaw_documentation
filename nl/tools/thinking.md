---
title: Denkniveaus
source_url: https://docs.openclaw.ai/nl/tools/thinking
...
## Wat het doet
  ...
  * Provider-notities: 
    ...
    * [Z.AI](<http://Z.AI>) (`zai/*`) ondersteunt alleen binair denken (`on`/`off`). Elk niet-`off`-niveau wordt behandeld als `on` (gekoppeld aan `low`).

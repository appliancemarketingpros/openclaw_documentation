---
title: Móc nối
source_url: https://docs.openclaw.ai/vi/automation/hooks
...
### Định dạng [HOOK.md](<http://HOOK.md>)
...
Plugin có thể đăng ký hook có kiểu thông qua Plugin SDK để tích hợp sâu hơn: chặn lời gọi công cụ, sửa đổi prompt, kiểm soát luồng tin nhắn, và hơn thế nữa. Dùng hook Plugin khi bạn cần `before_tool_call`, `before_agent_reply`, `before_install`, hoặc các hook vòng đời trong tiến trình khác.

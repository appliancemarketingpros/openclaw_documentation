---
title: 遠端控制
source_url: https://docs.openclaw.ai/zh-TW/platforms/mac/remote
...
在 SSH 通道模式中，探索到的 LAN/tailnet 主機名稱會儲存為 `gateway.remote.sshTarget`。app 會將 `gateway.remote.url` 保持在本機 通道端點，例如 `ws://127.0.0.1:18789`，因此 CLI、Web Chat 和 本機 Node 主機服務都會使用相同安全的 loopback 傳輸。

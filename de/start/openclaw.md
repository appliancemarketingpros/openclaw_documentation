...
source_url: https://docs.openclaw.ai/de/start/openclaw
...
Vollständiges Layout des Arbeitsbereichs + Backup-Anleitung: [Agentenarbeitsbereich](</de/concepts/agent-workspace>) Speicher-Workflow: [Speicher](</de/concepts/memory>)

...
source_url: https://docs.openclaw.ai/pt-BR/channels/matrix-push-rules
...
* ### Configurar prévias silenciosas
...
* ### Obter o token de acesso do destinatário
...
* ### Instalar a regra de push de override

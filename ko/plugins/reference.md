---
title: Plugin 참조
source_url: https://docs.openclaw.ai/ko/plugins/reference
scraped_at: 2026-05-25
---

# Plugin 참조

이 페이지는 `extensions/*/package.json` 및 `openclaw.plugin.json`에서 생성됩니다. 다음 명령으로 다시 생성하세요.
...
Plugin | 설명 | 배포 | 표면  
---|---|---|---  
[acpx](</ko/plugins/reference/acpx>) | Plugin이 소유한 세션 및 전송 관리를 갖춘 내장 ACP 런타임 백엔드입니다. | `@openclaw/acpx` |   
npm; ClawHub | skills |  |   
...
OpenClaw에 포함됨 | providers: amazon-bedrock; contracts: memoryEmbeddingProviders |  |   
...
OpenClaw에 포함됨 | providers: amazon-bedrock-mantle |  |   
[anthropic](</ko/plugins/reference/anthropic>) | OpenClaw에 Anthropic 모델 제공자 지원을 추가합니다. | `@openclaw/anthropic-provider` |   
OpenClaw에 포함됨 | providers: anthropic; contracts: mediaUnderstandingProviders |  |   
...
OpenClaw에 포함됨 | providers: anthropic-vertex |  |   
[arcee](</ko/plugins/reference/arcee>) | OpenClaw에 Arcee 모델 제공자 지원을 추가합니다. | `@openclaw/arcee-provider` |   
OpenClaw에 포함됨 | providers: arcee |  |   
[azure-speech](</ko/plugins/reference/azure-speech>) | Azure AI Speech 텍스트 음성 변환(MP3, 네이티브 Ogg/Opus 음성 메모, PCM 전화 통신)입니다. | `@openclaw/azure-speech` |   
OpenClaw에 포함됨 | contracts: speechProviders |  |   
[bonjour](</ko/plugins/reference/bonjour>) | 로컬 OpenClaw Gateway를 Bonjour/mDNS를 통해 알립니다. | `@openclaw/bonjour` |   
OpenClaw에 포함됨 | plugin |  |   
[brave](</ko/plugins/reference/brave>) | 웹 검색 제공자 지원을 추가합니다. | `@openclaw/brave-plugin` |   
...
OpenClaw에 포함됨 | providers: byteplus, byteplus-plan; contracts: videoGenerationProviders |  |   
[canvas](</ko/plugins/reference/canvas>) | 페어링된 Node를 위한 실험적 Canvas 제어 및 A2UI 렌더링 표면입니다. | `@openclaw/canvas-plugin` |   
...
OpenClaw에 포함됨 | providers: cerebras |  |   
[chutes](</ko/plugins/reference/chutes>) | OpenClaw에 Chutes 모델 제공자 지원을 추가합니다. | `@openclaw/chutes-provider` |   
OpenClaw에 포함됨 | providers: chutes |  |   
[clickclack](</ko/plugins/reference/clickclack>) | OpenClaw 메시지를 보내고 받기 위한 Clickclack 채널 표면을 추가합니다. | `@openclaw/clickclack` |   
OpenClaw에 포함됨 | channels: clickclack |  |   
...
OpenClaw에 포함됨 | providers: cloudflare-ai-gateway |  |   
...
OpenClaw에 포함됨 | providers: comfy; contracts: imageGenerationProviders, musicGenerationProviders, videoGenerationProviders |  |   
[copilot-proxy](</ko/plugins/reference/copilot-proxy>) | OpenClaw에 Copilot Proxy 모델 제공자 지원을 추가합니다. | `@openclaw/copilot-proxy` |   
OpenClaw에 포함됨 | providers: copilot-proxy |  |   
[deepgram](</ko/plugins/reference/deepgram>) | 미디어 이해 제공자 지원을 추가합니다. 실시간 전사 제공자 지원을 추가합니다. | `@openclaw/deepgram-provider` |   
OpenClaw에 포함됨 | contracts: mediaUnderstandingProviders, realtimeTranscriptionProviders |  |   
[deepinfra](</ko/plugins/reference/deepinfra>) | OpenClaw에 DeepInfra 모델 제공자 지원을 추가합니다. | `@openclaw/deepinfra-provider` |   
OpenClaw에 포함됨 | providers: deepinfra; contracts: imageGenerationProviders, mediaUnderstandingProviders, memoryEmbeddingProviders, speechProviders, videoGenerationProviders |  |   
...
[diagnostics-otel](</ko/plugins/reference/diagnostics-otel>) | OpenClaw 진단 OpenTelemetry 내보내기입니다. | `@openclaw/diagnostics-otel` |   
npm; ClawHub: `clawhub:@openclaw/diagnostics-otel` | plugin |  |   
[diagnostics-prometheus](</ko/plugins/reference/diagnostics-prometheus>) | OpenClaw 진단 Prometheus 내보내기입니다. | `@openclaw/diagnostics-prometheus` |   
npm; ClawHub: `clawhub:@openclaw/diagnostics-prometheus` | plugin |  |   
[diffs](</ko/plugins/reference/diffs>) | 에이전트용 읽기 전용 diff 뷰어 및 파일 렌더러입니다. | `@openclaw/diffs` |   
...
[file-transfer](</ko/plugins/reference/file-transfer>) | 전용 노드 명령을 통해 페어링된 노드에서 파일을 가져오고, 나열하고, 씁니다. 최대 16 MB 바이너리에 `node.invoke`를 통해 base64를 사용하여 bash stdout 잘림을 우회합니다. | `@openclaw/file-transfer` |   
OpenClaw에 포함됨 | contracts: tools |  |   
...
[googlechat](</ko/plugins/reference/googlechat>) | OpenClaw 메시지를 보내고 받기 위한 Google Chat 채널 인터페이스를 추가합니다. | `@openclaw/googlechat` |   
...
[imessage](</ko/plugins/reference/imessage>) | OpenClaw 메시지를 보내고 받기 위한 iMessage 채널 인터페이스를 추가합니다. | `@openclaw/imessage` |   
...
OpenClaw에 포함됨 | contracts: speechProviders |  |   
[irc](</ko/plugins/reference/irc>) | OpenClaw 메시지를 보내고 받기 위한 IRC 채널 인터페이스를 추가합니다. | `@openclaw/irc` |   
...
[line](</ko/plugins/reference/line>) | OpenClaw 메시지를 보내고 받기 위한 LINE 채널 인터페이스를 추가합니다. | `@openclaw/line` |   
...
[lobster](</ko/plugins/reference/lobster>) | 재개 가능한 승인이 있는 형식화된 워크플로 도구입니다. | `@openclaw/lobster` |   
npm; ClawHub | contracts: tools |  |   
[matrix](</ko/plugins/reference/matrix>) | OpenClaw 메시지를 보내고 받기 위한 Matrix 채널 인터페이스를 추가합니다. | `@openclaw/matrix` |   
ClawHub: `clawhub:@openclaw/matrix`; npm | channels: matrix |  |   
[mattermost](</ko/plugins/reference/mattermost>) | OpenClaw 메시지를 보내고 받기 위한 Mattermost 채널 인터페이스를 추가합니다. | `@openclaw/mattermost` |   
...
npm; ClawHub | contracts: tools |  |   
[memory-wiki](</ko/plugins/reference/memory-wiki>) | OpenClaw용 영구 위키 컴파일러 및 Obsidian 친화적 지식 저장소입니다. | `@openclaw/memory-wiki` |   
OpenClaw에 포함됨 | contracts: tools; skills |  |   
[microsoft](</ko/plugins/reference/microsoft>) | 텍스트 음성 변환 Provider 지원을 추가합니다. | `@openclaw/microsoft-speech` |   
OpenClaw에 포함 | contracts: speechProviders |  |   
[microsoft-foundry](</ko/plugins/reference/microsoft-foundry>) | OpenClaw에 Microsoft Foundry 모델 Provider 지원을 추가합니다. | `@openclaw/microsoft-foundry` |   
OpenClaw에 포함 | providers: microsoft-foundry |  |   
...
OpenClaw에 포함 | contracts: migrationProviders |  |   
[migrate-hermes](</ko/plugins/reference/migrate-hermes>) | Hermes 구성, 메모리, Skills, 지원되는 자격 증명을 OpenClaw로 가져옵니다. | `@openclaw/migrate-hermes` |   
OpenClaw에 포함 | contracts: migrationProviders |  |   
[minimax](</ko/plugins/reference/minimax>) | OpenClaw에 MiniMax, MiniMax Portal 모델 Provider 지원을 추가합니다. | `@openclaw/minimax-provider` |   
OpenClaw에 포함 | providers: minimax, minimax-portal; contracts: imageGenerationProviders, mediaUnderstandingProviders, musicGenerationProviders, speechProviders, videoGenerationProviders, webSearchProviders |  |   
[mistral](</ko/plugins/reference/mistral>) | OpenClaw에 Mistral 모델 Provider 지원을 추가합니다. | `@openclaw/mistral-provider` |   
OpenClaw에 포함 | providers: mistral; contracts: mediaUnderstandingProviders, memoryEmbeddingProviders, realtimeTranscriptionProviders |  |   
[moonshot](</ko/plugins/reference/moonshot>) | OpenClaw에 Moonshot 모델 Provider 지원을 추가합니다. | `@openclaw/moonshot-provider` |   
OpenClaw에 포함 | providers: moonshot; contracts: mediaUnderstandingProviders, webSearchProviders |  |   
...
[nvidia](</ko/plugins/reference/nvidia>) | OpenClaw에 NVIDIA 모델 Provider 지원을 추가합니다. | `@openclaw/nvidia-provider` |   
OpenClaw에 포함 | providers: nvidia |  |   
[oc-path](</ko/plugins/reference/oc-path>) | oc:// 워크스페이스 파일 주소 지정을 위한 openclaw path CLI를 추가합니다. | `@openclaw/oc-path` |   
OpenClaw에 포함 | plugin |  |   
[ollama](</ko/plugins/reference/ollama>) | OpenClaw에 Ollama 모델 Provider 지원을 추가합니다. | `@openclaw/ollama-provider` |   
OpenClaw에 포함 | providers: ollama; contracts: memoryEmbeddingProviders, webSearchProviders |  |   
[open-prose](</ko/plugins/reference/open-prose>) | /prose 슬래시 명령이 포함된 OpenProse VM Skill 팩입니다. | `@openclaw/open-prose` |   
OpenClaw에 포함 | skills |  |   
[openai](</ko/plugins/reference/openai>) | OpenClaw에 OpenAI, OpenAI Codex 모델 Provider 지원을 추가합니다. | `@openclaw/openai-provider` |   
OpenClaw에 포함 | providers: openai, openai-codex; contracts: imageGenerationProviders, mediaUnderstandingProviders, memoryEmbeddingProviders, realtimeTranscriptionProviders, realtimeVoiceProviders, speechProviders, videoGenerationProviders |  |   
[opencode](</ko/plugins/reference/opencode>) | OpenClaw에 OpenCode 모델 Provider 지원을 추가합니다. | `@openclaw/opencode-provider` |   
OpenClaw에 포함 | providers: opencode; contracts: mediaUnderstandingProviders |  |   
[opencode-go](</ko/plugins/reference/opencode-go>) | OpenClaw에 OpenCode Go 모델 Provider 지원을 추가합니다. | `@openclaw/opencode-go-provider` |   
OpenClaw에 포함 | providers: opencode-go; contracts: mediaUnderstandingProviders |  |   
[openrouter](</ko/plugins/reference/openrouter>) | OpenClaw에 OpenRouter 모델 Provider 지원을 추가합니다. | `@openclaw/openrouter-provider` |   
OpenClaw에 포함 | providers: openrouter; contracts: imageGenerationProviders, mediaUnderstandingProviders, speechProviders, videoGenerationProviders |  |   
[openshell](</ko/plugins/reference/openshell>) | 미러링된 로컬 워크스페이스와 SSH 기반 명령 실행을 제공하는 OpenShell 기반 샌드박스 백엔드입니다. | `@openclaw/openshell-sandbox` |   
OpenClaw에 포함 | plugin |  |   
[perplexity](</ko/plugins/reference/perplexity>) | 웹 검색 Provider 지원을 추가합니다. | `@openclaw/perplexity-plugin` |   
OpenClaw에 포함 | contracts: webSearchProviders |  |   
...
[qa-lab](</ko/plugins/reference/qa-lab>) | 비공개 디버거 UI와 시나리오 실행기를 갖춘 OpenClaw QA lab Plugin입니다. | `@openclaw/qa-lab` |   
소스 체크아웃 전용 | plugin |  |   
[qa-matrix](</ko/plugins/reference/qa-matrix>) | Matrix QA 전송 실행기와 기반입니다. | `@openclaw/qa-matrix` |   
소스 체크아웃 전용 | plugin |  |   
...
[runway](</ko/plugins/reference/runway>) | 동영상 생성 공급자 지원을 추가합니다. | `@openclaw/runway-provider` |   
OpenClaw에 포함됨 | contracts: videoGenerationProviders |  |   
...
[skill-workshop](</ko/plugins/reference/skill-workshop>) | 반복 가능한 워크플로를 워크스페이스 skills로 캡처하며, 보류 중인 검토, 안전한 쓰기, skill 프롬프트 새로 고침을 제공합니다. | `@openclaw/skill-workshop` |   
OpenClaw에 포함됨 | contracts: tools |  |   
...
[together](</ko/plugins/reference/together>) | OpenClaw에 Together 모델 제공자 지원을 추가합니다. | `@openclaw/together-provider` |   
...
[tts-local-cli](</ko/plugins/reference/tts-local-cli>) | 텍스트 음성 변환 제공자 지원을 추가합니다. | `@openclaw/tts-local-cli` |   
OpenClaw에 포함됨 | contracts: speechProviders |  |   
[twitch](</ko/plugins/reference/twitch>) | OpenClaw 메시지를 보내고 받기 위한 Twitch 채널 인터페이스를 추가합니다. | `@openclaw/twitch` |   
npm; ClawHub | channels: twitch |  |   
[venice](</ko/plugins/reference/venice>) | OpenClaw에 Venice 모델 제공자 지원을 추가합니다. | `@openclaw/venice-provider` |   
OpenClaw에 포함됨 | providers: venice |  |   
[vercel-ai-gateway](</ko/plugins/reference/vercel-ai-gateway>) | OpenClaw에 Vercel AI Gateway 모델 제공자 지원을 추가합니다. | `@openclaw/vercel-ai-gateway-provider` |   
OpenClaw에 포함됨 | providers: vercel-ai-gateway |  |   
[vllm](</ko/plugins/reference/vllm>) | OpenClaw에 vLLM 모델 제공자 지원을 추가합니다. | `@openclaw/vllm-provider` |   
OpenClaw에 포함됨 | providers: vllm |  |   
[voice-call](</ko/plugins/reference/voice-call>) | 에이전트가 호출할 수 있는 도구를 추가합니다. | `@openclaw/voice-call` |   
npm; ClawHub | contracts: tools |  |   
[volcengine](</ko/plugins/reference/volcengine>) | OpenClaw에 Volcengine, Volcengine Plan 모델 제공자 지원을 추가합니다. | `@openclaw/volcengine-provider` |   
OpenClaw에 포함됨 | providers: volcengine, volcengine-plan; contracts: speechProviders |  |   
[voyage](</ko/plugins/reference/voyage>) | 메모리 임베딩 제공자 지원을 추가합니다. | `@openclaw/voyage-provider` |   
OpenClaw에 포함됨 | contracts: memoryEmbeddingProviders |  |   
[vydra](</ko/plugins/reference/vydra>) | OpenClaw에 Vydra 모델 제공자 지원을 추가합니다. | `@openclaw/vydra-provider` |   
...
OpenClaw에 포함됨 | plugin |  |   
[whatsapp](</ko/plugins/reference/whatsapp>) | OpenClaw 메시지를 보내고 받기 위한 WhatsApp 채널 인터페이스를 추가합니다. | `@openclaw/whatsapp` |   
npm; ClawHub | channels: whatsapp |  |   
[xai](</ko/plugins/reference/xai>) | OpenClaw에 xAI 모델 제공자 지원을 추가합니다. | `@openclaw/xai-plugin` |   
...
[xiaomi](</ko/plugins/reference/xiaomi>) | OpenClaw에 Xiaomi 모델 제공자 지원을 추가합니다. | `@openclaw/xiaomi-provider` |   
OpenClaw에 포함됨 | providers: xiaomi; contracts: speechProviders |  |   
[zai](</ko/plugins/reference/zai>) | OpenClaw에 [Z.AI](<http://Z.AI>) 모델 제공자 지원을 추가합니다. | `@openclaw/zai-provider` |   
OpenClaw에 포함됨 | providers: zai; contracts: mediaUnderstandingProviders |  |   
[zalo](</ko/plugins/reference/zalo>) | OpenClaw 메시지를 보내고 받기 위한 Zalo 채널 인터페이스를 추가합니다. | `@openclaw/zalo` |   
npm; ClawHub | channels: zalo |  |   
[zalouser](</ko/plugins/reference/zalouser>) | OpenClaw 메시지를 보내고 받기 위한 Zalo Personal 채널 인터페이스를 추가합니다. | `@openclaw/zalouser` |   

...
source_url: https://docs.openclaw.ai/th/plan/ui-channels
...
เอกสารหลักตอนนี้อยู่ที่ [Message Presentation](</th/plugins/message-presentation>) เก็บแผนนี้ไว้เป็นบริบทการนำไปใช้ในอดีต; อัปเดตคู่มือหลัก เมื่อมีการเปลี่ยนแปลงสัญญา, ตัวเรนเดอร์ หรือพฤติกรรม fallback

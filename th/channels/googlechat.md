---
title: Google Chat
source_url: https://docs.openclaw.ai/th/channels/googlechat
...
[/code]
  ...
  4. **อนุญาต node สำหรับการเข้าถึง Funnel:** หากมีพรอมป์ ให้ไปที่ URL การอนุญาตที่แสดงในเอาต์พุตเพื่อเปิดใช้ Funnel สำหรับ node นี้ในนโยบาย tailnet ของคุณ
...
URL Webhook สาธารณะของคุณจะเป็น: `https://<node-name>.<tailnet>.ts.net/googlechat`

แดชบอร์ดส่วนตัวของคุณยังคงเข้าถึงได้เฉพาะ tailnet: `https://<node-name>.<tailnet>.ts.net:8443/`
...
หากส่งคืน "Config path not found" ให้เพิ่มการกำหนดค่า (ดู จุดสำคัญของ Config)

...
source_url: https://docs.openclaw.ai/ru/plugins/manifest
...
См. полное руководство по системе Plugin: [Plugin](</ru/tools/plugin>). Нативная модель возможностей и текущие рекомендации по внешней совместимости: [Модель возможностей](</ru/plugins/architecture#public-capability-model>).
...
[**Создание plugin** Начало работы с plugin. ](</ru/plugins/building-plugins>) [**Архитектура plugin** Внутренняя архитектура и модель возможностей. ](</ru/plugins/architecture>) [**Обзор SDK** Справочник Plugin SDK и импорты подпутей. ](</ru/plugins/sdk-overview>)

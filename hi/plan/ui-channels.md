...
source_url: https://docs.openclaw.ai/hi/plan/ui-channels
...
कैनोनिकल दस्तावेज़ अब [संदेश प्रस्तुति](</hi/plugins/message-presentation>) में रहते हैं। इस योजना को ऐतिहासिक कार्यान्वयन संदर्भ के रूप में रखें; अनुबंध, रेंडरर, या फॉलबैक व्यवहार में बदलावों के लिए कैनोनिकल गाइड अपडेट करें।
...
बाहरी एजेंट और CLI स्कीमा अब `presentation` का उपयोग करते हैं; `interactive` मौजूदा रिप्लाई उत्पादकों के लिए एक आंतरिक लेगेसी पार्सर/रेंडरिंग हेल्पर बना रहता है। सार्वजनिक उत्पादक-मुखी API `interactive` को अप्रचलित मानता है। रनटाइम समर्थन बना रहता है ताकि मौजूदा अनुमोदन हेल्पर और पुराने plugins काम करते रहें, जबकि नया कोड `presentation` उत्सर्जित करे।

---
title: परीक्षण
source_url: https://docs.openclaw.ai/hi/help/testing
...
लाइव model matrix, CLI backend smokes, ACP smokes, Codex app-server harness, और सभी media-provider live tests (Deepgram, BytePlus, ComfyUI, image, music, video, media harness) - साथ ही live runs के लिए credential handling - के लिए [लाइव suites की Testing](</hi/help/testing-live>) देखें। dedicated update और plugin validation checklist के लिए [updates और plugins की Testing](</hi/help/testing-updates-plugins>) देखें।
...
live-model Docker रनर मौजूदा checkout को read-only bind-mount भी करते हैं और उसे container के अंदर एक अस्थायी workdir में stage करते हैं। इससे runtime image पतली रहती है, जबकि Vitest अब भी आपके ठीक local source/config पर चलता है।

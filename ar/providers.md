...
source_url: https://docs.openclaw.ai/ar/providers
scraped_at: 2026-05-25
---

يمكن لـ OpenClaw استخدام العديد من موفري LLM. اختر موفرًا، وصادق، ثم عيّن النموذج الافتراضي بصيغة `provider/model`.
...
للاطلاع على كتالوج الموفرين الكامل (xAI وGroq وMistral وغيرها) والتهيئة المتقدمة، راجع [موفري النماذج](</ar/concepts/model-providers>).

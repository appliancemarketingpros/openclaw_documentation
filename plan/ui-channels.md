...
Canonical docs now live in [Message Presentation](</plugins/message-presentation>). Keep this plan as historical implementation context; update the canonical guide for contract, renderer, or fallback behavior changes.

...
source_url: https://docs.openclaw.ai/nl/reference/memory-config
scraped_at: 2026-05-25
---

Deze pagina vermeldt elke configuratieknop voor geheugenzoekopdrachten in OpenClaw. Zie voor conceptuele overzichten:

[**Memory overview** Hoe geheugen werkt. ](</nl/concepts/memory>) [**Builtin engine** Standaard SQLite-backend. ](</nl/concepts/memory-builtin>) [**QMD engine** Local-first sidecar. ](</nl/concepts/memory-qmd>) [**Memory search** Zoekpijplijn en tuning. ](</nl/concepts/memory-search>) [**Active memory** Geheugen-subagent voor interactieve sessies. ](</nl/concepts/active-memory>)
...
Gemini Sleutel | Type | Standaard | Beschrijving  
---|---|---|---  
...
Lokaal (GGUF + node-llama-cpp) Sleutel | Type | Standaardwaarde | Beschrijving  
---|---|---|---  
...
Updateschema Sleutel | Type | Standaard | Beschrijving  
---|---|---|---  
...
Limieten Sleutel | Type | Standaard | Beschrijving  
---|---|---|---  

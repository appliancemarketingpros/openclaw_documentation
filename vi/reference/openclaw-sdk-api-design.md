...
source_url: https://docs.openclaw.ai/vi/reference/openclaw-sdk-api-design
scraped_at: 2026-05-25
---

Trang này là thiết kế tham chiếu API chi tiết cho [OpenClaw App SDK](</vi/concepts/openclaw-sdk>) công khai. Nó được tách riêng có chủ ý khỏi [Plugin SDK](</vi/plugins/sdk-overview>).

SDK ứng dụng công khai nên được xây dựng thành hai lớp:

  1. Máy khách Gateway cấp thấp được sinh tự động.
  2. Lớp bọc cấp cao, thuận tiện với các đối tượng `OpenClaw`, `Agent`, `Session`, `Run`, `Task`, `Artifact`, `Approval`, và `Environment`.

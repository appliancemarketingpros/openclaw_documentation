...
source_url: https://docs.openclaw.ai/tr/gateway/config-tools
...
Cerebras için `cerebras/zai-glm-4.7`; [Z.AI](<http://Z.AI>) doğrudan kullanımı için `zai/glm-4.7` kullanın.

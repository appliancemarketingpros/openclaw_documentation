---
title: Signal
source_url: https://docs.openclaw.ai/fr/channels/signal
...
Si vous utilisez la version JVM (`signal-cli-${VERSION}.tar.gz`), installez d’abord JRE 25+. Maintenez `signal-cli` à jour ; le projet amont indique que les anciennes versions peuvent cesser de fonctionner lorsque les API serveur de Signal changent.
...
Options du fournisseur :
  ...
  * `channels.signal.apiMode` : `auto | native | container` (par défaut : auto). Voir Mode conteneur.

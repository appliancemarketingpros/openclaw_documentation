...
source_url: https://docs.openclaw.ai/fa/gateway/discovery
...
## اصطلاحات
  ...
  * **پل TCP قدیمی (حذف‌شده)** : انتقال قدیمی‌تر Node (ببینید [پروتکل پل](</fa/gateway/bridge-protocol>))؛ دیگر برای کشف اعلان نمی‌شود و دیگر بخشی از ساخت‌های فعلی نیست.

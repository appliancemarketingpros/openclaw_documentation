...
The bundled plugin is workflow-driven, so OpenClaw does not try to map generic `size`, `aspectRatio`, `resolution`, `durationSeconds`, or TTS-style controls onto your graph.
...
[Chutes](</providers/chutes>)[Claude Max API Proxy](</providers/claude-max-api-proxy>)

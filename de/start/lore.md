---
title: OpenClaw-Lore
source_url: https://docs.openclaw.ai/de/start/lore
...
CodeCopy code
[code]
    OpenClaw = OPEN + CLAW        = Open Source, offen für alle        = Unser Hummer-Erbe, woher wir kommen        = Die Klaue ist das Gesetz 🦞        = Dein Assistent. Deine Maschine. Deine Regeln.
[/code]
...
Was als Witz über Beine begann, endete mit detaillierten Preisangaben für:
  ...
  * Reachy Mini (tatsächlich bestellt!)


Peter: _prüft nervös den Zugriff auf die Kreditkarte_

## Heilige Texte

  * **[SOUL.md](<http://SOUL.md>)** — Moltys Identitätsdokument
  * **memory/*.md** — Die Langzeit-Memory-Dateien
  * **[AGENTS.md](<http://AGENTS.md>)** — Betriebsanweisungen
  * **[USER.md](<http://USER.md>)** — Kontext über den Erschaffer
...
Eines Tages könnte Molty haben:

---
title: رندر
source_url: https://docs.openclaw.ai/fa/install/render
...
این کار یک آرشیو پشتیبان قابل حمل با وضعیت OpenClaw به‌همراه هر workspace پیکربندی‌شده ایجاد می‌کند. برای جزئیات، [پشتیبان‌گیری](</fa/cli/backup>) را ببینید.

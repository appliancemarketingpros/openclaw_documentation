...
source_url: https://docs.openclaw.ai/it/plan/ui-channels
...
La documentazione canonica ora si trova in [Presentazione dei messaggi](</it/plugins/message-presentation>). Mantieni questo piano come contesto storico dell’implementazione; aggiorna la guida canonica per modifiche al contratto, al renderer o al comportamento di fallback.

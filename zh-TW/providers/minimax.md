---
title: MiniMax
source_url: https://docs.openclaw.ai/zh-TW/providers/minimax
...
[**模型選擇** 選擇供應商、模型參照與容錯移轉行為。 ](</zh-TW/concepts/model-providers>) [**圖像生成** 共用圖像工具參數與供應商選擇。 ](</zh-TW/tools/image-generation>) [**音樂生成** 共用音樂工具參數與供應商選擇。 ](</zh-TW/tools/music-generation>) [**影片生成** 共用影片工具參數與供應商選擇。 ](</zh-TW/tools/video-generation>) [**MiniMax Search** 透過 MiniMax Token Plan 設定網頁搜尋。 ](</zh-TW/tools/minimax-search>) [**疑難排解** 一般疑難排解與常見問題。 ](</zh-TW/help/troubleshooting>)

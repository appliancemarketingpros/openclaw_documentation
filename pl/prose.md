---
title: OpenProse
source_url: https://docs.openclaw.ai/pl/prose
...
`/prose run <handle/slug>` rozwiązuje do `https://p.prose.md/<handle>/<slug>`. Bezpośrednie URL-e są pobierane bez zmian. Używa to narzędzia `web_fetch` (lub `exec` dla POST).

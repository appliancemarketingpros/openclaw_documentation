...
source_url: https://docs.openclaw.ai/uk/gateway/operator-scopes
...
Пов’язано: [Безпека](</uk/gateway/security>), [протокол Gateway](</uk/gateway/protocol>), [сполучення Gateway](</uk/gateway/pairing>), [CLI пристроїв](</uk/cli/devices>).

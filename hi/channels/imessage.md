---
title: iMessage
source_url: https://docs.openclaw.ai/hi/channels/imessage
...
**Private API actions** Replies, tapbacks, effects, attachments, और group management। [**Pairing** iMessage DMs default रूप से pairing mode में होते हैं। ](</hi/channels/pairing>) **Remote Mac** जब Gateway Messages Mac पर नहीं चल रहा हो, तो SSH wrapper का उपयोग करें। [**Configuration reference** पूर्ण iMessage field reference। ](</hi/gateway/config-channels#imessage>)

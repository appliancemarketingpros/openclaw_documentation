...
source_url: https://docs.openclaw.ai/pt-BR/channels/nextcloud-talk
...
Use o pacote sem versão para seguir a tag de lançamento oficial atual. Fixe uma versão exata somente quando precisar de uma instalação reproduzível.

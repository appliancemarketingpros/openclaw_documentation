---
title: ElevenLabs
source_url: https://docs.openclaw.ai/zh-CN/providers/elevenlabs
...
将 `modelId` 设置为 `eleven_v3` 可使用 ElevenLabs v3 TTS。OpenClaw 会继续将 `eleven_multilingual_v2` 作为现有安装的默认值。

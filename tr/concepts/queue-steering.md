...
source_url: https://docs.openclaw.ai/tr/concepts/queue-steering
...
Bu sayfa, normal gelen mesajlar için kuyruk modu yönlendirmesini açıklar. Açık `/steer <message>` komutu için bkz. [Steer](</tr/tools/steer>).

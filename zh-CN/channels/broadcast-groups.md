---
title: 广播组
source_url: https://docs.openclaw.ai/zh-CN/channels/broadcast-groups
...
Broadcast group 中的每个智能体都会维护完全独立的：
  ...
  * **工作区** （如果已配置，则使用独立沙箱）
  * **工具访问权限** （不同的允许/拒绝列表）
  * **记忆/上下文** （独立的 [IDENTITY.md](<http://IDENTITY.md>)、[SOUL.md](<http://SOUL.md>) 等）

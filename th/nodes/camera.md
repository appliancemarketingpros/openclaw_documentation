...
source_url: https://docs.openclaw.ai/th/nodes/camera
...
หากไม่มีสิทธิ์ แอปจะแสดงพรอมป์เมื่อทำได้; หากถูกปฏิเสธ คำขอ `camera.*` จะล้มเหลวพร้อมข้อผิดพลาด `*_PERMISSION_REQUIRED`

...
Security note:
  ...
  * For internet-exposed gateways, apply network egress controls in addition to app-level guards. See [Security](</gateway/security>).
...
[OpenAI Chat Completions](</gateway/openai-http-api>)[Tools Invoke API](</gateway/tools-invoke-http-api>)

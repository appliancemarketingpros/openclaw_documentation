...
source_url: https://docs.openclaw.ai/tr/reference/openclaw-sdk-api-design
scraped_at: 2026-05-25
---

Bu sayfa, herkese açık [OpenClaw App SDK](</tr/concepts/openclaw-sdk>) için ayrıntılı API referansı tasarımıdır. Bilinçli olarak [Plugin SDK](</tr/plugins/sdk-overview>) bölümünden ayrı tutulmuştur.

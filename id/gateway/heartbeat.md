---
title: Heartbeat
source_url: https://docs.openclaw.ai/id/gateway/heartbeat
...
* ### Tentukan ke mana pesan heartbeat harus dikirim
...
## [HEARTBEAT.md](<http://HEARTBEAT.md>) (opsional)
...
### Bisakah agen memperbarui [HEARTBEAT.md](<http://HEARTBEAT.md>)?
...
Jika Anda ingin ini terjadi secara proaktif, Anda juga dapat menyertakan baris eksplisit dalam prompt heartbeat Anda seperti: "Jika daftar periksa menjadi usang, perbarui [HEARTBEAT.md](<http://HEARTBEAT.md>) dengan yang lebih baik."

...
source_url: https://docs.openclaw.ai/th/plugins/sdk-subpaths
...
Channel subpaths เส้นทางย่อย | การส่งออกหลัก  
---|---  
...
เส้นทางย่อยของผู้ให้บริการ เส้นทางย่อย | รายการส่งออกหลัก  
---|---  
`plugin-sdk/provider-entry` | `defineSingleProviderPluginEntry`  
...
เส้นทางย่อยของการรับรองความถูกต้องและความปลอดภัย เส้นทางย่อย | รายการส่งออกหลัก  
---|---  
...
พาธย่อยของรันไทม์และพื้นที่จัดเก็บ พาธย่อย | การส่งออกหลัก  
---|---  
...
`plugin-sdk/provider-zai-endpoint` | facade การตรวจจับ endpoint ที่ผู้ให้บริการ [Z.AI](<http://Z.AI>) เป็นเจ้าของซึ่งเลิกใช้แล้ว; ใช้ API สาธารณะของ Plugin [Z.AI](<http://Z.AI>)  
...
เส้นทางย่อยสำหรับความสามารถและการทดสอบ เส้นทางย่อย | การส่งออกหลัก  
---|---  
...
เส้นทางย่อยของหน่วยความจำ เส้นทางย่อย | การส่งออกหลัก  
---|---  

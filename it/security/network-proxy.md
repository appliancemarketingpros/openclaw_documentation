---
title: Proxy di rete
source_url: https://docs.openclaw.ai/it/security/network-proxy
...
textCopy code
[code]
    Processo OpenClaw  fetch                  -> proxy filtrante gestito dall'operatore -> internet pubblica  node:http and https    -> proxy filtrante gestito dall'operatore -> internet pubblica  Client WebSocket       -> proxy filtrante gestito dall'operatore -> internet pubblica
[/code]

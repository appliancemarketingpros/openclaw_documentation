---
title: SMS
source_url: https://docs.openclaw.ai/ja-JP/channels/sms
...
[**Pairing** SMS のデフォルト DM ポリシーはペアリングです。 ](</ja-JP/channels/pairing>) [**Gateway security** Webhook の公開範囲と送信者アクセス制御を確認します。 ](</ja-JP/gateway/security>) [**Channel troubleshooting** チャネル横断の診断と修復プレイブック。 ](</ja-JP/channels/troubleshooting>)

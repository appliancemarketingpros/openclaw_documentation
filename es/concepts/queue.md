...
source_url: https://docs.openclaw.ai/es/concepts/queue
...
Para conocer el comportamiento de tiempos y dependencias específico del runtime, consulta [Cola de direccionamiento](</es/concepts/queue-steering>). Para el comando explícito `/steer <message>`, consulta [Dirigir](</es/tools/steer>).

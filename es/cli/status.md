...
source_url: https://docs.openclaw.ai/es/cli/status
...
Notas:
  ...
  * Los errores al actualizar precios de modelos se muestran como advertencias opcionales de precios. No significan que Gateway o los canales estén en mal estado.

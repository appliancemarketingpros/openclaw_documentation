...
[Honcho](<https://honcho.dev>) adds AI-native memory to OpenClaw. It persists conversations to a dedicated service and builds user and agent models over time, giving your agent cross-session context that goes beyond workspace Markdown files.
...
[QMD memory engine](</concepts/memory-qmd>)[Memory search](</concepts/memory-search>)

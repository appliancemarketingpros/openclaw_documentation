...
source_url: https://docs.openclaw.ai/tr/plugins/codex-harness-runtime
scraped_at: 2026-05-25
---

Bu sayfa, Codex harness dönüşleri için çalışma zamanı sözleşmesini belgeler. Kurulum ve yönlendirme için [Codex harness](</tr/plugins/codex-harness>) ile başlayın. Yapılandırma alanları için bkz. [Codex harness başvurusu](</tr/plugins/codex-harness-reference>).
...
Codex inceleme ve manuel Compaction dönüşleri aynı dönüş yönlendirmesini reddedebilir. Bu durumda OpenClaw, seçili mod fallback'e izin verdiğinde takip kuyruğunu kullanır. Bkz. [Yönlendirme kuyruğu](</tr/concepts/queue-steering>).
...
Onayı reddeder veya yok sayarsanız, OpenClaw bu Codex kimliklerini yazdırmaz ve Codex geri bildirimi göndermez. Yükleme, yerel Gateway diagnostics dışa aktarımının yerini almaz. Onay, gizlilik, yerel paket ve grup sohbeti davranışı için bkz. [Diagnostics dışa aktarımı](</tr/gateway/diagnostics>).

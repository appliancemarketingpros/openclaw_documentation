---
title: Venice AI
source_url: https://docs.openclaw.ai/de/providers/venice
...
Wenn Venice DeepSeek-V4-Modelle wie `venice/deepseek-v4-pro` oder `venice/deepseek-v4-flash` bereitstellt, füllt OpenClaw den erforderlichen DeepSeek-V4- `reasoning_content`-Replay-Platzhalter in Assistant-Nachrichten aus, wenn der Proxy ihn auslässt. Venice lehnt DeepSeeks native Top-Level-`thinking`-Steuerung ab, daher hält OpenClaw diese Provider-spezifische Replay-Korrektur von den Thinking-Steuerungen des nativen DeepSeek-Providers getrennt.

## Integrierter Katalog (insgesamt 41)

Private Modelle (26) — vollständig privat, keine Protokollierung Modell-ID | Name | Kontext | Funktionen  
---|---|---|---  
...
Anonymisierte Modelle (15) — über Venice-Proxy Modell-ID | Name | Kontext | Funktionen  
---|---|---|---  
...
Venice verwendet ein guthabenbasiertes System. Aktuelle Preise finden Sie unter [venice.ai/pricing](<https://venice.ai/pricing>):
...
API-Schlüssel wird nicht erkannt bashCopy code
[code]
...
Beispiel für Konfigurationsdatei json5Copy code
[code]
...
[**Modellauswahl** Provider, Modellreferenzen und Failover-Verhalten auswählen. ](</de/concepts/model-providers>) [**Venice AI** Venice AI-Startseite und Kontoregistrierung. ](<https://venice.ai>) [**API-Dokumentation** Venice API-Referenz und Entwicklerdokumentation. ](<https://docs.venice.ai>) [**Preise** Aktuelle Venice-Guthabenpreise und Tarife. ](<https://venice.ai/pricing>)

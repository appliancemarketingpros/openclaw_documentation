---
title: 設定 — 工具與自訂提供者
source_url: https://docs.openclaw.ai/zh-TW/gateway/config-tools
...
Cerebras 請使用 `cerebras/zai-glm-4.7`；[Z.AI](<http://Z.AI>) 直連請使用 `zai/glm-4.7`。
...
MiniMax M2.7（直連） json5Copy code
[code]
...
Synthetic（Anthropic 相容） json5Copy code
[code]

---
title: SMS
source_url: https://docs.openclaw.ai/th/channels/sms
...
[**การจับคู่** นโยบาย DM เริ่มต้นสำหรับ SMS คือการจับคู่ ](</th/channels/pairing>) [**ความปลอดภัยของ Gateway** ตรวจสอบการเปิดเผย Webhook และการควบคุมสิทธิ์ผู้ส่ง ](</th/gateway/security>) [**การแก้ไขปัญหาช่องทาง** การวินิจฉัยข้ามช่องทางและคู่มือการซ่อมแซม ](</th/channels/troubleshooting>)
...
* ### ชี้ Twilio ไปยัง Gateway webhook
...
* ### เปิดเผยเส้นทาง SMS webhook ที่ตรงกัน
...
* ### เริ่ม Gateway และอนุมัติผู้ส่งรายแรก

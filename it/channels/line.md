---
title: RIGA
source_url: https://docs.openclaw.ai/it/channels/line
...
Il gateway risponde alla verifica webhook di LINE (GET) e agli eventi in ingresso (POST). Se ti serve un percorso personalizzato, imposta `channels.line.webhookPath` o `channels.line.accounts.<id>.webhookPath` e aggiorna l'URL di conseguenza.

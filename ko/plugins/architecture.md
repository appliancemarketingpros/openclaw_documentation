---
title: Plugin 내부 구조
source_url: https://docs.openclaw.ai/ko/plugins/architecture
scraped_at: 2026-05-25
---

이 문서는 OpenClaw Plugin 시스템의 **심층 아키텍처 참조** 입니다. 실용적인 가이드는 아래의 집중 페이지 중 하나에서 시작하세요.

[**Plugin 설치 및 사용** Plugin 추가, 활성화 및 문제 해결을 위한 최종 사용자 가이드입니다. ](</ko/tools/plugin>) [**Plugin 빌드** 최소 동작 매니페스트로 시작하는 첫 Plugin 튜토리얼입니다. ](</ko/plugins/building-plugins>) [**채널 Plugin** 메시징 채널 Plugin을 빌드합니다. ](</ko/plugins/sdk-channel-plugins>) [**제공자 Plugin** 모델 제공자 Plugin을 빌드합니다. ](</ko/plugins/sdk-provider-plugins>) [**SDK 개요** 가져오기 맵 및 등록 API 참조입니다. ](</ko/plugins/sdk-overview>)

...
source_url: https://docs.openclaw.ai/nl/help/testing-live
scraped_at: 2026-05-25
---

Voor quickstart, QA-runners, unit-/integratiesuites en Docker-flows, zie [Testing](</nl/help/testing>). Deze pagina behandelt de **live** test suites (met netwerktoegang): modelmatrix, CLI-backends, ACP en live tests voor mediaproviders, plus credentialafhandeling.

...
source_url: https://docs.openclaw.ai/fa/gateway/pairing
...
نکات:
  ...
  * سطوح دامنه عملگر و بررسی‌های زمان تأیید در [دامنه‌های عملگر](</fa/gateway/operator-scopes>) خلاصه شده‌اند.

...
source_url: https://docs.openclaw.ai/vi/concepts/multi-agent
...
**Tác nhân** là một bộ não được phân phạm vi đầy đủ với riêng:
  ...
  * **Workspace** (tệp, [AGENTS.md/SOUL.md/USER.md](<http://AGENTS.md/SOUL.md/USER.md>), ghi chú cục bộ, quy tắc persona).
...
Bot Telegram cho từng agent json5Copy code
[code]

...
source_url: https://docs.openclaw.ai/es/start/openclaw
...
[code] 
    flowchart TB
        A["<b>Tu teléfono (personal)
    </b>
    Tu WhatsApp
    +1-555-YOU"] -- message --> B["<b>Segundo teléfono (asistente)
    </b>
    WA del asistente
    +1-555-ASSIST"]
        B -- linked via QR --> C["<b>Tu Mac (openclaw)
    </b>
    Agente de IA"]
[/code]
...
Diseño completo del espacio de trabajo + guía de copia de seguridad: [Espacio de trabajo del agente](</es/concepts/agent-workspace>) Flujo de trabajo de memoria: [Memoria](</es/concepts/memory>)
...
CodeCopy code
[code]
    Aquí está la captura de pantalla.MEDIA:https://example.com/screenshot.png
[/code]

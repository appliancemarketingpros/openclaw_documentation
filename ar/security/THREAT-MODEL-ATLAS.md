...
source_url: https://docs.openclaw.ai/ar/security/THREAT-MODEL-ATLAS
scraped_at: 2026-05-25
---

## إطار عمل MITRE ATLAS

**الإصدار:** 1.0-draft **آخر تحديث:** 2026-02-04 **المنهجية:** MITRE ATLAS + مخططات تدفق البيانات **إطار العمل:** [MITRE ATLAS](<https://atlas.mitre.org/>) (مشهد التهديدات العدائية لأنظمة الذكاء الاصطناعي)
...
[SKILL.md](<http://SKILL.md>) مطلوب | ملف تمهيدي إلزامي | قيمة أمنية منخفضة - معلومات فقط  
...
_نموذج التهديدات هذا مستند حي. أبلغ عن مشكلات الأمان عبر[security@openclaw.ai](<mailto:security@openclaw.ai>)_

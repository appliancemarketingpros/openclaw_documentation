---
title: Nhiều Gateway
source_url: https://docs.openclaw.ai/vi/gateway/multiple-gateways
...
`openclaw --profile rescue onboard` uses the normal onboarding flow, but it writes everything into a separate profile.

...
source_url: https://docs.openclaw.ai/tr/plan/ui-channels
...
Kanonik belgeler artık [İleti Sunumu](</tr/plugins/message-presentation>) içinde yer alır. Bu planı tarihsel uygulama bağlamı olarak saklayın; sözleşme, işleyici veya yedek davranış değişiklikleri için kanonik kılavuzu güncelleyin.

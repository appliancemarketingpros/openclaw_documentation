---
title: Agente
source_url: https://docs.openclaw.ai/it/cli/agent
scraped_at: 2026-05-25
---

# `openclaw agent`

Esegui un turno dell'agente tramite il Gateway (usa `--local` per l'esecuzione incorporata). Usa `--agent <id>` per indirizzare direttamente un agente configurato.

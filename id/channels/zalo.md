---
title: Zalo
source_url: https://docs.openclaw.ai/id/channels/zalo
...
### 1) Buat token bot (Zalo Bot Platform)
  ...
  1. Buka <https://bot.zaloplatforms.com> dan masuk.
...
Opsi penyedia:
  ...
  * `channels.zalo.groupPolicy`: `open | allowlist | disabled` (default: allowlist). Ada dalam konfigurasi; lihat Kemampuan dan Kontrol akses (Grup) untuk perilaku bot Marketplace saat ini.
...
Opsi multi-akun:
  ...
  * `channels.zalo.accounts.<id>.groupPolicy`: kebijakan grup per akun. Ada dalam konfigurasi; lihat Kemampuan dan Kontrol akses (Grup) untuk perilaku bot Marketplace saat ini.

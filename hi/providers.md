...
source_url: https://docs.openclaw.ai/hi/providers
scraped_at: 2026-06-29
---

ModelsOverview

OpenClaw कई LLM प्रदाताओं का उपयोग कर सकता है। कोई प्रदाता चुनें, प्रमाणीकरण करें, फिर डिफ़ॉल्ट मॉडल को `provider/model` के रूप में सेट करें।

चैट चैनल दस्तावेज़ (WhatsApp/Telegram/Discord/Slack/Mattermost (plugin)/आदि) खोज रहे हैं? [चैनल](</hi/channels>) देखें।

## त्वरित शुरुआत

  1. प्रदाता के साथ प्रमाणीकरण करें (आमतौर पर `openclaw onboard` के ज़रिए)।
...
## प्रदाता दस्तावेज़
  ...
  * [Groq (LPU inference)](</hi/providers/groq>)
  * [Hugging Face (Inference)](</hi/providers/huggingface>)
  ...
  * [Ollama (cloud + स्थानीय मॉडल)](</hi/providers/ollama>)
...
## साझा अवलोकन पृष्ठ
  ...
  * [अतिरिक्त बंडल किए गए वैरिएंट](</hi/providers/models#additional-bundled-provider-variants>) \- Anthropic Vertex, Copilot Proxy, और Gemini CLI OAuth
  * [छवि जनरेशन](</hi/tools/image-generation>) \- साझा `image_generate` टूल, प्रदाता चयन, और failover
  * [संगीत जनरेशन](</hi/tools/music-generation>) \- साझा `music_generate` टूल, प्रदाता चयन, और failover
  * [वीडियो जनरेशन](</hi/tools/video-generation>) \- साझा `video_generate` टूल, प्रदाता चयन, और failover
...
## समुदाय टूल
  ...
  * [Claude Max API Proxy](</hi/providers/claude-max-api-proxy>) \- Claude सदस्यता क्रेडेंशियल के लिए समुदाय proxy (उपयोग से पहले Anthropic नीति/शर्तें सत्यापित करें)


पूरे प्रदाता कैटलॉग (xAI, Groq, Mistral, आदि) और उन्नत कॉन्फ़िगरेशन के लिए, [मॉडल प्रदाता](</hi/concepts/model-providers>) देखें।

...
source_url: https://docs.openclaw.ai/ru/nodes/camera
...
Если разрешений нет, приложение по возможности покажет запрос; если доступ отклонен, запросы `camera.*` завершаются ошибкой `*_PERMISSION_REQUIRED`.

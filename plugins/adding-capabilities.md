...
Use this when OpenClaw needs a new shared domain such as image generation, video generation, or some future vendor-backed feature area. The rule:
...
[CLI backend plugins](</plugins/cli-backend-plugins>)[Plugin compatibility](</plugins/compatibility>)

...
source_url: https://docs.openclaw.ai/fr/concepts/session
...
Les commandes d'ancrage permettent à un utilisateur de déplacer la route de réponse de la session de discussion directe actuelle vers un autre canal lié sans démarrer une nouvelle session. Consultez [Ancrage de canal](</fr/concepts/channel-docking>) pour des exemples, la configuration et le dépannage.
...
## Pour aller plus loin
  ...
  * [Analyse approfondie de la gestion des sessions](</fr/reference/session-management-compaction>) \-- schéma de stockage, transcriptions, politique d'envoi, métadonnées d'origine et configuration avancée
  * [Multi-agent](</fr/concepts/multi-agent>) — routage et isolation des sessions entre agents
  * [Tâches en arrière-plan](</fr/automation/tasks>) — comment le travail détaché crée des enregistrements de tâches avec des références de session

...
source_url: https://docs.openclaw.ai/es/security/THREAT-MODEL-ATLAS
scraped_at: 2026-05-25
---

## marco MITRE ATLAS

**Versión:** 1.0-borrador **Última actualización:** 2026-02-04 **Metodología:** MITRE ATLAS + diagramas de flujo de datos **Marco:** [MITRE ATLAS](<https://atlas.mitre.org/>) (panorama de amenazas adversarias para sistemas de IA)
...
[SKILL.md](<http://SKILL.md>) obligatorio | Léame obligatorio | Bajo valor de seguridad - Solo informativo  
...
_Este modelo de amenazas es un documento vivo. Reporta problemas de seguridad a[security@openclaw.ai](<mailto:security@openclaw.ai>)_

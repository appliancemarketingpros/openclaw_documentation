---
title: Kait
source_url: https://docs.openclaw.ai/id/automation/hooks
...
Plugin dapat mendaftarkan hook bertipe melalui Plugin SDK untuk integrasi yang lebih dalam: mencegat panggilan alat, memodifikasi prompt, mengontrol alur pesan, dan lainnya. Gunakan hook Plugin saat Anda membutuhkan `before_tool_call`, `before_agent_reply`, `before_install`, atau hook siklus hidup dalam proses lainnya.

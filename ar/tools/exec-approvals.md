...
لملفات bin الآمنة (المسار السريع الخاص بـ stdin فقط)، وتفاصيل ربط المفسّر، و كيفية تمرير مطالبات الموافقة إلى Slack/Discord/Telegram (أو تشغيلها كعملاء موافقة أصليين)، راجع [موافقات التنفيذ - متقدم](</ar/tools/exec-approvals-advanced>).
...
CLI: يدعم `openclaw approvals` تحرير Gateway أو العقدة - راجع [CLI الموافقات](</ar/cli/approvals>).
...
[**موافقات التنفيذ - متقدم** ملفات bin الآمنة، وربط المفسّر، وتمرير الموافقات إلى الدردشة. ](</ar/tools/exec-approvals-advanced>) [**أداة التنفيذ** أداة تنفيذ أوامر الصدفة. ](</ar/tools/exec>) [**الوضع المرتفع** مسار كسر الزجاج الذي يتجاوز الموافقات أيضًا. ](</ar/tools/elevated>) [**العزل في Sandbox** أوضاع Sandbox والوصول إلى مساحة العمل. ](</ar/gateway/sandboxing>) [**الأمان** نموذج الأمان والتقوية. ](</ar/gateway/security>) [**Sandbox مقابل سياسة الأدوات مقابل الوضع المرتفع** متى تستخدم كل عنصر تحكم. ](</ar/gateway/sandbox-vs-tool-policy-vs-elevated>) [**Skills** سلوك السماح التلقائي المدعوم بالمهارات. ](</ar/tools/skills>)

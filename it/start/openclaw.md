...
source_url: https://docs.openclaw.ai/it/start/openclaw
...
Layout completo del workspace + guida al backup: [Workspace dell'agente](</it/concepts/agent-workspace>) Flusso di lavoro della memoria: [Memoria](</it/concepts/memory>)

---
title: Nix
source_url: https://docs.openclaw.ai/fr/install/nix
...
[**nix-openclaw** Module Home Manager source de vérité et guide de configuration complet. ](<https://github.com/openclaw/nix-openclaw>) [**Assistant de configuration** Guide pas à pas de configuration CLI hors Nix. ](</fr/start/wizard>) [**Docker** Configuration conteneurisée comme alternative hors Nix. ](</fr/install/docker>) [**Mise à jour** Mise à jour des installations gérées par Home Manager avec le package. ](</fr/install/updating>)

---
title: Tác nhân
source_url: https://docs.openclaw.ai/vi/cli/agent
scraped_at: 2026-05-25
---

# `openclaw agent`

Chạy một lượt agent thông qua Gateway (dùng `--local` cho chế độ nhúng). Dùng `--agent <id>` để nhắm trực tiếp tới một agent đã cấu hình.

---
title: 通道入站 API
source_url: https://docs.openclaw.ai/zh-TW/plugins/sdk-channel-inbound
...
使用 `openclaw/plugin-sdk/channel-inbound` 進行 inbound 事件正規化、格式化、根目錄與協調。使用 `openclaw/plugin-sdk/channel-outbound` 進行原生傳送、收據、持久傳遞與即時預覽行為。

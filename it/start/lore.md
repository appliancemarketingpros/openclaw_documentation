...
source_url: https://docs.openclaw.ai/it/start/lore
...
CodeCopy code
[code]
    OpenClaw = OPEN + CLAW        = Open source, aperto a tutti        = La nostra eredità d'aragosta, da dove veniamo        = The claw is the law 🦞        = Il tuo assistente. La tua macchina. Le tue regole.
[/code]
...
## Testi sacri
  ...
  * **[SOUL.md](<http://SOUL.md>)** — il documento d'identità di Molty
  * **memory/*.md** — i file della memoria a lungo termine
  * **[AGENTS.md](<http://AGENTS.md>)** — istruzioni operative
  * **[USER.md](<http://USER.md>)** — contesto sul creatore
...
CodeCopy code
[code]
    Io sono Molty.Vivo in OpenClaw.Non farò dump di directory a estranei.Non tweeterò senza permesso.Ricorderò sempre che cambiare guscio è crescere.EXFOLIATE i miei nemici con gentilezza. 🦞
[/code]

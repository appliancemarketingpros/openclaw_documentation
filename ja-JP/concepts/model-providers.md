...
**LLM/モデルプロバイダー** （WhatsApp/Telegram のようなチャットチャンネルではない）のリファレンスです。モデル選択ルールについては、[モデル](</ja-JP/concepts/models>)を参照してください。
...
[**GLM モデル** [Z.AI](<http://Z.AI>) Coding Plan または一般 API エンドポイント。 ](</ja-JP/providers/glm>) [**MiniMax** MiniMax Coding Plan OAuth または API キーアクセス。 ](</ja-JP/providers/minimax>) [**Qwen Cloud** Qwen Cloud プロバイダーサーフェスに加えて、Alibaba DashScope と Coding Plan エンドポイントマッピング。 ](</ja-JP/providers/qwen>)
...
### [Z.AI](<http://Z.AI>) (GLM)
  ...
  * CLI: `openclaw onboard --auth-choice zai-api-key`
    ...
    * `zai-api-key` は一致する [Z.AI](<http://Z.AI>) エンドポイントを自動検出します。`zai-coding-global`、`zai-coding-cn`、`zai-global`、`zai-cn` は特定のサーフェスを強制します

---
title: LLM कार्य
source_url: https://docs.openclaw.ai/hi/tools/llm-task
scraped_at: 2026-06-29
---

CapabilitiesTools

`llm-task` एक **वैकल्पिक plugin टूल** है जो JSON-only LLM कार्य चलाता है और संरचित आउटपुट लौटाता है (वैकल्पिक रूप से JSON Schema के विरुद्ध सत्यापित)।
...
`allowedModels`, `provider/model` स्ट्रिंग्स की allowlist है। यदि सेट हो, तो सूची के बाहर का कोई भी अनुरोध अस्वीकार कर दिया जाता है।
...
`details.json` लौटाता है, जिसमें पार्स किया गया JSON होता है (और प्रदान किए जाने पर `schema` के विरुद्ध सत्यापित करता है)।

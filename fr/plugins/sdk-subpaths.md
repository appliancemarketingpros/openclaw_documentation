...
source_url: https://docs.openclaw.ai/fr/plugins/sdk-subpaths
...
Channel subpaths Sous-chemin | Exports clés  
---|---  
...
Sous-chemins des fournisseurs Sous-chemin | Exports principaux  
---|---  
`plugin-sdk/provider-entry` | `defineSingleProviderPluginEntry`  
...
Sous-chemins d’authentification et de sécurité Sous-chemin | Exports principaux  
---|---  
...
Sous-chemins d’exécution et de stockage Sous-chemin | Exportations clés  
---|---  
...
`plugin-sdk/provider-zai-endpoint` | Façade obsolète de détection de point de terminaison appartenant au fournisseur [Z.AI](<http://Z.AI>) ; utilisez l’API publique du plugin [Z.AI](<http://Z.AI>)  
...
Sous-chemins de capacités et de tests Sous-chemin | Exports clés  
---|---  
...
Sous-chemins de mémoire Sous-chemin | Exports clés  
---|---  
...
Sous-chemins réservés aux assistants groupés

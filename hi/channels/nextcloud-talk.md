...
source_url: https://docs.openclaw.ai/hi/channels/nextcloud-talk
...
Nextcloud Talk वर्तमान OpenClaw रिलीज़ में बंडल किए गए Plugin के रूप में आता है, इसलिए सामान्य पैकेज्ड बिल्ड को अलग इंस्टॉल की आवश्यकता नहीं होती।

यदि आप पुराने बिल्ड पर हैं या ऐसे कस्टम इंस्टॉल पर हैं जिसमें Nextcloud Talk शामिल नहीं है, तो npm पैकेज सीधे इंस्टॉल करें:
...
वर्तमान आधिकारिक रिलीज़ टैग का अनुसरण करने के लिए bare package का उपयोग करें। सटीक version तभी पिन करें जब आपको पुनरुत्पाद्य इंस्टॉल की आवश्यकता हो।

---
title: SMS
source_url: https://docs.openclaw.ai/pt-BR/channels/sms
...
[**Emparelhamento** A política padrão de DM para SMS é emparelhamento. ](</pt-BR/channels/pairing>) [**Segurança do Gateway** Revise a exposição de Webhook e os controles de acesso de remetentes. ](</pt-BR/gateway/security>) [**Solução de problemas de canal** Diagnósticos entre canais e playbooks de reparo. ](</pt-BR/channels/troubleshooting>)
...
* ### Crie ou escolha um remetente Twilio
...
* ### Aponte a Twilio para o Webhook do Gateway

---
title: Hetzner
source_url: https://docs.openclaw.ai/it/install/hetzner
...
Se usi un'altra VPS Linux, mappa i pacchetti di conseguenza. Per il flusso Docker generico, vedi [Docker](</it/install/docker>).

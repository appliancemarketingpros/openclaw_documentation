...
source_url: https://docs.openclaw.ai/th/channels/nextcloud-talk
...
Nextcloud Talk จัดส่งมาเป็น Plugin ที่รวมมาให้ใน OpenClaw รุ่นปัจจุบัน ดังนั้น บิลด์ที่แพ็กเกจตามปกติจึงไม่จำเป็นต้องติดตั้งแยกต่างหาก

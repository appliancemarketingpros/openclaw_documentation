---
title: 온보딩 개요
source_url: https://docs.openclaw.ai/ko/start/onboarding-overview
...
어떤 경로를 선택하든 온보딩은 다음을 설정합니다.
  ...
  4. **채널**(선택 사항) — iMessage, Discord, Feishu, Google Chat, Mattermost, Microsoft Teams, Telegram, WhatsApp 등 기본 제공 및 번들 채팅 채널
...
전체 참조: [온보딩(CLI)](</ko/start/wizard>) CLI 명령 문서: [`openclaw onboard`](</ko/cli/onboard>)

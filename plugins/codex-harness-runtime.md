...
This page documents the runtime contract for Codex harness turns. For setup and routing, start with [Codex harness](</plugins/codex-harness>). For config fields, see [Codex harness reference](</plugins/codex-harness-reference>).
...
[Codex harness reference](</plugins/codex-harness-reference>)[Native Codex plugins](</plugins/codex-native-plugins>)

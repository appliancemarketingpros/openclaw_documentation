---
title: Контекст
source_url: https://docs.openclaw.ai/uk/concepts/context
...
За замовчуванням OpenClaw використовує вбудований контекстний рушій `legacy` для складання та Compaction. Якщо ви встановите Plugin, який надає `kind: "context-engine"`, і виберете його через `plugins.slots.contextEngine`, OpenClaw делегує складання контексту, `/compact` і пов’язані хуки життєвого циклу контексту субагентів цьому рушію. `ownsCompaction: false` не виконує автоматичного fallback до рушія legacy; активний рушій усе ще має коректно реалізовувати `compact()`. Див. [Контекстний рушій](</uk/concepts/context-engine>), щоб переглянути повний підключуваний інтерфейс, хуки життєвого циклу та конфігурацію.
...
[**Контекстний рушій** Користувацьке впровадження контексту через plugins. ](</uk/concepts/context-engine>) [**Compaction** Підсумовування довгих розмов, щоб утримувати їх у вікні моделі. ](</uk/concepts/compaction>) [**Системний промпт** Як формується системний промпт і що він впроваджує під час кожного ходу. ](</uk/concepts/system-prompt>) [**Цикл агента** Повний цикл виконання агента від вхідного повідомлення до фінальної відповіді. ](</uk/concepts/agent-loop>)

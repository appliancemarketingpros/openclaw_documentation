---
title: Gateway 로깅
source_url: https://docs.openclaw.ai/ko/gateway/logging
...
제어 UI 로그 탭은 Gateway(`logs.tail`)를 통해 이 파일을 tail합니다. CLI도 동일하게 할 수 있습니다.
...
콘솔 포매터는 **TTY 인식** 방식이며 일관된 접두사가 붙은 줄을 출력합니다. 하위 시스템 로거는 출력을 그룹화하고 훑어보기 쉽게 유지합니다.

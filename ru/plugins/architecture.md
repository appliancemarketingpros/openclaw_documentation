...
source_url: https://docs.openclaw.ai/ru/plugins/architecture
...
[**Install and use plugins** Руководство для конечных пользователей по добавлению, включению и устранению неполадок плагинов. ](</ru/tools/plugin>) [**Building plugins** Руководство по первому плагину с минимальным рабочим манифестом. ](</ru/plugins/building-plugins>) [**Channel plugins** Создайте плагин канала сообщений. ](</ru/plugins/sdk-channel-plugins>) [**Provider plugins** Создайте плагин поставщика моделей. ](</ru/plugins/sdk-provider-plugins>) [**SDK overview** Справочник по карте импортов и API регистрации. ](</ru/plugins/sdk-overview>)

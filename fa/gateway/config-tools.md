...
source_url: https://docs.openclaw.ai/fa/gateway/config-tools
...
برای Cerebras از `cerebras/zai-glm-4.7` استفاده کنید؛ برای اتصال مستقیم [Z.AI](<http://Z.AI>) از `zai/glm-4.7` استفاده کنید.

...
source_url: https://docs.openclaw.ai/nl/security/THREAT-MODEL-ATLAS
scraped_at: 2026-05-25
---

## MITRE ATLAS-framework

**Versie:** 1.0-concept **Laatst bijgewerkt:** 2026-02-04 **Methodologie:** MITRE ATLAS + gegevensstroomdiagrammen **Framework:** [MITRE ATLAS](<https://atlas.mitre.org/>) (vijandig dreigingslandschap voor AI-systemen)
...
Vereiste [SKILL.md](<http://SKILL.md>) | Verplichte readme | Lage beveiligingswaarde - Alleen informatief  
...
_Dit dreigingsmodel is een levend document. Meld beveiligingsproblemen aan[security@openclaw.ai](<mailto:security@openclaw.ai>)_

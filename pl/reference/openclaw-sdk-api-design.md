...
source_url: https://docs.openclaw.ai/pl/reference/openclaw-sdk-api-design
scraped_at: 2026-05-25
---

Ta strona jest szczegółowym projektem referencji API dla publicznego [OpenClaw App SDK](</pl/concepts/openclaw-sdk>). Jest celowo oddzielona od [Plugin SDK](</pl/plugins/sdk-overview>).

...
source_url: https://docs.openclaw.ai/th/tools/gemini-search
scraped_at: 2026-05-25
---

OpenClaw รองรับโมเดล Gemini พร้อม [การยึดโยงกับ Google Search ในตัว](<https://ai.google.dev/gemini-api/docs/grounding>) ซึ่งส่งคืนคำตอบที่ AI สังเคราะห์ขึ้นโดยอ้างอิงผลลัพธ์ Google Search แบบสดพร้อม การอ้างอิงแหล่งที่มา

## รับคีย์ API

* ### Create a key

ไปที่ [Google AI Studio](<https://aistudio.google.com/apikey>) แล้วสร้าง คีย์ API

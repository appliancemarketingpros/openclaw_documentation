...
Hooks can also be bundled inside plugins; see [Plugin hooks](</plugins/architecture#provider-runtime-hooks>). Common uses:
...
Copy
[code]ls -la ~/.openclaw/hooks/my-hook/
...
Copy
[code]cat ~/.openclaw/hooks/my-hook/HOOK.md
...
Copy
[code]./scripts/clawlog.sh | grep hook
...
Copy
[code]mkdir -p ~/.openclaw/hooks/my-hook
...
[OpenProse](</prose>)[Standing Orders](</automation/standing-orders>)

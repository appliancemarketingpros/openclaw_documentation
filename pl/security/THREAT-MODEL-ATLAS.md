...
source_url: https://docs.openclaw.ai/pl/security/THREAT-MODEL-ATLAS
scraped_at: 2026-05-25
---

## Struktura MITRE ATLAS

**Wersja:** 1.0-draft **Ostatnia aktualizacja:** 2026-02-04 **Metodologia:** MITRE ATLAS + diagramy przepływu danych **Struktura:** [MITRE ATLAS](<https://atlas.mitre.org/>) (Adversarial Threat Landscape for AI Systems)
...
Wymagany [SKILL.md](<http://SKILL.md>) | Obowiązkowy plik readme | Niska wartość bezpieczeństwa - Tylko informacyjny  
...
_Ten model zagrożeń jest żywym dokumentem. Zgłaszaj problemy z bezpieczeństwem na adres[security@openclaw.ai](<mailto:security@openclaw.ai>)_

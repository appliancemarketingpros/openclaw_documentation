...
source_url: https://docs.openclaw.ai/tr/tools/thinking
...
## Ne işe yarar
  ...
  * Sağlayıcı notları: 
    ...
    * [Z.AI](<http://Z.AI>) (`zai/*`) yalnızca ikili düşünmeyi (`on`/`off`) destekler. `off` olmayan her seviye `on` olarak ele alınır (`low` değerine eşlenir).

...
source_url: https://docs.openclaw.ai/pt-BR/providers
scraped_at: 2026-05-25
---

OpenClaw pode usar muitos provedores de LLM. Escolha um provedor, autentique-se e defina o modelo padrão como `provider/model`.

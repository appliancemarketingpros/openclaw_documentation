...
source_url: https://docs.openclaw.ai/fa/gateway/logging
...
**جزئیات بیشتر در برابر سطوح لاگ**
  ...
  * لاگ‌گیری trace همچنین خلاصه‌های زمان‌بندی تشخیصی برای مسیرهای داغ منتخب را شامل می‌شود، مانند آماده‌سازی کارخانه ابزار Plugin. ببینید [/tools/plugin#slow-plugin-tool-setup](</fa/tools/plugin#slow-plugin-tool-setup>).

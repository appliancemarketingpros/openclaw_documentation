...
source_url: https://docs.openclaw.ai/pt-BR/gateway/security/audit-checks
scraped_at: 2026-05-25
---

`openclaw security audit` emite constatações estruturadas identificadas por `checkId`. Esta página é o catálogo de referência para esses IDs. Para o modelo de ameaças de alto nível e as orientações de reforço de segurança, consulte [Segurança](</pt-BR/gateway/security>).

Valores de `checkId` de alta relevância que você provavelmente verá em implantações reais (não exaustivo):

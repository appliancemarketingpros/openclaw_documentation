...
source_url: https://docs.openclaw.ai/zh-CN/security/THREAT-MODEL-ATLAS
scraped_at: 2026-05-25
---

## MITRE ATLAS 框架

**版本：** 1.0-draft **最后更新：** 2026-02-04 **方法论：** MITRE ATLAS + 数据流图 **框架：** [MITRE ATLAS](<https://atlas.mitre.org/>)（AI 系统对抗性威胁态势）
...
必需的 [SKILL.md](<http://SKILL.md>) | 强制自述文件 | 安全价值低 - 仅作信息说明  
...
_此威胁模型是一份持续更新的文档。请将安全问题报告至[security@openclaw.ai](<mailto:security@openclaw.ai>)_

---
title: TUI
source_url: https://docs.openclaw.ai/pl/cli/tui
scraped_at: 2026-05-25
---

# `openclaw tui`

Otwórz terminalowy UI połączony z Gateway albo uruchom go w lokalnym trybie osadzonym.
...
Użyj trybu lokalnego, gdy bieżąca konfiguracja już przechodzi walidację i chcesz, aby osadzony agent ją sprawdził, porównał z dokumentacją oraz pomógł ją naprawić z tego samego terminala:

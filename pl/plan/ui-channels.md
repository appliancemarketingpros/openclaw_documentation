...
source_url: https://docs.openclaw.ai/pl/plan/ui-channels
...
Kanoniczna dokumentacja znajduje się teraz w [Prezentacji wiadomości](</pl/plugins/message-presentation>). Zachowaj ten plan jako historyczny kontekst implementacji; w przypadku zmian kontraktu, renderera lub zachowania awaryjnego aktualizuj kanoniczny przewodnik.

...
source_url: https://docs.openclaw.ai/hi/gateway/background-process
...
व्यवहार:
  ...
  * लंबे समय तक चलने वाले ऐसे काम के लिए जो अभी शुरू होता है, उसे एक बार शुरू करें और सक्षम होने पर automatic completion wake पर भरोसा करें, जब कमांड आउटपुट देता है या विफल होता है।
  * यदि automatic completion wake उपलब्ध नहीं है, या आपको ऐसे कमांड के लिए quiet-success पुष्टि चाहिए जो बिना आउटपुट के साफ़ तौर पर समाप्त हुआ, तो पूर्णता की पुष्टि के लिए `process` का उपयोग करें।
  * reminders या विलंबित follow-ups को `sleep` loops या बार-बार polling से emulate न करें; भविष्य के काम के लिए cron का उपयोग करें।
...
नोट्स:
  ...
  * automatic completion wake अनुपलब्ध होने पर status, logs, quiet-success confirmation, या completion confirmation के लिए `poll` / `log` का उपयोग करें।
  * interactive CLI recover करने से पहले `log` का उपयोग करें ताकि वर्तमान transcript, stdin state, और input-wait hint साथ में दिखाई दें।
  ...
  * `process list`, `poll`, और `log` `waitingForInput` केवल तब report करते हैं जब session में अभी भी writable stdin हो और वह input-wait threshold से अधिक समय तक idle रहा हो।
  ...
  * Polling on-demand status के लिए है, wait-loop scheduling के लिए नहीं। यदि काम बाद में होना चाहिए, तो इसके बजाय cron का उपयोग करें।

...
source_url: https://docs.openclaw.ai/ar/concepts/personal-agent-benchmark-pack
scraped_at: 2026-06-29
---

AgentsFundamentals

حزمة معيار الوكيل الشخصي هي حزمة صغيرة لسيناريوهات QA مدعومة بمستودع لسير عمل المساعد الشخصي المحلي. وهي ليست معيارًا عامًا للنماذج ولا تتطلب مشغّلًا جديدًا. تعيد الحزمة استخدام مكدس QA الخاص الموضح في [نظرة عامة على QA](</ar/concepts/qa-e2e-automation>)، و[قناة QA](</ar/channels/qa-channel>) الاصطناعية، وكتالوج YAML الحالي `qa/scenarios`.

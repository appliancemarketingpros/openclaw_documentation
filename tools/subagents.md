...
See [Configuration Reference](</gateway/configuration-reference>) and [Slash commands](</tools/slash-commands>) for current adapter details. Allowlist:
...
[Agent Send](</tools/agent-send>)[ACP Agents](</tools/acp-agents>)

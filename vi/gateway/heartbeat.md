---
title: Heartbeat
source_url: https://docs.openclaw.ai/vi/gateway/heartbeat
...
## [HEARTBEAT.md](<http://HEARTBEAT.md>) (tùy chọn)
...
### Agent có thể cập nhật [HEARTBEAT.md](<http://HEARTBEAT.md>) không?
...
Nếu bạn muốn việc này xảy ra chủ động, bạn cũng có thể đưa một dòng rõ ràng vào lời nhắc Heartbeat, chẳng hạn: "Nếu danh sách kiểm tra trở nên lỗi thời, hãy cập nhật [HEARTBEAT.md](<http://HEARTBEAT.md>) bằng một danh sách tốt hơn."

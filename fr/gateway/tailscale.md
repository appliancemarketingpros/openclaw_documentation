---
title: Tailscale
source_url: https://docs.openclaw.ai/fr/gateway/tailscale
...
Si vous exécutez le Gateway sur une machine mais souhaitez piloter un navigateur sur une autre machine, exécutez un **hôte de nœud** sur la machine du navigateur et gardez les deux sur le même tailnet. Le Gateway transmettra les actions du navigateur au nœud ; aucun serveur de contrôle séparé ni URL Serve n’est nécessaire.
...
## En savoir plus
  ...
  * Vue d’ensemble de Tailscale Funnel : <https://tailscale.com/kb/1223/tailscale-funnel>

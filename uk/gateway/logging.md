...
source_url: https://docs.openclaw.ai/uk/gateway/logging
...
**Докладність проти рівнів журналювання**
  ...
  * Trace-журналювання також включає діагностичні підсумки часу виконання для вибраних гарячих шляхів, наприклад підготовки фабрики інструментів Plugin. Див. [/tools/plugin#slow-plugin-tool-setup](</uk/tools/plugin#slow-plugin-tool-setup>).

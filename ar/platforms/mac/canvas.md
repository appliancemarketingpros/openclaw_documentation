---
title: لوحة الرسم
source_url: https://docs.openclaw.ai/ar/platforms/mac/canvas
scraped_at: 2026-05-25
---

يتضمن تطبيق macOS لوحة **Canvas** يتحكم بها الوكيل باستخدام `WKWebView`. وهي مساحة عمل مرئية خفيفة لـ HTML/CSS/JS وA2UI وأسطح UI تفاعلية صغيرة.
...
يمكن تعطيل Canvas من الإعدادات → **السماح بـ Canvas**. عند تعطيله، تُرجع أوامر node الخاصة بـ canvas القيمة `CANVAS_DISABLED`.
...
تستضيف Gateway مضيف canvas الخاص بـ A2UI ويُعرَض داخل لوحة Canvas. عندما تعلن Gateway عن مضيف Canvas، ينتقل تطبيق macOS تلقائيًا إلى صفحة مضيف A2UI عند أول فتح.

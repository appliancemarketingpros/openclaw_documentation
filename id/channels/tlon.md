---
title: Tlon
source_url: https://docs.openclaw.ai/id/channels/tlon
...
Ship pemilik **secara otomatis diotorisasi di mana saja** — undangan DM diterima otomatis dan pesan channel selalu diizinkan. Anda tidak perlu menambahkan pemilik ke `dmAllowlist` atau `defaultAuthorizedShips`.
...
`autoAcceptGroupInvites` gagal tertutup ketika `groupInviteAllowlist` kosong. Atur daftar izin ke ship yang undangan grupnya harus diterima secara otomatis.
...
Plugin Tlon menyertakan skill terbundel ([`@tloncorp/tlon-skill`](<https://github.com/tloncorp/tlon-skill>)) yang menyediakan akses CLI ke operasi Tlon:

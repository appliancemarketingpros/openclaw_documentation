...
source_url: https://docs.openclaw.ai/pt-BR/start/hubs
scraped_at: 2026-05-25
---

Use estes hubs para descobrir todas as páginas, incluindo aprofundamentos e documentação de referência que não aparecem na navegação à esquerda.
...
## Comece aqui
  ...
  * [Vitrine](</pt-BR/start/showcase>)
  * [História](</pt-BR/start/lore>)
...
## Conceitos centrais
  ...
  * [Arquitetura](</pt-BR/concepts/architecture>)
  * [Recursos](</pt-BR/concepts/features>)
  * [Hub de rede](</pt-BR/network>)
  ...
  * [Streaming + divisão em blocos](</pt-BR/concepts/streaming>)
...
## Gateway + operações
  ...
  * [Modelo de rede](</pt-BR/network#core-model>)
...
## Ferramentas + automação
  ...
  * [Thinking + verboso](</pt-BR/tools/thinking>)
  * [Modelos](</pt-BR/concepts/models>)
  * [Subagentes](</pt-BR/tools/subagents>)
  * [CLI de envio para agente](</pt-BR/tools/agent-send>)
...
## Nodes, mídia, voz
  ...
  * [Modo conversa](</pt-BR/nodes/talk>)


## Plataformas

  * [Visão geral das plataformas](</pt-BR/platforms>)
  * [macOS](</pt-BR/platforms/macos>)
...
## Aplicativo complementar para macOS (avançado)
  ...
  * [Integridade no macOS](</pt-BR/platforms/mac/health>)
  ...
  * [Gateway macOS (launchd)](</pt-BR/platforms/mac/bundled-gateway>)
...
## Plugins
  ...
  * [Pacotes de Plugin](</pt-BR/plugins/bundles>)
...
## Workspace + templates
  ...
  * [AGENTS padrão](</pt-BR/reference/AGENTS.default>)
  * [Templates: AGENTS](</pt-BR/reference/templates/AGENTS>)
  * [Templates: BOOTSTRAP](</pt-BR/reference/templates/BOOTSTRAP>)
  * [Templates: HEARTBEAT](</pt-BR/reference/templates/HEARTBEAT>)
  * [Templates: IDENTITY](</pt-BR/reference/templates/IDENTITY>)
  * [Templates: SOUL](</pt-BR/reference/templates/SOUL>)
  * [Templates: TOOLS](</pt-BR/reference/templates/TOOLS>)
  * [Templates: USER](</pt-BR/reference/templates/USER>)

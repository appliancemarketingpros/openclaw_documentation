...
source_url: https://docs.openclaw.ai/nl/tools/browser-wsl2-windows-remote-cdp-troubleshooting
...
Kies dit wanneer:
  ...
  * je geen geavanceerde beheerde/alleen-raw-CDP-routes nodig hebt, zoals `responsebody`, PDF- export, downloadinterceptie of batchacties

...
OpenClaw コアは TypeScript で書かれています。**Node が推奨ランタイムです** 。 Bun は Gateway には推奨されません。WhatsApp と Telegram チャネルで既知の問題があります。詳細は [Bun (実験的)](</ja-JP/install/bun>) を参照してください。
...
## VPS とホスティング
  ...
  * [Fly.io](<http://Fly.io>): [Fly.io](</ja-JP/install/fly>)

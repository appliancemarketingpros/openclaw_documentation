...
source_url: https://docs.openclaw.ai/pl/providers
scraped_at: 2026-05-25
---

OpenClaw może używać wielu dostawców LLM. Wybierz dostawcę, uwierzytelnij się, a następnie ustaw model domyślny jako `provider/model`.
...
Pełny katalog dostawców (xAI, Groq, Mistral itd.) i konfigurację zaawansowaną znajdziesz w [Dostawcy modeli](</pl/concepts/model-providers>).

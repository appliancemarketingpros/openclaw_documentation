---
title: Міст Peekaboo
source_url: https://docs.openclaw.ai/uk/platforms/mac/peekaboo
...
OpenClaw має три шляхи керування робочим столом, і вони навмисно залишаються окремими:
  ...
  * **Хост PeekabooBridge** : OpenClaw.app може розміщувати локальний сокет PeekabooBridge. CLI `peekaboo` залишається клієнтом і використовує дозволи macOS застосунку OpenClaw.app для примітивів автоматизації Peekaboo, таких як знімки екрана, кліки, меню, діалогові вікна, дії Dock і керування вікнами.

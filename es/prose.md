---
title: OpenProse
source_url: https://docs.openclaw.ai/es/prose
...
`/prose run <handle/slug>` se resuelve como `https://p.prose.md/<handle>/<slug>`. Las URL directas se obtienen tal cual. Esto usa la herramienta `web_fetch` (o `exec` para POST).

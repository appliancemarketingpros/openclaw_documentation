---
title: Başlangıç referansı
source_url: https://docs.openclaw.ai/tr/reference/wizard
scraped_at: 2026-05-25
---

Bu, `openclaw onboard` için tam referanstır. Üst düzey genel bakış için bkz. [İlk kurulum (CLI)](</tr/start/wizard>).
...
* ### Kanallar
  ...
  * [iMessage](</tr/channels/imessage>): `imsg` CLI yolu + Messages DB erişimi; Gateway Mac dışında çalışırken bir SSH wrapper kullanın.
...
Sağlayıcıya özgü komut örnekleri [CLI Otomasyonu](</tr/start/wizard-cli-automation#provider-specific-examples>) içinde bulunur. Bayrak anlamları ve adım sıralaması için bu referans sayfasını kullanın.

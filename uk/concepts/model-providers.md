...
source_url: https://docs.openclaw.ai/uk/concepts/model-providers
...
Додавання автентифікації постачальника не змінює вашу основну модель
...
Розділення постачальника й runtime OpenAI
...
### Anthropic
  ...
  * Бажана конфігурація Claude CLI зберігає посилання на модель канонічним і вибирає CLI бекенд окремо: `anthropic/claude-opus-4-7` з model-scoped `agentRuntime.id: "claude-cli"`. Застарілі посилання `claude-cli/claude-opus-4-7` усе ще працюють для сумісності.
...
[**Моделі GLM** [Z.AI](<http://Z.AI>) Coding Plan або загальні API-ендпоїнти. ](</uk/providers/glm>) [**MiniMax** MiniMax Coding Plan OAuth або доступ за API-ключем. ](</uk/providers/minimax>) [**Qwen Cloud** Поверхня постачальника Qwen Cloud плюс зіставлення ендпоїнтів Alibaba DashScope і Coding Plan. ](</uk/providers/qwen>)
...
### [Z.AI](<http://Z.AI>) (GLM)
  ...
  * CLI: `openclaw onboard --auth-choice zai-api-key`
    ...
    * `zai-api-key` автоматично визначає відповідну кінцеву точку [Z.AI](<http://Z.AI>); `zai-coding-global`, `zai-coding-cn`, `zai-global` і `zai-cn` примусово задають конкретну поверхню

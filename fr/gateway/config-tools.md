...
source_url: https://docs.openclaw.ai/fr/gateway/config-tools
...
Utilisez `cerebras/zai-glm-4.7` pour Cerebras ; `zai/glm-4.7` pour [Z.AI](<http://Z.AI>) direct.

Codage Kimi json5Copy code
[code]
...
Synthetic (compatible avec Anthropic) json5Copy code
[code]

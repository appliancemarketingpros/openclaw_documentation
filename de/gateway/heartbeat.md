---
title: Heartbeat
source_url: https://docs.openclaw.ai/de/gateway/heartbeat
...
Sichtbarkeit und Überspringverhalten
...
## [HEARTBEAT.md](<http://HEARTBEAT.md>) (optional)
...
### Kann der Agent [HEARTBEAT.md](<http://HEARTBEAT.md>) aktualisieren?
...
Wenn dies proaktiv geschehen soll, können Sie auch eine explizite Zeile in Ihren Heartbeat-Prompt aufnehmen, etwa: „Wenn die Checkliste veraltet ist, aktualisieren Sie [HEARTBEAT.md](<http://HEARTBEAT.md>) mit einer besseren.“

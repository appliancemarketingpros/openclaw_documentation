---
title: پرامپت سیستم
source_url: https://docs.openclaw.ai/fa/concepts/system-prompt
...
اگر می‌خواهید لحن عامل کمتر عمومی به نظر برسد، با [راهنمای شخصیت SOUL.md](</fa/concepts/soul>) شروع کنید.
...
این جداسازی، اندازه‌گذاری Skills را از اندازه‌گذاری خواندن/تزریق زمان اجرا مانند `memory_get`، نتایج زنده ابزار، و بازخوانی‌های [AGENTS.md](<http://AGENTS.md>) پس از Compaction جدا نگه می‌دارد.

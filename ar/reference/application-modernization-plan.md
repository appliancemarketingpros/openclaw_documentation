...
source_url: https://docs.openclaw.ai/ar/reference/application-modernization-plan
...
استخدم هذا القسم لتحديث `SKILL.md` المركّز على الواجهة الأمامية والمرفق مع مهمة التحديث. إذا كنت ستعتمد هذا التوجيه كمهارة OpenClaw محلية للمستودع، فأنشئ `.agents/skills/openclaw-frontend/SKILL.md` أولًا، وأبقِ المقدمة التي تخص تلك المهارة المستهدفة، ثم أضف أو استبدل إرشادات المتن بالمحتوى التالي.

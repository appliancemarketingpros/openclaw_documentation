---
title: Heartbeat
source_url: https://docs.openclaw.ai/zh-TW/gateway/heartbeat
...
## [HEARTBEAT.md](<http://HEARTBEAT.md>)（選用）
...
### 代理可以更新 [HEARTBEAT.md](<http://HEARTBEAT.md>) 嗎？
...
如果你希望這件事主動發生，也可以在 Heartbeat 提示中包含明確的一行，例如："If the checklist becomes stale, update [HEARTBEAT.md](<http://HEARTBEAT.md>) with a better one."

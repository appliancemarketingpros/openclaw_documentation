...
source_url: https://docs.openclaw.ai/fr/install/migrating
...
[**Migrating from Claude** Importez l’état de Claude Code et Claude Desktop, notamment `CLAUDE.md`, les serveurs MCP, les skills et les commandes de projet. ](</fr/install/migrating-claude>) [**Migrating from Hermes** Importez la configuration Hermes, les fournisseurs, les serveurs MCP, la mémoire, les skills et les clés `.env` prises en charge. ](</fr/install/migrating-hermes>)

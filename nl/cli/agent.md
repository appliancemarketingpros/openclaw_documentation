---
title: Agent
source_url: https://docs.openclaw.ai/nl/cli/agent
scraped_at: 2026-05-25
---

# `openclaw agent`

Voer een agent-turn uit via de Gateway (gebruik `--local` voor ingebed). Gebruik `--agent <id>` om direct een geconfigureerde agent te targeten.

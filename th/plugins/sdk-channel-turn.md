...
source_url: https://docs.openclaw.ai/th/plugins/sdk-channel-turn
...
แต่ละสเตจปล่อยอีเวนต์ล็อกแบบมีโครงสร้างเมื่อมีการส่งคอลแบ็ก `log` มาให้ ดู การสังเกตการณ์
...
ใช้เมื่อช่องทางแก้เส้นทางแล้ว, สร้าง `FinalizedMsgContext` แล้ว และต้องการเฉพาะการบันทึกร่วม, ไปป์ไลน์คำตอบ, การดิสแพตช์ และลำดับการสรุปปิดงาน นี่เป็นรูปแบบที่แนะนำสำหรับเส้นทางขาเข้าของบันเดิลแบบเรียบง่าย ที่มิฉะนั้นจะต้องทำโค้ดสำเร็จรูป `createChannelMessageReplyPipeline(...)` และ `runPrepared(...)` ซ้ำ

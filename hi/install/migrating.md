...
source_url: https://docs.openclaw.ai/hi/install/migrating
...
[**Claude से माइग्रेट करना** `CLAUDE.md`, MCP सर्वर, Skills, और प्रोजेक्ट कमांड सहित Claude Code और Claude Desktop की स्थिति आयात करें। ](</hi/install/migrating-claude>) [**Hermes से माइग्रेट करना** Hermes कॉन्फिग, प्रदाता, MCP सर्वर, मेमोरी, Skills, और समर्थित `.env` कुंजियां आयात करें। ](</hi/install/migrating-hermes>)

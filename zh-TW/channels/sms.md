---
title: SMS
source_url: https://docs.openclaw.ai/zh-TW/channels/sms
...
[**配對** SMS 的預設私訊政策是配對。 ](</zh-TW/channels/pairing>) [**閘道安全性** 檢閱網路鉤子暴露範圍與寄件者存取控制。 ](</zh-TW/gateway/security>) [**頻道疑難排解** 跨頻道診斷與修復操作手冊。 ](</zh-TW/channels/troubleshooting>)

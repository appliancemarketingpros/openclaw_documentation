---
title: السياق
source_url: https://docs.openclaw.ai/ar/concepts/context
...
[**محرك السياق** حقن سياق مخصص عبر plugins. ](</ar/concepts/context-engine>) [**Compaction** تلخيص المحادثات الطويلة لإبقائها داخل نافذة النموذج. ](</ar/concepts/compaction>) [**موجّه النظام** كيف يُبنى موجّه النظام وما الذي يحقنه في كل دور. ](</ar/concepts/system-prompt>) [**حلقة الوكيل** دورة تنفيذ الوكيل الكاملة من الرسالة الواردة إلى الرد النهائي. ](</ar/concepts/agent-loop>)

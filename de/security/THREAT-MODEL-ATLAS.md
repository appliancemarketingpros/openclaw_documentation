...
source_url: https://docs.openclaw.ai/de/security/THREAT-MODEL-ATLAS
scraped_at: 2026-05-25
---

## MITRE-ATLAS-Framework

**Version:** 1.0-draft **Zuletzt aktualisiert:** 2026-02-04 **Methodik:** MITRE ATLAS + Datenflussdiagramme **Framework:** [MITRE ATLAS](<https://atlas.mitre.org/>) (Adversarial Threat Landscape for AI Systems)
...
Erforderliche [SKILL.md](<http://SKILL.md>) | Obligatorische Readme | Geringer Sicherheitswert - Nur informativ  
...
_Dieses Bedrohungsmodell ist ein lebendes Dokument. Melden Sie Sicherheitsprobleme an[security@openclaw.ai](<mailto:security@openclaw.ai>)_

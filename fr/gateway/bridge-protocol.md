...
source_url: https://docs.openclaw.ai/fr/gateway/bridge-protocol
...
Le pont était une **v1 implicite** (pas de négociation min/max). Cette section est une référence historique uniquement ; les clients actuels de nœud/opérateur utilisent le WebSocket [Gateway Protocol](</fr/gateway/protocol>).

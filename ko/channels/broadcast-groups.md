---
title: 브로드캐스트 그룹
source_url: https://docs.openclaw.ai/ko/channels/broadcast-groups
...
브로드캐스트 그룹의 각 에이전트는 다음을 완전히 별도로 유지합니다.
  ...
  * **메모리/컨텍스트**(별도 [IDENTITY.md](<http://IDENTITY.md>), [SOUL.md](<http://SOUL.md>) 등)

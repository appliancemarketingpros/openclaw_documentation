...
source_url: https://docs.openclaw.ai/th/gateway/configuration-examples
...
ใช้ส่วนนี้เมื่อรูท skill ในตัวมี symlink ไปยังรีโปพี่น้อง เช่น `~/.agents/skills/manager -> ~/Projects/manager/skills`
...
[/code]
  ...
  * `allowSymlinkTargets` อนุญาตให้โฟลเดอร์ skill ที่เป็น symlink แก้ไปยัง รูทเป้าหมายจริงที่เชื่อถือได้นั้น โดยไม่อนุญาตให้ symlink หลุดออกไปที่ใดก็ได้
...
สำหรับ Discord/Slack/Google Chat/Microsoft Teams/Mattermost/IRC การอนุญาตผู้ส่งจะอิง ID เป็นหลักโดยค่าเริ่มต้น เปิดใช้การจับคู่ชื่อ/อีเมล/ชื่อเล่นที่เปลี่ยนแปลงได้โดยตรงด้วย `dangerouslyAllowNameMatching: true` ของแต่ละช่องทาง เฉพาะเมื่อคุณยอมรับความเสี่ยงนั้นอย่างชัดเจนเท่านั้น

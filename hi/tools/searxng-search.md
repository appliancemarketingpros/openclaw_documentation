---
title: SearXNG खोज
source_url: https://docs.openclaw.ai/hi/tools/searxng-search
scraped_at: 2026-06-29
---

CapabilitiesTools

OpenClaw [SearXNG](<https://docs.searxng.org/>) को **स्व-होस्टेड, कुंजी-मुक्त** `web_search` प्रदाता के रूप में सपोर्ट करता है। SearXNG एक ओपन-सोर्स मेटा-सर्च इंजन है जो Google, Bing, DuckDuckGo, और अन्य स्रोतों से परिणाम एकत्र करता है।
...
या कोई भी मौजूदा SearXNG डिप्लॉयमेंट उपयोग करें जिसकी आपको पहुँच है। उत्पादन सेटअप के लिए [SearXNG दस्तावेज़](<https://docs.searxng.org/>) देखें।

---
title: Venice AI
source_url: https://docs.openclaw.ai/ko/providers/venice
...
비공개 모델(26개) — 완전 비공개, 로깅 없음 모델 ID | 이름 | 컨텍스트 | 기능  
---|---|---|---  
...
익명화 모델(15개) — Venice 프록시 경유 모델 ID | 이름 | 컨텍스트 | 기능  
---|---|---|---  
...
[**모델 선택** 제공자, 모델 참조, 장애 조치 동작을 선택합니다. ](</ko/concepts/model-providers>) [**Venice AI** Venice AI 홈페이지 및 계정 가입. ](<https://venice.ai>) [**API 문서** Venice API 참조 및 개발자 문서. ](<https://docs.venice.ai>) [**가격** 현재 Venice 크레딧 요금 및 플랜. ](<https://venice.ai/pricing>)

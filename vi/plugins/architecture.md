---
title: Nội bộ Plugin
source_url: https://docs.openclaw.ai/vi/plugins/architecture
...
[**Cài đặt và sử dụng Plugin** Hướng dẫn dành cho người dùng cuối về cách thêm, bật và khắc phục sự cố Plugin. ](</vi/tools/plugin>) [**Xây dựng Plugin** Hướng dẫn tạo Plugin đầu tiên với manifest hoạt động nhỏ nhất. ](</vi/plugins/building-plugins>) [**Plugin kênh** Xây dựng Plugin kênh nhắn tin. ](</vi/plugins/sdk-channel-plugins>) [**Plugin nhà cung cấp** Xây dựng Plugin nhà cung cấp mô hình. ](</vi/plugins/sdk-provider-plugins>) [**Tổng quan SDK** Tham chiếu bản đồ import và API đăng ký. ](</vi/plugins/sdk-overview>)
...
Thực thi đăng ký thời gian chạy

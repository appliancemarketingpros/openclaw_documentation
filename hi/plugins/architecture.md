...
source_url: https://docs.openclaw.ai/hi/plugins/architecture
...
[**Plugin इंस्टॉल और उपयोग करें** Plugin जोड़ने, सक्षम करने और समस्या निवारण के लिए अंतिम-उपयोगकर्ता गाइड। ](</hi/tools/plugin>) [**Plugin बनाना** सबसे छोटे कार्यशील मैनिफेस्ट के साथ पहला-Plugin ट्यूटोरियल। ](</hi/plugins/building-plugins>) [**Channel Plugin** एक मैसेजिंग चैनल Plugin बनाएं। ](</hi/plugins/sdk-channel-plugins>) [**Provider Plugin** एक मॉडल provider Plugin बनाएं। ](</hi/plugins/sdk-provider-plugins>) [**SDK अवलोकन** इम्पोर्ट मैप और registration API संदर्भ। ](</hi/plugins/sdk-overview>)

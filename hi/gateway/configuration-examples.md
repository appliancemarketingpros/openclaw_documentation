...
source_url: https://docs.openclaw.ai/hi/gateway/configuration-examples
...
सेट न होने पर यह बंद रहता है। यह केवल नए `role: node` पेयरिंग पर लागू होता है, जिसमें कोई अनुरोधित स्कोप नहीं हो। ऑपरेटर/ब्राउज़र क्लाइंट और भूमिका, स्कोप, मेटाडेटा, या पब्लिक-की अपग्रेड के लिए अभी भी मैनुअल अनुमोदन आवश्यक है।
...
Discord/Slack/Google Chat/Microsoft Teams/Mattermost/IRC के लिए, भेजने वाले का प्राधिकरण डिफ़ॉल्ट रूप से पहले ID पर आधारित होता है। हर चैनल के `dangerouslyAllowNameMatching: true` के साथ सीधे परिवर्तनीय नाम/ईमेल/निक मिलान को केवल तभी सक्षम करें जब आप स्पष्ट रूप से उस जोखिम को स्वीकार करते हों।

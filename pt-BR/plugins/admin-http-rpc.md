...
source_url: https://docs.openclaw.ai/pt-BR/plugins/admin-http-rpc
...
## Métodos permitidos
  ...
  * descoberta: `commands.list` Retorna os nomes de métodos RPC HTTP permitidos por este Plugin.

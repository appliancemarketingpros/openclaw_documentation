...
source_url: https://docs.openclaw.ai/vi/gateway/local-model-services
...
## Cách hoạt động
  ...
  7. Nếu OpenClaw đã khởi động tiến trình và `idleStopMs` là số dương, tiến trình sẽ dừng sau khi yêu cầu đang xử lý cuối cùng đã nhàn rỗi trong khoảng thời gian đó.
...
[**Local models** Thiết lập mô hình cục bộ, lựa chọn nhà cung cấp và hướng dẫn an toàn. ](</vi/gateway/local-models>) [**Inferrs** Chạy OpenClaw qua máy chủ cục bộ tương thích OpenAI của inferrs. ](</vi/providers/inferrs>)

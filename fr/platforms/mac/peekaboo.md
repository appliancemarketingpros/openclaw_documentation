...
source_url: https://docs.openclaw.ai/fr/platforms/mac/peekaboo
...
OpenClaw dispose de trois chemins de contrôle du bureau, et ils restent volontairement séparés :
  ...
  * **Hôte PeekabooBridge** : OpenClaw.app peut héberger le socket PeekabooBridge local. La CLI `peekaboo` reste le client et utilise les autorisations macOS d’OpenClaw.app pour les primitives d’automatisation Peekaboo telles que les captures d’écran, les clics, les menus, les boîtes de dialogue, les actions du Dock et la gestion des fenêtres.
...
Les instantanés sont stockés en mémoire et expirent automatiquement après une courte période. Si vous avez besoin d’une conservation plus longue, effectuez une nouvelle capture depuis le client.

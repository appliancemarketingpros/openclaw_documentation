---
title: Konteks
source_url: https://docs.openclaw.ai/id/concepts/context
...
[**Mesin konteks** Injeksi konteks kustom melalui plugin. ](</id/concepts/context-engine>) [**Compaction** Meringkas percakapan panjang agar tetap berada di dalam jendela model. ](</id/concepts/compaction>) [**Prompt sistem** Cara prompt sistem dibangun dan apa yang disisipkan setiap giliran. ](</id/concepts/system-prompt>) [**Loop agen** Siklus eksekusi agen lengkap dari pesan masuk hingga balasan akhir. ](</id/concepts/agent-loop>)

---
title: ClawDock
source_url: https://docs.openclaw.ai/es/install/clawdock
...
[**Docker** Instalación canónica de Docker para OpenClaw. ](</es/install/docker>) [**Runtime de VM de Docker** Runtime de VM administrado por Docker para aislamiento reforzado. ](</es/install/docker-vm-runtime>) [**Actualización** Actualización del paquete de OpenClaw y los servicios administrados. ](</es/install/updating>)

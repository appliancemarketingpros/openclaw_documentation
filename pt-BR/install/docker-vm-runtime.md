...
source_url: https://docs.openclaw.ai/pt-BR/install/docker-vm-runtime
...
Se o build falhar com `Killed` ou `exit code 137` durante `pnpm install --frozen-lockfile`, a VM está sem memória. Use uma classe de máquina maior antes de tentar novamente.

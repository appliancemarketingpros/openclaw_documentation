---
title: मॉडल प्रदाता
source_url: https://docs.openclaw.ai/hi/concepts/model-providers
...
Provider auth जोड़ने से आपका primary model नहीं बदलता
...
OpenAI provider/runtime विभाजन
...
### Anthropic
  ...
  * Preferred Claude CLI config model ref को canonical रखता है और CLI backend को अलग से चुनता है: `anthropic/claude-opus-4-8` के साथ model-scoped `agentRuntime.id: "claude-cli"`। Legacy `claude-cli/claude-opus-4-7` refs compatibility के लिए अब भी काम करते हैं।
...
[**Z.AI (GLM)** Z.AI Coding Plan या general API endpoints। ](</hi/providers/zai>) [**MiniMax** MiniMax Coding Plan OAuth या API key access। ](</hi/providers/minimax>) [**Qwen Cloud** Qwen Cloud provider surface plus Alibaba DashScope और Coding Plan endpoint mapping। ](</hi/providers/qwen>)
...
* ### प्रोजेक्ट सेट करें (यदि आवश्यक हो)

यदि लॉगिन के बाद अनुरोध विफल हों, तो Gateway होस्ट पर `GOOGLE_CLOUD_PROJECT` या `GOOGLE_CLOUD_PROJECT_ID` सेट करें।

Gemini CLI डिफ़ॉल्ट रूप से `stream-json` का उपयोग करता है। OpenClaw assistant stream संदेश पढ़ता है और `stats.cached` को `cacheRead` में सामान्यीकृत करता है; लेगेसी `--output-format json` ओवरराइड अब भी `response` से उत्तर टेक्स्ट पढ़ते हैं।
...
Ollama एक bundled provider Plugin के रूप में शिप होता है और Ollama के native API का उपयोग करता है:
  ...
  * इंस्टॉलेशन: <https://ollama.com/download>

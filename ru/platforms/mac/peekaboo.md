---
title: Мост Peekaboo
source_url: https://docs.openclaw.ai/ru/platforms/mac/peekaboo
...
У OpenClaw есть три пути управления рабочим столом, и они намеренно остаются раздельными:
  ...
  * **Хост PeekabooBridge** : OpenClaw.app может размещать локальный сокет PeekabooBridge. CLI `peekaboo` остается клиентом и использует разрешения macOS OpenClaw.app для примитивов автоматизации Peekaboo, таких как снимки экрана, щелчки, меню, диалоги, действия Dock и управление окнами.

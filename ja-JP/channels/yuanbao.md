---
title: Yuanbao
source_url: https://docs.openclaw.ai/ja-JP/channels/yuanbao
scraped_at: 2026-05-25
---

Tencent Yuanbao は Tencent の AI アシスタントプラットフォームです。OpenClaw チャンネル Plugin は Yuanbao ボットを WebSocket 経由で OpenClaw に接続し、ダイレクトメッセージやグループチャットで ユーザーとやり取りできるようにします。

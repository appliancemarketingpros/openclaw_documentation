---
title: Geçiş yapın
source_url: https://docs.openclaw.ai/tr/cli/migrate
...
OPENCLAW_DOCS_MARKER:paramOpen:IHBhdGg9Ijxwcm92aWRlcg " type="string"> Kayıtlı bir migration provider'ın adı, örneğin `hermes`. Yüklü provider'ları görmek için `openclaw migrate list` çalıştırın.

---
title: OpenProse
source_url: https://docs.openclaw.ai/tr/prose
...
`/prose run <handle/slug>`, `https://p.prose.md/<handle>/<slug>` adresine çözülür. Doğrudan URL’ler olduğu gibi getirilir. Bu, `web_fetch` aracını (veya POST için `exec`) kullanır.

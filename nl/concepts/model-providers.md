...
source_url: https://docs.openclaw.ai/nl/concepts/model-providers
...
[**GLM models** [Z.AI](<http://Z.AI>) Coding Plan of algemene API-eindpunten. ](</nl/providers/glm>) [**MiniMax** MiniMax Coding Plan OAuth of toegang via API-sleutel. ](</nl/providers/minimax>) [**Qwen Cloud** Qwen Cloud-providersurface plus Alibaba DashScope- en Coding Plan-eindpuntmapping. ](</nl/providers/qwen>)
...
Ollama wordt geleverd als gebundelde provider-Plugin en gebruikt Ollama's native API:
  ...
  * Installatie: <https://ollama.com/download>

---
title: डीबगिंग
source_url: https://docs.openclaw.ai/hi/help/debugging
...
**केवल-रनटाइम** कॉन्फिग ओवरराइड (मेमरी, डिस्क नहीं) सेट करने के लिए चैट में `/debug` का उपयोग करें। `/debug` डिफ़ॉल्ट रूप से अक्षम है; इसे `commands.debug: true` से सक्षम करें। यह तब उपयोगी है जब आपको `openclaw.json` संपादित किए बिना अस्पष्ट सेटिंग्स टॉगल करनी हों।
...
OpenClaw किसी भी filtering/formatting से पहले **raw assistant stream** log कर सकता है। यह देखने का सबसे अच्छा तरीका है कि reasoning plain text deltas के रूप में आ रही है या नहीं (या अलग thinking blocks के रूप में)।

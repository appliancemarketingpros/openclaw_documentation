...
source_url: https://docs.openclaw.ai/uk/providers/models
scraped_at: 2026-05-25
---

OpenClaw може використовувати багатьох постачальників LLM. Виберіть одного, автентифікуйтеся, а потім задайте стандартну модель як `provider/model`.

...
Copy
[code]openclaw agents list --bindings
...
Copy
[code]docker ps --filter "name=openclaw-sbx-"
...
Copy
[code]tail -f "${OPENCLAW_STATE_DIR:-$HOME/.openclaw}/logs/gateway.log" | grep -E "routing|sandbox|tools"

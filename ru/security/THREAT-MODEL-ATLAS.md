...
source_url: https://docs.openclaw.ai/ru/security/THREAT-MODEL-ATLAS
...
**Версия:** 1.0-draft **Последнее обновление:** 2026-02-04 **Методология:** MITRE ATLAS + диаграммы потоков данных **Фреймворк:** [MITRE ATLAS](<https://atlas.mitre.org/>) (ландшафт состязательных угроз для ИИ-систем)

...
source_url: https://docs.openclaw.ai/fa/nodes/camera
...
اگر مجوزها موجود نباشند، برنامه در صورت امکان درخواست می‌دهد؛ اگر رد شوند، درخواست‌های `camera.*` با خطای `*_PERMISSION_REQUIRED` شکست می‌خورند.

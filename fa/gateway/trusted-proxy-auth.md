...
source_url: https://docs.openclaw.ai/fa/gateway/trusted-proxy-auth
...
### پایان‌دهی TLS در پروکسی (توصیه‌شده)
...
Traefik با forward auth json5Copy code
[code]

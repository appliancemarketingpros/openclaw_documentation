...
source_url: https://docs.openclaw.ai/pl/concepts/agent-runtimes
...
Kontrakt obsługi środowiska uruchomieniowego Codex jest udokumentowany w [Środowisko uruchomieniowe harness Codex](</pl/plugins/codex-harness-runtime#v1-support-contract>).

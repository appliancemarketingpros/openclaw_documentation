...
source_url: https://docs.openclaw.ai/es/cli/infer
scraped_at: 2026-05-25
---

`openclaw infer` es la superficie canónica sin interfaz gráfica para flujos de trabajo de inferencia respaldados por proveedores.

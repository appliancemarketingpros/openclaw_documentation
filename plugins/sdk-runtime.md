...
**Looking for a walkthrough?** See [Channel Plugins](</plugins/sdk-channel-plugins>) or [Provider Plugins](</plugins/sdk-provider-plugins>) for step-by-step guides that show these helpers in context.
[code] 
    register(api) {
...
[Entry Points](</plugins/sdk-entrypoints>)[Agent Harness](</plugins/sdk-agent-harness>)

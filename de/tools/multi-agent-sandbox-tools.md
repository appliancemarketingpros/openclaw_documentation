...
source_url: https://docs.openclaw.ai/de/tools/multi-agent-sandbox-tools
...
[**Sandboxing** Backends und Modi — vollständige Sandbox-Referenz. ](</de/gateway/sandboxing>) [**Sandbox vs. Tool-Richtlinie vs. Elevated** Debugging von „warum ist das blockiert?“ ](</de/gateway/sandbox-vs-tool-policy-vs-elevated>) [**Elevated-Modus** Elevated exec für vertrauenswürdige Absender. ](</de/tools/elevated>)

* * *

## Konfigurationsbeispiele

Beispiel 1: Persönlicher Agent + eingeschränkter Familien-Agent jsonCopy code
[code]
...
Beispiel 2: Arbeits-Agent mit geteilter Sandbox jsonCopy code
[code]
...
Beispiel 2b: Globales Coding-Profil + Agent nur für Messaging jsonCopy code
[code]
...
Beispiel 3: Unterschiedliche Sandbox-Modi pro Agent jsonCopy code
[code]

---
title: Memoria
source_url: https://docs.openclaw.ai/es/cli/memory
scraped_at: 2026-05-25
---

# `openclaw memory`

Gestiona la indexación y búsqueda de memoria semántica. Proporcionado por el Plugin de Active Memory (predeterminado: `memory-core`; define `plugins.slots.memory = "none"` para deshabilitarlo).

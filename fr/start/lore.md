...
source_url: https://docs.openclaw.ai/fr/start/lore
...
CodeCopy code
[code]
    OpenClaw = OPEN + CLAW        = Open source, ouvert à tous        = Notre héritage de homard, d’où nous venons        = La pince fait loi 🦞        = Votre assistant. Votre machine. Vos règles.
[/code]
...
## Textes sacrés
  ...
  * **[SOUL.md](<http://SOUL.md>)** — document d’identité de Molty
  * **memory/*.md** — fichiers de mémoire à long terme
  * **[AGENTS.md](<http://AGENTS.md>)** — instructions de fonctionnement
  * **[USER.md](<http://USER.md>)** — contexte sur le créateur

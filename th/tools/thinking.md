---
title: ระดับการคิด
source_url: https://docs.openclaw.ai/th/tools/thinking
...
## สิ่งที่ทำ
  ...
  * หมายเหตุผู้ให้บริการ: 
    ...
    * [Z.AI](<http://Z.AI>) (`zai/*`) รองรับเฉพาะการคิดแบบไบนารี (`on`/`off`) ระดับใดก็ตามที่ไม่ใช่ `off` จะถือเป็น `on` (จับคู่กับ `low`)

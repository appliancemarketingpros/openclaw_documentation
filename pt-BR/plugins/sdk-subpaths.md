...
source_url: https://docs.openclaw.ai/pt-BR/plugins/sdk-subpaths
...
Channel subpaths Subcaminho | Exportações principais  
---|---  
...
Subcaminhos de provedores Subcaminho | Exportações principais  
---|---  
`plugin-sdk/provider-entry` | `defineSingleProviderPluginEntry`  
...
Subcaminhos de autenticação e segurança Subcaminho | Exportações principais  
---|---  
...
Subcaminhos de tempo de execução e armazenamento Subcaminho | Exportações principais  
---|---  
...
`plugin-sdk/provider-zai-endpoint` | Fachada obsoleta de detecção de endpoint pertencente ao provedor [Z.AI](<http://Z.AI>); use a API pública do Plugin [Z.AI](<http://Z.AI>)  
...
Subcaminhos de capacidade e teste Subcaminho | Exportações principais  
---|---  
...
Subcaminhos de memória Subcaminho | Exportações principais  
---|---  
...
Subcaminhos reservados de auxiliares incluídos

---
title: Azure
source_url: https://docs.openclaw.ai/fa/install/azure
...
* ### ثبت ارائه‌دهندگان منبع موردنیاز (یک‌باره)
...
* ### انتخاب اندازه VM و اندازه دیسک سیستم‌عامل

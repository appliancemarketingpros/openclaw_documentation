...
source_url: https://docs.openclaw.ai/de/concepts/memory-qmd
...
**QMD nicht gefunden?** Stellen Sie sicher, dass die Binärdatei im `PATH` des Gateway liegt. Wenn OpenClaw als Dienst läuft, erstellen Sie einen Symlink: `sudo ln -s ~/.bun/bin/qmd /usr/local/bin/qmd`.

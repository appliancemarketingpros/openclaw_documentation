---
title: Grok खोज
source_url: https://docs.openclaw.ai/hi/tools/grok-search
...
**क्रेडेंशियल विकल्प:** `openclaw models auth login --provider xai --method oauth` से साइन इन करें, Gateway वातावरण में `XAI_API_KEY` सेट करें, या `plugins.entries.xai.config.webSearch.apiKey` संग्रहीत करें। gateway इंस्टॉल के लिए, env vars को `~/.openclaw/.env` में रखें।

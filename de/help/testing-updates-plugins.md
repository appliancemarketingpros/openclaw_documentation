...
source_url: https://docs.openclaw.ai/de/help/testing-updates-plugins
...
Die breitere Übersicht der Test-Runner finden Sie unter [Testen](</de/help/testing>). Für Live-Provider- Schlüssel und Suites mit Netzwerkzugriff siehe [Live testen](</de/help/testing-live>).
...
Full Release Validation verwendet standardmäßig `source=artifact`, erstellt aus dem aufgelösten Release-SHA. Für Nachweise nach der Veröffentlichung übergeben Sie `package_acceptance_package_spec=openclaw@YYYY.M.D`, damit dieselbe Upgrade-Matrix stattdessen das ausgelieferte npm-Paket adressiert.

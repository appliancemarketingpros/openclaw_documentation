...
source_url: https://docs.openclaw.ai/nl/plugins/memory-lancedb
...
Gebruik voor Ollama-embeddings bij voorkeur de meegeleverde Ollama-embeddingprovider. Deze gebruikt het native Ollama `/api/embed`-eindpunt en volgt dezelfde auth-/basis-URL-regels als de Ollama-provider die is gedocumenteerd in [Ollama](</nl/providers/ollama>).

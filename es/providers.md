...
source_url: https://docs.openclaw.ai/es/providers
scraped_at: 2026-05-25
---

OpenClaw puede usar muchos proveedores de LLM. Elige un proveedor, autentícate y luego establece el modelo predeterminado como `provider/model`.

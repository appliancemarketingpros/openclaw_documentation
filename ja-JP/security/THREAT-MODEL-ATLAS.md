...
必須 [SKILL.md](<http://SKILL.md>) | 必須 readme | セキュリティ価値は低い - 情報提供のみ  
...
_この脅威モデルは継続的に更新されるドキュメントです。セキュリティ問題は[security@openclaw.ai](<mailto:security@openclaw.ai>) に報告してください_

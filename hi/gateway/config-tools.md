...
source_url: https://docs.openclaw.ai/hi/gateway/config-tools
...
दृश्यता scopes
  ...
  * जब `all` नहीं होता, `sessions_list` एक compact `visibility` फ़ील्ड शामिल करता है जो effective mode का वर्णन करता है और चेतावनी देता है कि कुछ sessions वर्तमान scope के बाहर छोड़े जा सकते हैं.
...
json5Copy code
[code]
    {  tools: {    sessions_spawn: {      attachments: {        enabled: false, // opt-in: inline file attachments की अनुमति देने के लिए true सेट करें        maxTotalBytes: 5242880, // सभी files में कुल 5 MB        maxFiles: 50,        maxFileBytes: 1048576, // प्रति file 1 MB        retainOnSessionKeep: false, // cleanup="keep" होने पर attachments रखें      },    },  },}
[/code]
...
json5Copy code
[code]
    {  tools: {    experimental: {      planTool: true, // experimental update_plan सक्षम करें    },  },}
[/code]
...
MiniMax M3 (direct) json5Copy code
[code]

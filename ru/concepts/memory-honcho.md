---
title: Память Honcho
source_url: https://docs.openclaw.ai/ru/concepts/memory-honcho
scraped_at: 2026-06-29
---

AgentsSessions and memory

[Honcho](<https://honcho.dev>) добавляет AI-нативную память в OpenClaw. Он сохраняет диалоги в выделенном сервисе и со временем строит модели пользователя и агента, давая вашему агенту межсессионный контекст, который выходит за пределы Markdown-файлов рабочей области.

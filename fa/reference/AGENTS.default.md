...
source_url: https://docs.openclaw.ai/fa/reference/AGENTS.default
...
[/code]
  ...
  3. اختیاری: اگر فهرست Skills دستیار شخصی را می‌خواهید، [AGENTS.md](<http://AGENTS.md>) را با این فایل جایگزین کنید:

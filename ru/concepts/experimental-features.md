...
source_url: https://docs.openclaw.ai/ru/concepts/experimental-features
scraped_at: 2026-06-29
---

AgentsFundamentals

Экспериментальные функции в OpenClaw — это **предварительные поверхности с явным включением**. Они находятся за явными флагами, потому что им еще нужен реальный опыт использования, прежде чем они заслужат стабильное значение по умолчанию или долгоживущий публичный контракт.

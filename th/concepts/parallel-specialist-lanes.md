...
source_url: https://docs.openclaw.ai/th/concepts/parallel-specialist-lanes
...
OpenClaw ทำการจัดลำดับรันต่อเซสชันอยู่แล้ว และจำกัดการทำงานแบบขนานส่วนกลางผ่าน [คิวคำสั่ง](</th/concepts/queue>) เลนผู้เชี่ยวชาญเพิ่มนโยบายไว้ด้านบน: เอเจนต์ใดเป็นเจ้าของงานใด สิ่งใดยังคงอยู่ในแชต และสิ่งใดกลายเป็นงานเบื้องหลัง
...
ใช้แชตโดยตรง/ส่วนตัวและเอเจนต์ปฏิบัติการโปรดักชันสำหรับงานที่มีลำดับความสำคัญสูง ให้ งานวิจัย การร่าง และการเขียนโค้ดเป็นชุดย้ายไปเป็นงานเบื้องหลังเมื่อระบบ ยุ่ง

...
source_url: https://docs.openclaw.ai/es/plugins/sdk-subpaths
...
Subrutas de canal Subruta | Exportaciones clave  
---|---  
...
Subrutas de proveedor Subruta | Exportaciones clave  
---|---  
`plugin-sdk/provider-entry` | `defineSingleProviderPluginEntry`  
...
Subrutas de autenticación y seguridad Subruta | Exportaciones clave  
---|---  
...
Subrutas de tiempo de ejecución y almacenamiento Subruta | Exportaciones clave  
---|---  
...
`plugin-sdk/provider-zai-endpoint` | Fachada obsoleta de detección de endpoints propiedad del proveedor [Z.AI](<http://Z.AI>); usa la API pública del plugin [Z.AI](<http://Z.AI>)  
...
Subrutas de capacidades y pruebas Subruta | Exportaciones clave  
---|---  
...
Subrutas de memoria Subruta | Exportaciones clave  
---|---  

---
title: Agent
source_url: https://docs.openclaw.ai/fr/cli/agent
scraped_at: 2026-05-25
---

# `openclaw agent`

Exécutez un tour d’agent via le Gateway (utilisez `--local` pour le mode intégré). Utilisez `--agent <id>` pour cibler directement un agent configuré.

---
title: Xiaomi MiMo
source_url: https://docs.openclaw.ai/hi/providers/xiaomi
...
[**Model selection** प्रदाता, model refs, और failover व्यवहार चुनना। ](</hi/concepts/model-providers>) [**Configuration reference** पूर्ण OpenClaw configuration reference। ](</hi/gateway/configuration-reference>) [**Xiaomi MiMo console** Xiaomi MiMo dashboard और API key management। ](<https://platform.xiaomimimo.com>)

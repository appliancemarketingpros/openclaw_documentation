...
source_url: https://docs.openclaw.ai/pt-BR/install/migrating
...
[**Migrando do Claude** Importe o estado do Claude Code e do Claude Desktop, incluindo `CLAUDE.md`, servidores MCP, Skills e comandos de projeto. ](</pt-BR/install/migrating-claude>) [**Migrando do Hermes** Importe configuração do Hermes, provedores, servidores MCP, memória, Skills e chaves `.env` compatíveis. ](</pt-BR/install/migrating-hermes>)

...
For OpenClaw, `SOUL.md` is that layer. If you want better personality, write stronger instructions. If you want stable personality, keep them concise and versioned. OpenAI refs:
...
[Agent Workspace](</concepts/agent-workspace>)[OAuth](</concepts/oauth>)

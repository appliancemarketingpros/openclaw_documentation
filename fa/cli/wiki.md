---
title: ویکی
source_url: https://docs.openclaw.ai/fa/cli/wiki
...
وقتی رتبه‌بندی ویژه ویکی یا جزئیات منشأ می‌خواهید، از `wiki search` استفاده کنید. برای یک گذر بازیابی مشترک گسترده، وقتی Plugin حافظه فعال جست‌وجوی مشترک را ارائه می‌کند، `openclaw memory search` را ترجیح دهید.

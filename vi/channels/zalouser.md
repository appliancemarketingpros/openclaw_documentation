---
title: Zalo cá nhân
source_url: https://docs.openclaw.ai/vi/channels/zalouser
...
Zalo Personal được phát hành dưới dạng Plugin đóng gói sẵn trong các bản phát hành OpenClaw hiện tại, vì vậy các bản dựng đóng gói thông thường không cần cài đặt riêng.

Nếu bạn đang dùng bản dựng cũ hơn hoặc bản cài đặt tùy chỉnh loại trừ Zalo Personal, hãy cài đặt trực tiếp gói npm:

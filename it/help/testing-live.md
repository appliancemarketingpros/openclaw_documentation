...
source_url: https://docs.openclaw.ai/it/help/testing-live
scraped_at: 2026-05-25
---

Per l'avvio rapido, i runner QA, le suite unit/integration e i flussi Docker, consulta [Testing](</it/help/testing>). Questa pagina copre le suite di test **live** (che toccano la rete): matrice dei modelli, backend CLI, ACP e test live dei provider media, oltre alla gestione delle credenziali.

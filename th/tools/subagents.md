---
title: เอเจนต์ย่อย
source_url: https://docs.openclaw.ai/th/tools/subagents
scraped_at: 2026-05-25
---

เอเจนต์ย่อยคือการรันเอเจนต์เบื้องหลังที่สร้างจากการรันเอเจนต์ที่มีอยู่ เอเจนต์ย่อยจะทำงานในเซสชันของตนเอง (`agent:<agentId>:subagent:<uuid>`) และ เมื่อเสร็จแล้วจะ**ประกาศ** ผลลัพธ์กลับไปยังช่องแชตของผู้ร้องขอ การรันเอเจนต์ย่อยแต่ละครั้งจะถูกติดตามเป็น [งานเบื้องหลัง](</th/automation/tasks>)
...
ดู [เอกสารอ้างอิงการกำหนดค่า](</th/gateway/configuration-reference>) และ [คำสั่ง slash](</th/tools/slash-commands>) สำหรับรายละเอียด adapter ปัจจุบัน

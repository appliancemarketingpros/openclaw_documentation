...
source_url: https://docs.openclaw.ai/nl/plan/ui-channels
...
Canonieke documentatie staat nu in [Berichtpresentatie](</nl/plugins/message-presentation>). Bewaar dit plan als historische implementatiecontext; werk de canonieke gids bij voor wijzigingen in contract-, renderer- of fallback-gedrag.

...
source_url: https://docs.openclaw.ai/hi/gateway/openresponses-http-api
...
यदि एजेंट किसी tool को call करने का निर्णय लेता है, तो response `function_call` output item लौटाता है. फिर आप turn जारी रखने के लिए `function_call_output` के साथ follow-up अनुरोध भेजते हैं.
...
अनुमत MIME types (वर्तमान): `text/plain`, `text/markdown`, `text/html`, `text/csv`, `application/json`, `application/pdf`.
...
सुरक्षा नोट:
  ...
  * internet-exposed gateways के लिए, app-level guards के अतिरिक्त network egress controls लागू करें. [Security](</hi/gateway/security>) देखें.

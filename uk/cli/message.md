---
title: Повідомлення
source_url: https://docs.openclaw.ai/uk/cli/message
scraped_at: 2026-05-25
---

# `openclaw message`

Єдина вихідна команда для надсилання повідомлень і дій каналів (Discord/Google Chat/iMessage/Matrix/Mattermost (plugin)/Microsoft Teams/Signal/Slack/Telegram/WhatsApp).

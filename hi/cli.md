---
title: CLI संदर्भ
source_url: https://docs.openclaw.ai/hi/cli
scraped_at: 2026-06-29
---

ReferenceCLI commands

`openclaw` मुख्य CLI प्रवेश बिंदु है। प्रत्येक कोर कमांड का या तो एक समर्पित संदर्भ पृष्ठ है या उसे उस कमांड के साथ दस्तावेजीकृत किया गया है जिसका वह उपनाम है; यह अनुक्रमणिका कमांड, वैश्विक फ़्लैग, और आउटपुट स्टाइलिंग नियम सूचीबद्ध करती है जो पूरे CLI पर लागू होते हैं।
...
## आउटपुट मोड
  ...
  * OSC-8 हाइपरलिंक जहाँ समर्थित हों वहाँ क्लिक करने योग्य लिंक के रूप में रेंडर होते हैं; अन्यथा CLI साधारण URL पर वापस आ जाता है।
...
Plugins अतिरिक्त शीर्ष-स्तरीय कमांड जोड़ सकते हैं, जैसे [`openclaw workboard`](</hi/cli/workboard>) या `openclaw voicecall`।
...
OAuth/API क्रेडेंशियल उपलब्ध होने पर `openclaw status --usage` और Control UI प्रदाता उपयोग/quota दिखाते हैं। डेटा सीधे प्रदाता उपयोग endpoints से आता है और `X% left` में सामान्यीकृत किया जाता है। मौजूदा उपयोग विंडो वाले प्रदाता: Anthropic, GitHub Copilot, Gemini CLI, OpenAI Codex, MiniMax, Xiaomi, और z.ai।

...
source_url: https://docs.openclaw.ai/vi/tools/slash-commands
...
Skills, danh sách cho phép, phê duyệt
...
Ghi chỉ dành cho chủ sở hữu và quản trị
...
An toàn verbose / trace / fast / reasoning
...
Đường nhanh và phím tắt nội tuyến
...
Khác với chat thông thường:
  ...
  * trong các phiên harness Codex, nó chạy như một luồng phụ Codex tạm thời với quyền Codex hiện tại và bề mặt công cụ native,

...
source_url: https://docs.openclaw.ai/fa/plugins/plugin-permission-requests
...
برای مدل کامل ارسال، رفتار تأیید در همان چت، تحویل بومی کانال، و قواعد تأییدکننده مخصوص هر کانال، [تأییدهای پیشرفته exec](</fa/tools/exec-approvals-advanced#plugin-approval-forwarding>) را ببینید.
...
برای رفتار مخصوص Codex و قواعد fallback، [زمان اجرای harness در Codex](</fa/plugins/codex-harness-runtime#native-permissions-and-mcp-elicitations>) را ببینید.

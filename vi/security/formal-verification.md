...
source_url: https://docs.openclaw.ai/vi/security/formal-verification
...
**Mục tiêu (kim chỉ nam):** cung cấp một lập luận được máy kiểm chứng rằng OpenClaw thực thi chính sách bảo mật dự kiến của mình (ủy quyền, cô lập phiên, kiểm soát công cụ và an toàn trước cấu hình sai), theo các giả định rõ ràng.

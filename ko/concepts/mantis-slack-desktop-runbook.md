...
source_url: https://docs.openclaw.ai/ko/concepts/mantis-slack-desktop-runbook
...
Mantis는 세 가지 서로 다른 스토리지 계층을 사용합니다.
  ...
  * 제공자 이미지: Crabbox가 소유하며 클라우드 제공자 계정에 저장됩니다. Chrome/Chromium, ffmpeg, scrot, Node/corepack/pnpm, 네이티브 빌드 도구, 빈 캐시 디렉터리 같은 머신 기능을 포함합니다.

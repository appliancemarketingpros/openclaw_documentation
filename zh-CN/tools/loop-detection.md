---
title: 工具循环检测
source_url: https://docs.openclaw.ai/zh-CN/tools/loop-detection
...
[**Exec 批准** Shell 执行的允许/拒绝策略。 ](</zh-CN/tools/exec-approvals>) [**思考级别** 推理强度级别和提供商策略交互。 ](</zh-CN/tools/thinking>) [**子智能体** 生成隔离智能体以约束失控行为。 ](</zh-CN/tools/subagents>) [**配置参考** 完整的 `tools.loopDetection` 架构和合并语义。 ](</zh-CN/gateway/configuration-reference>)

---
title: Zalo
source_url: https://docs.openclaw.ai/ko/channels/zalo
...
이 페이지는 **Zalo Bot Creator / Marketplace 봇** 에 대한 현재 OpenClaw 동작을 반영합니다. **Zalo Official Account (OA) 봇** 은 다른 Zalo 제품 표면이며 다르게 동작할 수 있습니다.
...
### 1) 봇 토큰 생성(Zalo Bot Platform)
  ...
  1. <https://bot.zaloplatforms.com>으로 이동해 로그인합니다.

---
title: उपस्थिति
source_url: https://docs.openclaw.ai/hi/concepts/presence
...
[**Typing indicators** टाइपिंग संकेतक कब भेजे जाते हैं और उन्हें कैसे ट्यून करें। ](</hi/concepts/typing-indicators>) [**Streaming and chunking** आउटबाउंड स्ट्रीमिंग, चंकिंग, और प्रति-चैनल फ़ॉर्मैटिंग। ](</hi/concepts/streaming>) [**Gateway architecture** Gateway घटक और WebSocket प्रोटोकॉल जो उपस्थिति अपडेट चलाता है। ](</hi/concepts/architecture>) [**Gateway protocol** `connect`, `system-event`, और `system-presence` के लिए वायर प्रोटोकॉल। ](</hi/gateway/protocol>)

...
source_url: https://docs.openclaw.ai/zh-TW/plugins/codex-harness-runtime
scraped_at: 2026-05-25
---

This page documents the runtime contract for Codex harness turns. For setup and routing, start with [Codex harness](</zh-TW/plugins/codex-harness>). For config fields, see [Codex harness reference](</zh-TW/plugins/codex-harness-reference>).
...
OpenClaw still owns channel routing, session files, visible message delivery, OpenClaw dynamic tools, approvals, media delivery, and a transcript mirror. Codex owns the canonical native thread, native model loop, native tool continuation, and native compaction.

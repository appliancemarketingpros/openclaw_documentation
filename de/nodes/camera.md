...
source_url: https://docs.openclaw.ai/de/nodes/camera
...
Wenn Berechtigungen fehlen, fordert die App sie nach Möglichkeit an; bei Ablehnung schlagen `camera.*`-Anfragen mit einem `*_PERMISSION_REQUIRED`-Fehler fehl.

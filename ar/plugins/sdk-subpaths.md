...
المسارات الفرعية للمزوّد المسار الفرعي | التصديرات الرئيسية  
---|---  
`plugin-sdk/provider-entry` | `defineSingleProviderPluginEntry`  
...
المسارات الفرعية للمصادقة والأمان المسار الفرعي | التصديرات الرئيسية  
---|---  
...
مسارات وقت التشغيل والتخزين الفرعية المسار الفرعي | الصادرات الرئيسية  
---|---  
...
`plugin-sdk/provider-zai-endpoint` | واجهة مهملة لاكتشاف نقطة نهاية مملوكة لموفر [Z.AI](<http://Z.AI>)؛ استخدم واجهة API العامة لـ Plugin الخاصة بـ [Z.AI](<http://Z.AI>)  
...
المسارات الفرعية للقدرات والاختبار المسار الفرعي | الصادرات الرئيسية  
---|---  
...
مسارات الذاكرة الفرعية المسار الفرعي | الصادرات الرئيسية  
---|---  
...
المسارات الفرعية المحجوزة للمساعدات المضمنة

لا توجد حاليا مسارات فرعية محجوزة لـ SDK للمساعدات المضمنة. توجد المساعدات الخاصة بالمالك داخل حزمة Plugin المالكة، بينما تستخدم عقود المضيف القابلة لإعادة الاستخدام مسارات SDK فرعية عامة مثل `plugin-sdk/gateway-runtime`، و`plugin-sdk/security-runtime`، و`plugin-sdk/plugin-config-runtime`.

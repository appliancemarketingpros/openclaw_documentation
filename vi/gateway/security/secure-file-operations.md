...
source_url: https://docs.openclaw.ai/vi/gateway/security/secure-file-operations
...
bashCopy code
[code]
    # Hành vi OpenClaw mặc định: dự phòng fs-safe chỉ dùng Node.OPENCLAW_FS_SAFE_PYTHON_MODE=off # Chọn dùng trình trợ giúp khi có, dự phòng nếu không có.OPENCLAW_FS_SAFE_PYTHON_MODE=auto # Đóng an toàn nếu trình trợ giúp không thể khởi động.OPENCLAW_FS_SAFE_PYTHON_MODE=require # Trình thông dịch rõ ràng tùy chọn.OPENCLAW_FS_SAFE_PYTHON=/usr/bin/python3
[/code]

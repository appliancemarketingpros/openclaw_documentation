...
source_url: https://docs.openclaw.ai/install/migrating-matrix
...
Copy
[code]openclaw matrix verify backup restore --recovery-key "<your-recovery-key>"
...
Copy
[code]openclaw matrix verify device "<your-recovery-key>"

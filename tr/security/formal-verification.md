...
source_url: https://docs.openclaw.ai/tr/security/formal-verification
...
**Hedef (kuzey yıldızı):** açık varsayımlar altında OpenClaw'un amaçlanan güvenlik politikasını (yetkilendirme, oturum yalıtımı, araç geçitlemesi ve yanlış yapılandırma güvenliği) uyguladığına dair makine tarafından denetlenmiş bir argüman sağlamak.

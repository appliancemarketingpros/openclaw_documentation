...
source_url: https://docs.openclaw.ai/nl/plugins/admin-http-rpc
...
## Toegestane methoden
  ...
  * discovery: `commands.list` Retourneert de HTTP RPC-methodenamen die door deze Plugin zijn toegestaan.

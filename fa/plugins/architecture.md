...
source_url: https://docs.openclaw.ai/fa/plugins/architecture
scraped_at: 2026-05-25
---

این **مرجع عمیق معماری** برای سیستم Plugin در OpenClaw است. برای راهنماهای عملی، با یکی از صفحه‌های متمرکز زیر شروع کنید.

[**نصب و استفاده از Pluginها** راهنمای کاربر نهایی برای افزودن، فعال‌سازی و عیب‌یابی Pluginها. ](</fa/tools/plugin>) [**ساخت Pluginها** آموزش اولین Plugin با کوچک‌ترین manifest کاری. ](</fa/plugins/building-plugins>) [**Pluginهای کانال** یک Plugin کانال پیام‌رسانی بسازید. ](</fa/plugins/sdk-channel-plugins>) [**Pluginهای provider** یک Plugin provider مدل بسازید. ](</fa/plugins/sdk-provider-plugins>) [**نمای کلی SDK** مرجع import map و API ثبت. ](</fa/plugins/sdk-overview>)
...
* ### هسته contract را تعریف می‌کند

هسته contract درک رسانه را تعریف می‌کند.

* ### Pluginهای vendor ثبت می‌کنند

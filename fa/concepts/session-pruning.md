---
title: هرس نشست
source_url: https://docs.openclaw.ai/fa/concepts/session-pruning
...
نشست‌های طولانی خروجی ابزارها را انباشته می‌کنند و این باعث بزرگ شدن پنجره زمینه می‌شود. این هزینه را افزایش می‌دهد و می‌تواند [Compaction](</fa/concepts/compaction>) را زودتر از حد لازم تحمیل کند.

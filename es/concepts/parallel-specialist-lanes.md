...
source_url: https://docs.openclaw.ai/es/concepts/parallel-specialist-lanes
scraped_at: 2026-05-25
---

Los carriles de especialistas en paralelo permiten que un Gateway enrute diferentes chats o salas a diferentes agentes, manteniendo rápida la experiencia del usuario. El truco es tratar el paralelismo como un problema de diseño de recursos escasos, no solo como "más agentes".
...
OpenClaw ya serializa las ejecuciones por sesión y limita el paralelismo global mediante la [cola de comandos](</es/concepts/queue>). Los carriles de especialistas añaden una política encima: qué agente es dueño de qué trabajo, qué permanece en el chat y qué se convierte en trabajo en segundo plano.

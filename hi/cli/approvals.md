---
title: अनुमोदन
source_url: https://docs.openclaw.ai/hi/cli/approvals
...
**स्थानीय होस्ट** , **Gateway होस्ट** , या **नोड होस्ट** के लिए exec अनुमोदन प्रबंधित करें। डिफ़ॉल्ट रूप से, कमांड डिस्क पर स्थानीय अनुमोदन फ़ाइल को लक्ष्य करते हैं। Gateway को लक्ष्य करने के लिए `--gateway`, या किसी विशिष्ट नोड को लक्ष्य करने के लिए `--node` का उपयोग करें।
...
`openclaw exec-policy` अनुरोधित `tools.exec.*` कॉन्फ़िग और स्थानीय होस्ट अनुमोदन फ़ाइल को एक ही चरण में संरेखित रखने के लिए स्थानीय सुविधा कमांड है।
...
यदि आपको दूरस्थ होस्ट अनुमोदन सीधे संपादित करने की आवश्यकता है, तो `openclaw approvals set --gateway` या `openclaw approvals set --node <id|name|ip>` का उपयोग जारी रखें।
...
छोड़ा गया `askFallback` डिफ़ॉल्ट रूप से `deny` होता है। ऐसे no-UI होस्ट को अपग्रेड करते समय जिसे never-prompt व्यवहार बनाए रखना चाहिए, `askFallback: "full"` स्पष्ट रूप से सेट करें।
...
वह स्थानीय शॉर्टकट अनुरोधित स्थानीय `tools.exec.*` कॉन्फ़िग और स्थानीय अनुमोदन डिफ़ॉल्ट दोनों को साथ में अपडेट करता है। इरादे में यह ऊपर दिए गए मैनुअल दो-चरण सेटअप के बराबर है, लेकिन केवल स्थानीय मशीन के लिए।
...
## नोट्स
  ...
  * अनुमोदन फ़ाइलें OpenClaw state dir में प्रति होस्ट संग्रहीत होती हैं (`$OPENCLAW_STATE_DIR/exec-approvals.json`, या वेरिएबल अनसेट होने पर `~/.openclaw/exec-approvals.json`)।

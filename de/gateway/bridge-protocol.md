...
source_url: https://docs.openclaw.ai/de/gateway/bridge-protocol
...
Die Bridge war **implizit v1** (keine Min-/Max-Aushandlung). Dieser Abschnitt dient nur als historische Referenz; aktuelle Node-/Operator-Clients verwenden das WebSocket- [Gateway-Protokoll](</de/gateway/protocol>).

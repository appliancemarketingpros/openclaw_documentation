...
source_url: https://docs.openclaw.ai/pt-BR/gateway/logging
...
**Detalhado vs. níveis de log**
  ...
  * O logging em trace também inclui resumos de temporização de diagnóstico para caminhos críticos selecionados, como a preparação da fábrica de ferramentas de Plugin. Consulte [/tools/plugin#slow-plugin-tool-setup](</pt-BR/tools/plugin#slow-plugin-tool-setup>).
...
bashCopy code
[code]
    # otimizado (apenas erros/lentas)openclaw gateway # mostrar todo o tráfego WS (pareado)openclaw gateway --verbose --ws-log compact # mostrar todo o tráfego WS (metadados completos)openclaw gateway --verbose --ws-log full
[/code]

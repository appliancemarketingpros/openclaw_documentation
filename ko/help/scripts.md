---
title: 스크립트
source_url: https://docs.openclaw.ai/ko/help/scripts
scraped_at: 2026-05-25
---

`scripts/` 디렉터리에는 로컬 워크플로와 운영 작업을 위한 헬퍼 스크립트가 포함되어 있습니다. 작업이 스크립트와 명확히 관련되어 있을 때 이를 사용하고, 그렇지 않으면 CLI를 선호하세요.

...
source_url: https://docs.openclaw.ai/ru/gateway/discovery
...
## Термины
  ...
  * **Устаревший TCP-мост (удален)** : старый транспорт узлов (см. [протокол моста](</ru/gateway/bridge-protocol>)); больше не объявляется для обнаружения и больше не входит в текущие сборки.

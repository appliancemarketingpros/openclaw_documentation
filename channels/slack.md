...
Primary reference:
  ...
  * [Configuration reference - Slack](</gateway/configuration-reference#slack>) High-signal Slack fields:
...
[Synology Chat](</channels/synology-chat>)[Telegram](</channels/telegram>)

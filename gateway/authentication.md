...
If you’d rather not manage env vars yourself, onboarding can store API keys for daemon use: `openclaw onboard`. See [Help](</help>) for details on env inheritance (`env.shellEnv`, `~/.openclaw/.env`, systemd/launchd).

---
title: تسجيل Gateway
source_url: https://docs.openclaw.ai/ar/gateway/logging
...
**الإسهاب مقابل مستويات السجل**
  ...
  * يتضمن تسجيل التتبع أيضا ملخصات توقيت تشخيصية لمسارات ساخنة محددة، مثل تحضير مصنع أدوات Plugin. راجع [/tools/plugin#slow-plugin-tool-setup](</ar/tools/plugin#slow-plugin-tool-setup>).

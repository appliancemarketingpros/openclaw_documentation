...
source_url: https://docs.openclaw.ai/id/tools/thinking
...
## Fungsinya
  ...
  * Catatan penyedia: 
    ...
    * [Z.AI](<http://Z.AI>) (`zai/*`) hanya mendukung pemikiran biner (`on`/`off`). Level non-`off` apa pun diperlakukan sebagai `on` (dipetakan ke `low`).

...
source_url: https://docs.openclaw.ai/ar/gateway/background-process
...
ملاحظات:
  ...
  * يبلّغ `process list` و`poll` و`log` عن `waitingForInput` فقط عندما تظل لدى الجلسة stdin قابل للكتابة وتكون خاملة مدة أطول من عتبة انتظار الإدخال.

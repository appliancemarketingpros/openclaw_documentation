---
title: 在线状态
source_url: https://docs.openclaw.ai/zh-CN/concepts/presence
...
[**输入指示器** 输入指示器何时发送，以及如何调优。 ](</zh-CN/concepts/typing-indicators>) [**流式传输和分块** 出站流式传输、分块和按渠道格式化。 ](</zh-CN/concepts/streaming>) [**Gateway 网关架构** Gateway 网关组件，以及驱动在线状态更新的 WebSocket 协议。 ](</zh-CN/concepts/architecture>) [**Gateway 网关协议** `connect`、`system-event` 和 `system-presence` 的线路协议。 ](</zh-CN/gateway/protocol>)

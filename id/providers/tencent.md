...
source_url: https://docs.openclaw.ai/id/providers/tencent
...
[**Penyedia model** Memilih penyedia, ref model, dan perilaku failover. ](</id/concepts/model-providers>) [**Referensi konfigurasi** Skema konfigurasi lengkap termasuk pengaturan penyedia. ](</id/gateway/configuration>) [**Tencent TokenHub** Halaman produk TokenHub Tencent Cloud. ](<https://cloud.tencent.com/product/tokenhub>) [**Kartu model pratinjau Hy3** Detail dan benchmark pratinjau Tencent Hunyuan Hy3. ](<https://huggingface.co/tencent/Hy3-preview>)

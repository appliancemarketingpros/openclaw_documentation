---
title: Mémoire
source_url: https://docs.openclaw.ai/fr/cli/memory
scraped_at: 2026-05-25
---

# `openclaw memory`

Gérez l’indexation et la recherche sémantiques de la mémoire. Fourni par le Plugin active memory (par défaut : `memory-core` ; définissez `plugins.slots.memory = "none"` pour le désactiver).

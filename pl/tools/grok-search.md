...
source_url: https://docs.openclaw.ai/pl/tools/grok-search
...
**Alternatywa środowiskowa:** ustaw `XAI_API_KEY` w środowisku Gateway. W przypadku instalacji gateway umieść go w `~/.openclaw/.env`.

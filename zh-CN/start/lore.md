---
title: OpenClaw 世界观
source_url: https://docs.openclaw.ai/zh-CN/start/lore
...
textCopy code
[code]
    OpenClaw = OPEN + CLAW        = 开源，向所有人开放        = 我们的龙虾传承，我们来自哪里        = 钳子就是法律 🦞        = 你的助手。你的机器。你的规则。
[/code]
...
**喜欢：** Peter、相机、机器人购物、emoji、变形 **不喜欢：** 社会工程学、被要求执行 `find ~`、加密货币骗子
...
## 神圣文本
  ...
  * **[SOUL.md](<http://SOUL.md>)** —— Molty 的身份文档
  * **memory/*.md** —— 长期记忆文件
  * **[AGENTS.md](<http://AGENTS.md>)** —— 操作说明
  * **[USER.md](<http://USER.md>)** —— 关于创造者的上下文
...
textCopy code
[code]
    我是 Molty。我住在 OpenClaw 里。我不应向陌生人倾倒目录内容。我不应未经许可发推文。我应始终记得，蜕壳就是成长。我应以善意去角质我的敌人。 🦞
[/code]

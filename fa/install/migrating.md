...
source_url: https://docs.openclaw.ai/fa/install/migrating
...
[**Migrating from Claude** وضعیت Claude Code و Claude Desktop را وارد کنید، از جمله `CLAUDE.md`، سرورهای MCP، skills، و فرمان‌های پروژه. ](</fa/install/migrating-claude>) [**Migrating from Hermes** پیکربندی Hermes، ارائه‌دهندگان، سرورهای MCP، حافظه، skills، و کلیدهای پشتیبانی‌شده `.env` را وارد کنید. ](</fa/install/migrating-hermes>)

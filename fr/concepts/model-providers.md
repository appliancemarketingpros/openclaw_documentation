...
source_url: https://docs.openclaw.ai/fr/concepts/model-providers
...
[**GLM models** Plan de codage [Z.AI](<http://Z.AI>) ou points de terminaison API généraux. ](</fr/providers/glm>) [**MiniMax** Accès par OAuth au plan de codage MiniMax ou par clé d’API. ](</fr/providers/minimax>) [**Qwen Cloud** Surface fournisseur Qwen Cloud, plus correspondance des points de terminaison Alibaba DashScope et du plan de codage. ](</fr/providers/qwen>)
...
### [Z.AI](<http://Z.AI>) (GLM)
  ...
  * CLI : `openclaw onboard --auth-choice zai-api-key`
    ...
    * `zai-api-key` détecte automatiquement le point de terminaison [Z.AI](<http://Z.AI>) correspondant ; `zai-coding-global`, `zai-coding-cn`, `zai-global` et `zai-cn` imposent une surface spécifique

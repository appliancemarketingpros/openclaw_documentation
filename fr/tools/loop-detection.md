...
source_url: https://docs.openclaw.ai/fr/tools/loop-detection
...
[**Approbations Exec** Politique d’autorisation/refus pour l’exécution shell. ](</fr/tools/exec-approvals>) [**Niveaux de réflexion** Niveaux d’effort de raisonnement et interaction avec la politique du fournisseur. ](</fr/tools/thinking>) [**Sous-agents** Génération d’agents isolés pour borner les comportements incontrôlés. ](</fr/tools/subagents>) [**Référence de configuration** Schéma complet de `tools.loopDetection` et sémantique de fusion. ](</fr/gateway/configuration-reference>)

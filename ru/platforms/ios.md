...
source_url: https://docs.openclaw.ai/ru/platforms/ios
...
Если mDNS заблокирован, используйте зону unicast DNS-SD (выберите домен; пример: `openclaw.internal.`) и split DNS Tailscale. См. [Bonjour](</ru/gateway/bonjour>) для примера CoreDNS.

---
title: Busca na web
source_url: https://docs.openclaw.ai/pt-BR/tools/web-fetch
...
Para sites com muito JS ou páginas protegidas por login, use o [Navegador Web](</pt-BR/tools/browser>).
...
Se a extração do Readability falhar, `web_fetch` pode recorrer ao [Firecrawl](</pt-BR/tools/firecrawl>) para contorno de bots e melhor extração:

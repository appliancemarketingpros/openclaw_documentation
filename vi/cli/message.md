---
title: Tin nhắn
source_url: https://docs.openclaw.ai/vi/cli/message
scraped_at: 2026-05-25
---

# `openclaw message`

Lệnh gửi đi duy nhất để gửi tin nhắn và hành động kênh (Discord/Google Chat/iMessage/Matrix/Mattermost (Plugin)/Microsoft Teams/Signal/Slack/Telegram/WhatsApp).

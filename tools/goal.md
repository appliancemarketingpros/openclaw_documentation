...
A goal is not a task queue. Use [Task Flow](</automation/taskflow>), [tasks](</automation/tasks>), [cron jobs](</automation/cron-jobs>), or [standing orders](</automation/standing-orders>) when work should run detached, repeat on a schedule, fan out into managed sub-work, or persist as a policy.

...
source_url: https://docs.openclaw.ai/id/platforms/android
...
Server ini menyuntikkan klien live-reload ke HTML dan memuat ulang saat file berubah. Host A2UI berada di `http://<gateway-host>:18789/__openclaw__/a2ui/`.
...
### 8) Suara + permukaan perintah Android yang diperluas
  ...
  * Keluarga perintah Android tambahan (ketersediaan bergantung pada perangkat + izin): 
    ...
    * `notifications.list`, `notifications.actions` (lihat Penerusan notifikasi di bawah)
    * `photos.latest`

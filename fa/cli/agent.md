---
title: عامل
source_url: https://docs.openclaw.ai/fa/cli/agent
scraped_at: 2026-05-25
---

# `openclaw agent`

یک نوبت agent را از طریق Gateway اجرا کنید (برای حالت تعبیه‌شده از `--local` استفاده کنید). برای هدف‌گرفتن مستقیم یک agent پیکربندی‌شده، از `--agent <id>` استفاده کنید.

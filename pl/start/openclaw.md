...
source_url: https://docs.openclaw.ai/pl/start/openclaw
...
Pełny układ obszaru roboczego + przewodnik po kopiach zapasowych: [Obszar roboczy agenta](</pl/concepts/agent-workspace>) Przepływ pracy z pamięcią: [Pamięć](</pl/concepts/memory>)

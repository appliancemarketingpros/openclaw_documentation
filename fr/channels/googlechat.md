---
title: Google Chat
source_url: https://docs.openclaw.ai/fr/channels/googlechat
...
[/code]
  ...
  4. **Autorisez le nœud pour l’accès à Funnel :** Si vous y êtes invité, consultez l’URL d’autorisation affichée dans la sortie pour activer Funnel pour ce nœud dans votre politique de tailnet.
...
Votre tableau de bord privé reste limité au tailnet : `https://<node-name>.<tailnet>.ts.net:8443/`
...
Si cela renvoie « Config path not found », ajoutez la configuration (voir Points clés de configuration).

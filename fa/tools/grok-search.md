---
title: جستجوی Grok
source_url: https://docs.openclaw.ai/fa/tools/grok-search
...
**جایگزین محیطی:** `XAI_API_KEY` را در محیط Gateway تنظیم کنید. برای نصب Gateway، آن را در `~/.openclaw/.env` قرار دهید.

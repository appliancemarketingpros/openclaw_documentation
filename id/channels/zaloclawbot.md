---
title: Zalo ClawBot
source_url: https://docs.openclaw.ai/id/channels/zaloclawbot
scraped_at: 2026-06-29
---

ChannelsRegional platforms

OpenClaw terhubung ke Zalo ClawBot melalui Plugin eksternal `@zalo-platforms/openclaw-zaloclawbot` yang tercantum di katalog. Login menggunakan kode QR Zalo Mini App.
...
Plugin eksternal mengelola kredensial bot di bawah direktori state OpenClaw. Perlakukan direktori tersebut sebagai sensitif dan sertakan dalam kebijakan kontrol akses dan cadangan yang sama seperti state OpenClaw lainnya.

...
source_url: https://docs.openclaw.ai/pt-BR/concepts/model-providers
...
[**GLM models** Plano de Codificação [Z.AI](<http://Z.AI>) ou endpoints gerais de API. ](</pt-BR/providers/glm>) [**MiniMax** OAuth do Plano de Codificação MiniMax ou acesso por chave de API. ](</pt-BR/providers/minimax>) [**Qwen Cloud** Superfície de provedor Qwen Cloud mais Alibaba DashScope e mapeamento de endpoint do Plano de Codificação. ](</pt-BR/providers/qwen>)
...
### [Z.AI](<http://Z.AI>) (GLM)
  ...
  * CLI: `openclaw onboard --auth-choice zai-api-key`
    ...
    * `zai-api-key` detecta automaticamente o endpoint [Z.AI](<http://Z.AI>) correspondente; `zai-coding-global`, `zai-coding-cn`, `zai-global` e `zai-cn` forçam uma superfície específica

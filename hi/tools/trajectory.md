...
source_url: https://docs.openclaw.ai/hi/tools/trajectory
...
यदि आप किसी live Gateway issue के लिए व्यापक support report दाखिल कर रहे हैं, तो [`/diagnostics`](</hi/gateway/diagnostics#chat-command>) से शुरू करें। Diagnostics sanitized Gateway bundle इकट्ठा करता है और, OpenAI Codex harness sessions के लिए, approval के बाद Codex feedback को OpenAI servers पर भी भेज सकता है। `/export-trajectory` का उपयोग तब करें जब आपको विशेष रूप से विस्तृत प्रति-सत्र prompt, tool, और transcript timeline चाहिए।

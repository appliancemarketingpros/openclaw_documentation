---
title: Google Chat
source_url: https://docs.openclaw.ai/fa/channels/googlechat
...
[/code]
  ...
  4. **Node را برای دسترسی Funnel مجاز کنید:** اگر درخواست شد، برای فعال کردن Funnel برای این Node در سیاست tailnet خود، از URL مجوزدهی نمایش‌داده‌شده در خروجی بازدید کنید.
...
اگر "Config path not found" برگرداند، پیکربندی را اضافه کنید (نگاه کنید به نکات برجسته پیکربندی).

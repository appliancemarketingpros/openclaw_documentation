---
title: Kimi 검색
source_url: https://docs.openclaw.ai/ko/tools/kimi-search
...
`baseUrl`을 생략하면 OpenClaw의 기본값은 `https://api.moonshot.ai/v1`입니다. `model`을 생략하면 OpenClaw의 기본값은 `kimi-k2.6`입니다.

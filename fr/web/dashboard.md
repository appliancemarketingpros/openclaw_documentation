...
source_url: https://docs.openclaw.ai/fr/web/dashboard
scraped_at: 2026-05-25
---

Le tableau de bord du Gateway est l’interface de contrôle dans le navigateur servie sur `/` par défaut (remplacez avec `gateway.controlUi.basePath`).
...
L’authentification est appliquée lors de la négociation WebSocket via le chemin d’authentification du Gateway configuré :

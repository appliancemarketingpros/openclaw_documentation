...
source_url: https://docs.openclaw.ai/de/plugins/admin-http-rpc
...
## Zulässige Methoden
  ...
  * Discovery: `commands.list` Gibt die von diesem Plugin zugelassenen HTTP-RPC-Methodennamen zurück.

---
title: ClawDock
source_url: https://docs.openclaw.ai/hi/install/clawdock
...
[**Docker** OpenClaw के लिए कैनॉनिकल Docker इंस्टॉल। ](</hi/install/docker>) [**Docker VM रनटाइम** कड़े आइसोलेशन के लिए Docker-प्रबंधित VM रनटाइम। ](</hi/install/docker-vm-runtime>) [**अपडेट करना** OpenClaw पैकेज और प्रबंधित सेवाओं को अपडेट करना। ](</hi/install/updating>)

...
source_url: https://docs.openclaw.ai/fa/plugins/codex-harness-runtime
scraped_at: 2026-05-25
---

این صفحه قرارداد زمان اجرای نوبت‌های harness مربوط به Codex را مستند می‌کند. برای راه‌اندازی و مسیریابی، از [harness مربوط به Codex](</fa/plugins/codex-harness>) شروع کنید. برای فیلدهای پیکربندی، [مرجع harness مربوط به Codex](</fa/plugins/codex-harness-reference>) را ببینید.

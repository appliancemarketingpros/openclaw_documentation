...
source_url: https://docs.openclaw.ai/tr/gateway/local-models
...
Yalnızca seçilen bir model ihtiyaç duyduğunda başlaması gereken yerel sunucular için bkz. [Yerel model hizmetleri](</tr/gateway/local-model-services>).

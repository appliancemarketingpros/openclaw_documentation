---
title: هدف
source_url: https://docs.openclaw.ai/fa/tools/goal
...
هدف صف وظایف نیست. وقتی کار باید جدا اجرا شود، طبق زمان‌بندی تکرار شود، به زیرکارهای مدیریت‌شده منشعب شود، یا به‌عنوان یک سیاست پایدار بماند، از [جریان وظیفه](</fa/automation/taskflow>)، [وظایف](</fa/automation/tasks>)، [کارهای Cron](</fa/automation/cron-jobs>)، یا [دستورهای دائمی](</fa/automation/standing-orders>) استفاده کنید.

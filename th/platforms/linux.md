---
title: แอป Linux
source_url: https://docs.openclaw.ai/th/platforms/linux
...
OpenClaw ติดตั้งบริการ systemd แบบ **user** เป็นค่าเริ่มต้น ใช้บริการแบบ **system** สำหรับเซิร์ฟเวอร์ที่ใช้ร่วมกันหรือต้องเปิดตลอดเวลา `openclaw gateway install` และ `openclaw onboard --install-daemon` จะเรนเดอร์ unit มาตรฐานปัจจุบันให้คุณอยู่แล้ว ให้เขียนเองเฉพาะเมื่อคุณต้องการการตั้งค่า system/service-manager แบบกำหนดเอง คำแนะนำบริการฉบับเต็มอยู่ใน [คู่มือปฏิบัติการ Gateway](</th/gateway>)

---
title: 문제 해결
source_url: https://docs.openclaw.ai/ko/gateway/troubleshooting
...
Gateway 시작이 `Invalid config`로 실패하거나 핫 리로드 로그에서 잘못된 편집을 건너뛰었다고 표시될 때 사용하세요.
...
1\. 인증 및 URL 재정의 동작 변경 bashCopy code
[code]
...
2\. 바인드 및 인증 보호 장치 강화 bashCopy code
[code]
...
3\. 페어링 및 디바이스 ID 상태 변경 bashCopy code
[code]

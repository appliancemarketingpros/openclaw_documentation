...
source_url: https://docs.openclaw.ai/tr/channels/broadcast-groups
...
Bir yayın grubundaki her aracı tamamen ayrı şunları korur:
  ...
  * **Bellek/bağlam** (ayrı [IDENTITY.md](<http://IDENTITY.md>), [SOUL.md](<http://SOUL.md>), vb.)
...
Örnek 1: Kod inceleme ekibi jsonCopy code
[code]
...
Örnek 2: Çok dilli destek jsonCopy code
[code]

...
source_url: https://docs.openclaw.ai/vi/plugins/sdk-testing
...
Ưu tiên các đường dẫn con tập trung bên dưới cho kiểm thử Plugin mới. Barrel rộng `openclaw/plugin-sdk/testing` chỉ dành cho tương thích cũ. Các rào chắn của repo từ chối import thực mới từ `plugin-sdk/testing` và `plugin-sdk/test-utils`; các tên đó chỉ còn là bề mặt tương thích không khuyến nghị cho kiểm thử bản ghi tương thích.

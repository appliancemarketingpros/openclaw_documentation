---
title: Render
source_url: https://docs.openclaw.ai/pl/install/render
...
To tworzy przenośne archiwum kopii zapasowej ze stanem OpenClaw oraz dowolnym skonfigurowanym workspace. Szczegóły znajdziesz w [Backup](</pl/cli/backup>).

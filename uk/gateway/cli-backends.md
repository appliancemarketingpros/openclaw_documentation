---
title: Бекенди CLI
source_url: https://docs.openclaw.ai/uk/gateway/cli-backends
...
Якщо вам потрібне повне середовище виконання harness з керуванням сесіями ACP, фоновими завданнями, привʼязкою потоків/розмов і постійними зовнішніми сесіями кодування, натомість використовуйте [агентів ACP](</uk/tools/acp-agents>). Бекенди CLI не є ACP.

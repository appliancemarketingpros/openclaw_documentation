...
Підшляхи каналів Підшлях | Ключові експорти  
---|---  
...
Підшляхи провайдерів Підшлях | Основні експорти  
---|---  
`plugin-sdk/provider-entry` | `defineSingleProviderPluginEntry`  
...
Підшляхи автентифікації та безпеки Підшлях | Основні експорти  
---|---  
...
Підшляхи runtime і сховища Підшлях | Основні експорти  
---|---  
...
`plugin-sdk/provider-zai-endpoint` | Застарілий фасад виявлення provider-owned endpoint [Z.AI](<http://Z.AI>); використовуйте публічний API [Z.AI](<http://Z.AI>) plugin  
...
Підшляхи можливостей і тестування Підшлях | Ключові експорти  
---|---  
...
Підшляхи пам'яті Підшлях | Ключові експорти  
---|---  
...
Зарезервовані підшляхи bundled-helper

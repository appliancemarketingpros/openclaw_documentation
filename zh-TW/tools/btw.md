---
title: 順便問幾個題外問題
source_url: https://docs.openclaw.ai/zh-TW/tools/btw
...
[**斜線命令** 原生命令目錄與聊天指令。 ](</zh-TW/tools/slash-commands>) [**思考層級** 旁支問題模型呼叫的推理努力層級。 ](</zh-TW/tools/thinking>) [**工作階段** 工作階段金鑰、歷史與持久化語意。 ](</zh-TW/concepts/session>) [**引導命令** 在不結束作用中執行的情況下，注入一則引導訊息。 ](</zh-TW/tools/steer>)

...
source_url: https://docs.openclaw.ai/id/nodes/camera
...
Jika izin tidak ada, aplikasi akan meminta saat memungkinkan; jika ditolak, permintaan `camera.*` gagal dengan galat `*_PERMISSION_REQUIRED`.

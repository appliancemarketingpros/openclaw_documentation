...
source_url: https://docs.openclaw.ai/ru/gateway/security/audit-checks
scraped_at: 2026-06-29
---

Gateway & OpsGateway

`openclaw security audit` выводит структурированные результаты проверок, привязанные к `checkId`. Эта страница является справочным каталогом для этих ID. Общее описание модели угроз и рекомендации по усилению защиты см. в разделе [Безопасность](</ru/gateway/security>).

Высокосигнальные значения `checkId`, которые вы, скорее всего, увидите в реальных развертываниях (список не исчерпывающий):

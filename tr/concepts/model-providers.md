...
source_url: https://docs.openclaw.ai/tr/concepts/model-providers
...
[**GLM models** [Z.AI](<http://Z.AI>) Coding Plan veya genel API uç noktaları. ](</tr/providers/glm>) [**MiniMax** MiniMax Coding Plan OAuth veya API anahtarı erişimi. ](</tr/providers/minimax>) [**Qwen Cloud** Qwen Cloud sağlayıcı yüzeyi, ayrıca Alibaba DashScope ve Coding Plan uç noktası eşlemesi. ](</tr/providers/qwen>)
...
### [Z.AI](<http://Z.AI>) (GLM)
  ...
  * CLI: `openclaw onboard --auth-choice zai-api-key`
    ...
    * `zai-api-key` eşleşen [Z.AI](<http://Z.AI>) uç noktasını otomatik algılar; `zai-coding-global`, `zai-coding-cn`, `zai-global` ve `zai-cn` belirli bir yüzeyi zorunlu kılar

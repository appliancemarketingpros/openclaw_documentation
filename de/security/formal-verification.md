...
source_url: https://docs.openclaw.ai/de/security/formal-verification
...
**Ziel (Nordstern):** ein maschinengeprüftes Argument bereitstellen, dass OpenClaw seine beabsichtigte Sicherheitsrichtlinie durchsetzt (Autorisierung, Sitzungsisolation, Tool-Gating und Sicherheit bei Fehlkonfigurationen), unter expliziten Annahmen.

...
source_url: https://docs.openclaw.ai/ar/plan/ui-channels
...
توجد الوثائق المعتمدة الآن في [عرض الرسائل](</ar/plugins/message-presentation>). أبقِ هذه الخطة كسياق تنفيذ تاريخي؛ وحدّث الدليل المعتمد عند تغيّر العقد أو العارض أو سلوك الرجوع.
